---
title: "SelectColumn"
description: "Details for Class SelectColumn (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.SelectColumn">
  <h1 id="ETLBox_DataFlow_SelectColumn" data-uid="ETLBox.DataFlow.SelectColumn" class="text-break">Class SelectColumn
</h1>
  <div class="markdown level0 summary"><p>This attribute defines if the column is used as Select for the <a class="xref" href="/api/etlbox.dataflow.connectors/dbsource">DbSource</a></p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level2"><span class="xref">SelectColumn</span></div>
  </div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_SelectColumn_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_SelectColumn__ctor_" data-uid="ETLBox.DataFlow.SelectColumn.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_SelectColumn__ctor" data-uid="ETLBox.DataFlow.SelectColumn.#ctor">SelectColumn()</h4>
  <div class="markdown level1 summary"><p>This property is used as an Select column for reading data in the BulkSelect operation mode from the DbSource.</p>
</div>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_SelectColumn_SelectPropertyName_" data-uid="ETLBox.DataFlow.SelectColumn.SelectPropertyName*"></a>
  <h4 id="ETLBox_DataFlow_SelectColumn_SelectPropertyName" data-uid="ETLBox.DataFlow.SelectColumn.SelectPropertyName">SelectPropertyName</h4>
  <div class="markdown level1 summary"><p>Name of the property used to retrieve additional data</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
