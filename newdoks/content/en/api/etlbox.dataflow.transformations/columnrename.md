---
title: "ColumnRename"
description: "Details for Class ColumnRename (ETLBox.DataFlow.Transformations)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.Transformations.ColumnRename">
  <h1 id="ETLBox_DataFlow_Transformations_ColumnRename" data-uid="ETLBox.DataFlow.Transformations.ColumnRename" class="text-break">Class ColumnRename
</h1>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow.transformations/columnrename-1">ColumnRename</a>&lt;<span class="xref">System.Dynamic.ExpandoObject</span>&gt;</div>
    <div class="level6"><span class="xref">ColumnRename</span></div>
  </div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/columnrename-1#ETLBox_DataFlow_Transformations_ColumnRename_1_TaskName">ColumnRename&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/columnrename-1#ETLBox_DataFlow_Transformations_ColumnRename_1_SourceBlock">ColumnRename&lt;ExpandoObject&gt;.SourceBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/columnrename-1#ETLBox_DataFlow_Transformations_ColumnRename_1_TargetBlock">ColumnRename&lt;ExpandoObject&gt;.TargetBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/columnrename-1#ETLBox_DataFlow_Transformations_ColumnRename_1_RenameColumns">ColumnRename&lt;ExpandoObject&gt;.RenameColumns</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/columnrename-1#ETLBox_DataFlow_Transformations_ColumnRename_1_RenameFunc">ColumnRename&lt;ExpandoObject&gt;.RenameFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/columnrename-1#ETLBox_DataFlow_Transformations_ColumnRename_1_ProgressCount">ColumnRename&lt;ExpandoObject&gt;.ProgressCount</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/columnrename-1#ETLBox_DataFlow_Transformations_ColumnRename_1_PrepareParameter">ColumnRename&lt;ExpandoObject&gt;.PrepareParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/columnrename-1#ETLBox_DataFlow_Transformations_ColumnRename_1_CheckParameter">ColumnRename&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/columnrename-1#ETLBox_DataFlow_Transformations_ColumnRename_1_InitComponent">ColumnRename&lt;ExpandoObject&gt;.InitComponent()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/columnrename-1#ETLBox_DataFlow_Transformations_ColumnRename_1_CleanUpOnSuccess">ColumnRename&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/columnrename-1#ETLBox_DataFlow_Transformations_ColumnRename_1_CleanUpOnFaulted_System_Exception_">ColumnRename&lt;ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/columnrename-1#ETLBox_DataFlow_Transformations_ColumnRename_1_LinkErrorTo_ETLBox_DataFlow_IDataFlowDestination_ETLBox_DataFlow_ETLBoxError__">ColumnRename&lt;ExpandoObject&gt;.LinkErrorTo(IDataFlowDestination&lt;ETLBoxError&gt;)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Transformations</h6>
  ...
  <h5 id="ETLBox_DataFlow_Transformations_ColumnRename_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Transformations_ColumnRename__ctor_" data-uid="ETLBox.DataFlow.Transformations.ColumnRename.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Transformations_ColumnRename__ctor" data-uid="ETLBox.DataFlow.Transformations.ColumnRename.#ctor">ColumnRename()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_Transformations_ColumnRename__ctor_" data-uid="ETLBox.DataFlow.Transformations.ColumnRename.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Transformations_ColumnRename__ctor_System_Collections_Generic_ICollection_ETLBox_DataFlow_RenameColumn__" data-uid="ETLBox.DataFlow.Transformations.ColumnRename.#ctor(System.Collections.Generic.ICollection{ETLBox.DataFlow.RenameColumn})">ColumnRename(ICollection&lt;RenameColumn&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
