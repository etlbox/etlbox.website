---
title: "BlockTransformation"
description: "Details for Class BlockTransformation (ETLBox.DataFlow.Transformations)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.Transformations.BlockTransformation">
  <h1 id="ETLBox_DataFlow_Transformations_BlockTransformation" data-uid="ETLBox.DataFlow.Transformations.BlockTransformation" class="text-break">Class BlockTransformation
  </h1>
...
But as this block any processing until all data is buffered, it will also need to store the whole data in memory.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level6"><a class="xref" href="/api/etlbox.dataflow.transformations/blocktransformation-2">BlockTransformation</a>&lt;<span class="xref">System.Dynamic.ExpandoObject</span>, <span class="xref">System.Dynamic.ExpandoObject</span>&gt;</div>
    <div class="level7"><a class="xref" href="/api/etlbox.dataflow.transformations/blocktransformation-1">BlockTransformation</a>&lt;<span class="xref">System.Dynamic.ExpandoObject</span>&gt;</div>
    <div class="level8"><span class="xref">BlockTransformation</span></div>
  </div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/blocktransformation-2#ETLBox_DataFlow_Transformations_BlockTransformation_2_TaskName">BlockTransformation&lt;ExpandoObject, ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/blocktransformation-2#ETLBox_DataFlow_Transformations_BlockTransformation_2_BatchSize">BlockTransformation&lt;ExpandoObject, ExpandoObject&gt;.BatchSize</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/blocktransformation-2#ETLBox_DataFlow_Transformations_BlockTransformation_2_MaxBufferSize">BlockTransformation&lt;ExpandoObject, ExpandoObject&gt;.MaxBufferSize</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/blocktransformation-2#ETLBox_DataFlow_Transformations_BlockTransformation_2_BlockTransformationFunc">BlockTransformation&lt;ExpandoObject, ExpandoObject&gt;.BlockTransformationFunc</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Transformations</h6>
  ...
  <h5 id="ETLBox_DataFlow_Transformations_BlockTransformation_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Transformations_BlockTransformation__ctor_" data-uid="ETLBox.DataFlow.Transformations.BlockTransformation.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Transformations_BlockTransformation__ctor" data-uid="ETLBox.DataFlow.Transformations.BlockTransformation.#ctor">BlockTransformation()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_Transformations_BlockTransformation__ctor_" data-uid="ETLBox.DataFlow.Transformations.BlockTransformation.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Transformations_BlockTransformation__ctor_System_Func_System_Dynamic_ExpandoObject___System_Dynamic_ExpandoObject____" data-uid="ETLBox.DataFlow.Transformations.BlockTransformation.#ctor(System.Func{System.Dynamic.ExpandoObject[],System.Dynamic.ExpandoObject[]})">BlockTransformation(Func&lt;ExpandoObject[], ExpandoObject[]&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
{{< /rawhtml >}}
