...
description: "Details for Class XmlDestination<TInput> (ETLBox.DataFlow.Connectors)"
draft: false
images: []
menu:
  api:
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Connectors</h6>
  ...
  <h5 id="ETLBox_DataFlow_Connectors_XmlDestination_1_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class XmlDestination<TInput> : DataFlowStreamDestination<TInput>, ILoggableTask, IDataFlowLogging, IDataFlowStreamDestination<TInput>, IDataFlowDestination<TInput>, IDataFlowDestination, IDataFlowComponent, IDataFlowStreamDestination
```
...
{{< rawhtml >}}
  ...
  <h5 id="ETLBox_DataFlow_Connectors_XmlDestination_1_examples"><strong>Examples</strong></h5>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Connectors_XmlDestination_1_NS_" data-uid="ETLBox.DataFlow.Connectors.XmlDestination`1.NS*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_XmlDestination_1_NS" data-uid="ETLBox.DataFlow.Connectors.XmlDestination`1.NS">NS</h4>
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">System.Xml.Serialization.XmlSerializerNamespaces</span></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  <a id="ETLBox_DataFlow_Connectors_XmlDestination_1_RootElementName_" data-uid="ETLBox.DataFlow.Connectors.XmlDestination`1.RootElementName*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_XmlDestination_1_RootElementName" data-uid="ETLBox.DataFlow.Connectors.XmlDestination`1.RootElementName">RootElementName</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Connectors_XmlDestination_1_Settings_" data-uid="ETLBox.DataFlow.Connectors.XmlDestination`1.Settings*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_XmlDestination_1_Settings" data-uid="ETLBox.DataFlow.Connectors.XmlDestination`1.Settings">Settings</h4>
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">System.Xml.XmlWriterSettings</span></td>
        <td></td>
      </tr>
    </tbody>
  </table>
