...
description: "Details for Class ConcurrentMemoryDestination<TInput> (ETLBox.DataFlow.Connectors)"
draft: false
images: []
menu:
  api:
...
the <a class="xref" href="/api/etlbox.dataflow.connectors/memorydestination">MemoryDestination</a> which uses a regular List&lt;T&gt;.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level4"><a class="xref" href="/api/etlbox.dataflow.connectors/memorydestination-1">MemoryDestination</a>&lt;TInput&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/memorydestination-1#ETLBox_DataFlow_Connectors_MemoryDestination_1_CheckParameter">MemoryDestination&lt;TInput&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/memorydestination-1#ETLBox_DataFlow_Connectors_MemoryDestination_1_InitComponent">MemoryDestination&lt;TInput&gt;.InitComponent()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Connectors</h6>
  ...
  <h5 id="ETLBox_DataFlow_Connectors_ConcurrentMemoryDestination_1_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">System.Collections.Concurrent.BlockingCollection</span>&lt;TInput&gt;</td>
        <td></td>
      </tr>
    </tbody>
  </table>
...
{{< rawhtml >}}
  <h5 class="overrides">Overrides</h5>
  <div><span class="xref">ETLBox.DataFlow.Connectors.MemoryDestination&lt;TInput&gt;.CleanUpOnSuccess()</span></div>
