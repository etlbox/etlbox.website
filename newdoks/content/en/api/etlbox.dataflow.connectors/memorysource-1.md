...
description: "Details for Class MemorySource<TOutput> (ETLBox.DataFlow.Connectors)"
draft: false
images: []
menu:
  api:
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Connectors</h6>
  ...
  <h5 id="ETLBox_DataFlow_Connectors_MemorySource_1_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <h5 id="ETLBox_DataFlow_Connectors_MemorySource_1_examples"><strong>Examples</strong></h5>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><p>Set the source collection and stores it in <a class="xref" href="/api/etlbox.dataflow.connectors/memorysource-1#ETLBox_DataFlow_Connectors_MemorySource_1_Data">Data</a></p>
</td>
      </tr>
    </tbody>
  </table>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Connectors_MemorySource_1_DataAsList_" data-uid="ETLBox.DataFlow.Connectors.MemorySource`1.DataAsList*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_MemorySource_1_DataAsList" data-uid="ETLBox.DataFlow.Connectors.MemorySource`1.DataAsList">DataAsList</h4>
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">System.Collections.Generic.IList</span>&lt;TOutput&gt;</td>
        <td></td>
      </tr>
    </tbody>
  </table>
