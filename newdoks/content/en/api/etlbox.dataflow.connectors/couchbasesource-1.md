...
description: "Details for Class CouchbaseSource<TOutput> (ETLBox.DataFlow.Connectors)"
draft: false
images: []
menu:
  api:
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Connectors</h6>
  ...
  <h5 id="ETLBox_DataFlow_Connectors_CouchbaseSource_1_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class CouchbaseSource<TOutput> : DataFlowExecutableSource<TOutput>, ILoggableTask, IDataFlowLogging, IDataFlowExecutableSource<TOutput>, IDataFlowSource<TOutput>, IDataFlowSource, IDataFlowComponent, IDataFlowExecutableSource
```
...
use <a class="xref" href="/api/etlbox.dataflow.connectors/couchbasesource-1#ETLBox_DataFlow_Connectors_CouchbaseSource_1_CouchbaseCluster">CouchbaseCluster</a> instead to pass it directly to the component.
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Connectors_CouchbaseSource_1_ConnectionString_" data-uid="ETLBox.DataFlow.Connectors.CouchbaseSource`1.ConnectionString*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CouchbaseSource_1_ConnectionString" data-uid="ETLBox.DataFlow.Connectors.CouchbaseSource`1.ConnectionString">ConnectionString</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Connectors_CouchbaseSource_1_CouchbaseCluster_" data-uid="ETLBox.DataFlow.Connectors.CouchbaseSource`1.CouchbaseCluster*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CouchbaseSource_1_CouchbaseCluster" data-uid="ETLBox.DataFlow.Connectors.CouchbaseSource`1.CouchbaseCluster">CouchbaseCluster</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Connectors_CouchbaseSource_1_N1QLStatement_" data-uid="ETLBox.DataFlow.Connectors.CouchbaseSource`1.N1QLStatement*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CouchbaseSource_1_N1QLStatement" data-uid="ETLBox.DataFlow.Connectors.CouchbaseSource`1.N1QLStatement">N1QLStatement</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Connectors_CouchbaseSource_1_Options_" data-uid="ETLBox.DataFlow.Connectors.CouchbaseSource`1.Options*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CouchbaseSource_1_Options" data-uid="ETLBox.DataFlow.Connectors.CouchbaseSource`1.Options">Options</h4>
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">Couchbase.Query.QueryOptions</span></td>
        <td></td>
      </tr>
    </tbody>
  </table>
