...
description: "Details for Class CsvDestination<TInput> (ETLBox.DataFlow.Connectors)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1">
  <h1 id="ETLBox_DataFlow_Connectors_CsvDestination_1" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1" class="text-break">Class CsvDestination&lt;TInput&gt;
</h1>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><span class="xref">CsvDestination&lt;TInput&gt;</span></div>
      <div class="level6"><a class="xref" href="/api/etlbox.dataflow.connectors/csvdestination">CsvDestination</a></div>
  </div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Connectors</h6>
  ...
  <h5 id="ETLBox_DataFlow_Connectors_CsvDestination_1_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <h5 id="ETLBox_DataFlow_Connectors_CsvDestination_1_examples"><strong>Examples</strong></h5>
...
dest.Wait(); //Wait for all data to arrive</code></pre>
  ...
  <a id="ETLBox_DataFlow_Connectors_CsvDestination_1__ctor_" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CsvDestination_1__ctor" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1.#ctor">CsvDestination()</h4>
...
{{< rawhtml >}}
  <h5 id="ETLBox_DataFlow_Connectors_CsvDestination_1__ctor_examples">Examples</h5>
  <pre><code>CsvDestination&lt;MyRow> dest = new CsvDestination&lt;MyRow>(&quot;/path/to/file.csv&quot;);
dest.Wait(); //Wait for all data to arrive</code></pre>
  <a id="ETLBox_DataFlow_Connectors_CsvDestination_1__ctor_" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CsvDestination_1__ctor_System_String_ETLBox_DataFlow_ResourceType_" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1.#ctor(System.String,ETLBox.DataFlow.ResourceType)">CsvDestination(String, ResourceType)</h4>
  <div class="markdown level1 summary"><p>A Csv destination defines a csv file where data from the flow is inserted.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Connectors_CsvDestination_1__ctor_" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CsvDestination_1__ctor_System_String_" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1.#ctor(System.String)">CsvDestination(String)</h4>
  <div class="markdown level1 summary"><p>A Csv destination defines a csv file where data from the flow is inserted.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Connectors_CsvDestination_1_Configuration_" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1.Configuration*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CsvDestination_1_Configuration" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1.Configuration">Configuration</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Connectors_CsvDestination_1_CsvContext_" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1.CsvContext*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CsvDestination_1_CsvContext" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1.CsvContext">CsvContext</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Connectors_CsvDestination_1_TaskName_" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1.TaskName*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CsvDestination_1_TaskName" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1.TaskName">TaskName</h4>
  <div class="markdown level1 summary"><p>A Csv destination defines a csv file where data from the flow is inserted.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Connectors_CsvDestination_1_CheckParameter_" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1.CheckParameter*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CsvDestination_1_CheckParameter" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1.CheckParameter">CheckParameter()</h4>
  <div class="markdown level1 summary"><p>A Csv destination defines a csv file where data from the flow is inserted.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
...
{{< rawhtml >}}
  ...
  <h5 id="ETLBox_DataFlow_Connectors_CsvDestination_1_CheckParameter_examples">Examples</h5>
  <pre><code>CsvDestination&lt;MyRow> dest = new CsvDestination&lt;MyRow>(&quot;/path/to/file.csv&quot;);
dest.Wait(); //Wait for all data to arrive</code></pre>
  <a id="ETLBox_DataFlow_Connectors_CsvDestination_1_CloseStream_" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1.CloseStream*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CsvDestination_1_CloseStream" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1.CloseStream">CloseStream()</h4>
  <div class="markdown level1 summary"><p>A Csv destination defines a csv file where data from the flow is inserted.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
...
{{< rawhtml >}}
  ...
  <h5 id="ETLBox_DataFlow_Connectors_CsvDestination_1_CloseStream_examples">Examples</h5>
  <pre><code>CsvDestination&lt;MyRow> dest = new CsvDestination&lt;MyRow>(&quot;/path/to/file.csv&quot;);
dest.Wait(); //Wait for all data to arrive</code></pre>
  <a id="ETLBox_DataFlow_Connectors_CsvDestination_1_InitStream_" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1.InitStream*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CsvDestination_1_InitStream" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1.InitStream">InitStream()</h4>
  <div class="markdown level1 summary"><p>A Csv destination defines a csv file where data from the flow is inserted.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
...
{{< rawhtml >}}
  ...
  <h5 id="ETLBox_DataFlow_Connectors_CsvDestination_1_InitStream_examples">Examples</h5>
  <pre><code>CsvDestination&lt;MyRow> dest = new CsvDestination&lt;MyRow>(&quot;/path/to/file.csv&quot;);
dest.Wait(); //Wait for all data to arrive</code></pre>
  <a id="ETLBox_DataFlow_Connectors_CsvDestination_1_WriteIntoStream_" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1.WriteIntoStream*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CsvDestination_1_WriteIntoStream__0_" data-uid="ETLBox.DataFlow.Connectors.CsvDestination`1.WriteIntoStream(`0)">WriteIntoStream(TInput)</h4>
  <div class="markdown level1 summary"><p>A Csv destination defines a csv file where data from the flow is inserted.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
...
{{< rawhtml >}}
  ...
  <h5 id="ETLBox_DataFlow_Connectors_CsvDestination_1_WriteIntoStream__0__examples">Examples</h5>
  <pre><code>CsvDestination&lt;MyRow> dest = new CsvDestination&lt;MyRow>(&quot;/path/to/file.csv&quot;);
dest.Wait(); //Wait for all data to arrive</code></pre>
