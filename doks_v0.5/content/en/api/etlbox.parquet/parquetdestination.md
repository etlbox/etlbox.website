...
{{< rawhtml >}}
  ...
  <div class="inheritance">
    ...
    <div class="level4"><a class="xref" href="ETLBox.DataFlow.DataFlowStreamDestination-1.html">DataFlowStreamDestination</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
    <div class="level5"><a class="xref" href="ETLBox.Parquet.ParquetDestination-1.html">ParquetDestination</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
    <div class="level6"><span class="xref">ParquetDestination</span></div>
  </div>
  <div class="implements">
    <h5>Implements</h5>
    <div><a class="xref" href="/api/etlbox/idataflowlogging">IDataFlowLogging</a></div>
    <div><a class="xref" href="ETLBox.IDataFlowStreamDestination-1.html">IDataFlowStreamDestination</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.parquet/parquetdestination-1#ETLBox_Parquet_ParquetDestination_1_TaskName">ParquetDestination&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.parquet/parquetdestination-1#ETLBox_Parquet_ParquetDestination_1_PrepareParameter">ParquetDestination&lt;ExpandoObject&gt;.PrepareParameter()</a>
    </div>
    <div>
