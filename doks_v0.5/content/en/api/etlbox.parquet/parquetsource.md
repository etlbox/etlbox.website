---
title: "ParquetSource"
description: "Details for Class ParquetSource (ETLBox.Parquet)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
  ...
  <div class="inheritance">
    ...
    <div class="level6"><a class="xref" href="ETLBox.Parquet.ParquetSource-1.html">ParquetSource</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
    <div class="level7"><span class="xref">ParquetSource</span></div>
  </div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.parquet/parquetsource-1#ETLBox_Parquet_ParquetSource_1_TaskName">ParquetSource&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.parquet/parquetsource-1#ETLBox_Parquet_ParquetSource_1_ParquetColumns">ParquetSource&lt;ExpandoObject&gt;.ParquetColumns</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.parquet/parquetsource-1#ETLBox_Parquet_ParquetSource_1_ParquetOptions">ParquetSource&lt;ExpandoObject&gt;.ParquetOptions</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.parquet/parquetsource-1#ETLBox_Parquet_ParquetSource_1_PrepareParameter">ParquetSource&lt;ExpandoObject&gt;.PrepareParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.parquet/parquetsource-1#ETLBox_Parquet_ParquetSource_1_CheckParameter">ParquetSource&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.parquet/parquetsource-1#ETLBox_Parquet_ParquetSource_1_InitReader">ParquetSource&lt;ExpandoObject&gt;.InitReader()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.parquet/parquetsource-1#ETLBox_Parquet_ParquetSource_1_SupportedDataTypes">ParquetSource&lt;ExpandoObject&gt;.SupportedDataTypes</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.parquet/parquetsource-1#ETLBox_Parquet_ParquetSource_1_ReadAllRecords">ParquetSource&lt;ExpandoObject&gt;.ReadAllRecords()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.parquet/parquetsource-1#ETLBox_Parquet_ParquetSource_1_FindPropNameMapping_System_String_">ParquetSource&lt;ExpandoObject&gt;.FindPropNameMapping(string)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.parquet/parquetsource-1#ETLBox_Parquet_ParquetSource_1_CloseReader">ParquetSource&lt;ExpandoObject&gt;.CloseReader()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.Parquet</h6>
  ...
  <h5 id="ETLBox_Parquet_ParquetSource_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Parquet_ParquetSource__ctor_" data-uid="ETLBox.Parquet.ParquetSource.#ctor*"></a>
  <h4 id="ETLBox_Parquet_ParquetSource__ctor" data-uid="ETLBox.Parquet.ParquetSource.#ctor">ParquetSource()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_Parquet_ParquetSource__ctor_" data-uid="ETLBox.Parquet.ParquetSource.#ctor*"></a>
  <h4 id="ETLBox_Parquet_ParquetSource__ctor_System_String_" data-uid="ETLBox.Parquet.ParquetSource.#ctor(System.String)">ParquetSource(string)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Parquet_ParquetSource__ctor_" data-uid="ETLBox.Parquet.ParquetSource.#ctor*"></a>
  <h4 id="ETLBox_Parquet_ParquetSource__ctor_System_String_ETLBox_ResourceType_" data-uid="ETLBox.Parquet.ParquetSource.#ctor(System.String,ETLBox.ResourceType)">ParquetSource(string, ResourceType)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
