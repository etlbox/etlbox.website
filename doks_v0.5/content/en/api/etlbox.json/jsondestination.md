...
{{< rawhtml >}}
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.json/jsondestination-1">JsonDestination</a>&lt;<span class="xref">ExpandoObject</span>&gt;</div>
...
```C#
    public class JsonDestination : JsonDestination<ExpandoObject>, ILoggableTask, IDataFlowLogging, IDataFlowStreamDestination<ExpandoObject>, IDataFlowDestination<ExpandoObject>, IDataFlowStreamDestination, IDataFlowDestination, IDataFlowComponent
```
