---
title: "JsonSource"
description: "Details for Class JsonSource (ETLBox.Json)"
draft: false
images: []
menu:
  api:
...
By default, data is pulled via httpclient. Use the ResourceType property to read data from a file.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level6"><a class="xref" href="ETLBox.Json.JsonSource-1.html">JsonSource</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.json/jsonsource-1#ETLBox_Json_JsonSource_1_TaskName">JsonSource&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.json/jsonsource-1#ETLBox_Json_JsonSource_1_JsonSerializer">JsonSource&lt;ExpandoObject&gt;.JsonSerializer</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.json/jsonsource-1#ETLBox_Json_JsonSource_1_PropertyNameOfDataArray">JsonSource&lt;ExpandoObject&gt;.PropertyNameOfDataArray</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.json/jsonsource-1#ETLBox_Json_JsonSource_1_CheckParameter">JsonSource&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.json/jsonsource-1#ETLBox_Json_JsonSource_1_InitReader">JsonSource&lt;ExpandoObject&gt;.InitReader()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.json/jsonsource-1#ETLBox_Json_JsonSource_1_ReadAllRecords">JsonSource&lt;ExpandoObject&gt;.ReadAllRecords()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.json/jsonsource-1#ETLBox_Json_JsonSource_1_CloseReader">JsonSource&lt;ExpandoObject&gt;.CloseReader()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.Json</h6>
  ...
  <h5 id="ETLBox_Json_JsonSource_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <h4 id="ETLBox_Json_JsonSource__ctor" data-uid="ETLBox.Json.JsonSource.#ctor">JsonSource()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_Json_JsonSource__ctor_" data-uid="ETLBox.Json.JsonSource.#ctor*"></a>
  <h4 id="ETLBox_Json_JsonSource__ctor_System_String_" data-uid="ETLBox.Json.JsonSource.#ctor(System.String)">JsonSource(string)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Json_JsonSource__ctor_" data-uid="ETLBox.Json.JsonSource.#ctor*"></a>
  <h4 id="ETLBox_Json_JsonSource__ctor_System_String_ETLBox_ResourceType_" data-uid="ETLBox.Json.JsonSource.#ctor(System.String,ETLBox.ResourceType)">JsonSource(string, ResourceType)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
