---
title: "CompareColumn"
description: "Details for Class CompareColumn (ETLBox)"
draft: false
images: []
menu:
  api:
...
object that exists and needs to be updated.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level2"><span class="xref">CompareColumn</span></div>
  </div>
...
<h6><strong>Namespace</strong>: ETLBox</h6>
  ...
  <h5 id="ETLBox_CompareColumn_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  <h5 id="ETLBox_CompareColumn_examples"><strong>Examples</strong></h5>
  <pre><code class="lang-csharp"> public class MyPoco 
{
  ...
  <a id="ETLBox_CompareColumn__ctor_" data-uid="ETLBox.CompareColumn.#ctor*"></a>
  <h4 id="ETLBox_CompareColumn__ctor" data-uid="ETLBox.CompareColumn.#ctor">CompareColumn()</h4>
