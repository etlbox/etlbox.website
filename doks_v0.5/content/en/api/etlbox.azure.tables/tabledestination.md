---
title: "TableDestination"
description: "Details for Class TableDestination (ETLBox.Azure.Tables)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.Azure.Tables.TableDestination">
  <h1 id="ETLBox_Azure_Tables_TableDestination" data-uid="ETLBox.Azure.Tables.TableDestination" class="text-break">Class TableDestination
</h1>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="ETLBox.Azure.Tables.TableDestination-1.html">TableDestination</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
...
<h6><strong>Namespace</strong>: ETLBox.Azure.Tables</h6>
  ...
  <h5 id="ETLBox_Azure_Tables_TableDestination_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class TableDestination : TableDestination<ExpandoObject>, IDataFlowLogging, IDataFlowBatchDestination<ExpandoObject>, IDataFlowDestination<ExpandoObject>, IDataFlowBatchDestination, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```

{{< rawhtml >}}
  <h3 id="constructors">Constructors
</h3>
  <a id="ETLBox_Azure_Tables_TableDestination__ctor_" data-uid="ETLBox.Azure.Tables.TableDestination.#ctor*"></a>
  <h4 id="ETLBox_Azure_Tables_TableDestination__ctor" data-uid="ETLBox.Azure.Tables.TableDestination.#ctor">TableDestination()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_Azure_Tables_TableDestination__ctor_" data-uid="ETLBox.Azure.Tables.TableDestination.#ctor*"></a>
  <h4 id="ETLBox_Azure_Tables_TableDestination__ctor_System_Int32_" data-uid="ETLBox.Azure.Tables.TableDestination.#ctor(System.Int32)">TableDestination(int)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Azure_Tables_TableDestination__ctor_" data-uid="ETLBox.Azure.Tables.TableDestination.#ctor*"></a>
  <h4 id="ETLBox_Azure_Tables_TableDestination__ctor_System_String_System_String_" data-uid="ETLBox.Azure.Tables.TableDestination.#ctor(System.String,System.String)">TableDestination(string, string)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
