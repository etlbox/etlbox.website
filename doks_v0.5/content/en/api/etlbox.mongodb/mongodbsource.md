---
title: "MongoDbSource"
description: "Details for Class MongoDbSource (ETLBox.MongoDb)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.MongoDb.MongoDbSource">
  <h1 id="ETLBox_MongoDb_MongoDbSource" data-uid="ETLBox.MongoDb.MongoDbSource" class="text-break">Class MongoDbSource
</h1>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="ETLBox.MongoDb.MongoDbSource-1.html">MongoDbSource</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.mongodb/mongodbsource-1#ETLBox_MongoDb_MongoDbSource_1_TaskName">MongoDbSource&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.mongodb/mongodbsource-1#ETLBox_MongoDb_MongoDbSource_1_ConnectionString">MongoDbSource&lt;ExpandoObject&gt;.ConnectionString</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.mongodb/mongodbsource-1#ETLBox_MongoDb_MongoDbSource_1_DbClient">MongoDbSource&lt;ExpandoObject&gt;.DbClient</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.mongodb/mongodbsource-1#ETLBox_MongoDb_MongoDbSource_1_DatabaseName">MongoDbSource&lt;ExpandoObject&gt;.DatabaseName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.mongodb/mongodbsource-1#ETLBox_MongoDb_MongoDbSource_1_CollectionName">MongoDbSource&lt;ExpandoObject&gt;.CollectionName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.mongodb/mongodbsource-1#ETLBox_MongoDb_MongoDbSource_1_Filter">MongoDbSource&lt;ExpandoObject&gt;.Filter</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.mongodb/mongodbsource-1#ETLBox_MongoDb_MongoDbSource_1_FindOptions">MongoDbSource&lt;ExpandoObject&gt;.FindOptions</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.mongodb/mongodbsource-1#ETLBox_MongoDb_MongoDbSource_1_DEFAULT_BATCH_SIZE">MongoDbSource&lt;ExpandoObject&gt;.DEFAULT_BATCH_SIZE</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.mongodb/mongodbsource-1#ETLBox_MongoDb_MongoDbSource_1_CheckParameter">MongoDbSource&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.mongodb/mongodbsource-1#ETLBox_MongoDb_MongoDbSource_1_OnExecutionDoSynchronousWork">MongoDbSource&lt;ExpandoObject&gt;.OnExecutionDoSynchronousWork()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.mongodb/mongodbsource-1#ETLBox_MongoDb_MongoDbSource_1_OnExecutionDoAsyncWork">MongoDbSource&lt;ExpandoObject&gt;.OnExecutionDoAsyncWork()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.mongodb/mongodbsource-1#ETLBox_MongoDb_MongoDbSource_1_CleanUpOnSuccess">MongoDbSource&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.mongodb/mongodbsource-1#ETLBox_MongoDb_MongoDbSource_1_CleanUpOnFaulted_System_Exception_">MongoDbSource&lt;ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.MongoDb</h6>
  ...
  <h5 id="ETLBox_MongoDb_MongoDbSource_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class MongoDbSource : MongoDbSource<ExpandoObject>, IDataFlowLogging, IDataFlowExecutableSource<ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowExecutableSource, IDataFlowSource, IDataFlowComponent, ILoggableTask
```

{{< rawhtml >}}
  <h3 id="constructors">Constructors
</h3>
  <a id="ETLBox_MongoDb_MongoDbSource__ctor_" data-uid="ETLBox.MongoDb.MongoDbSource.#ctor*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbSource__ctor" data-uid="ETLBox.MongoDb.MongoDbSource.#ctor">MongoDbSource()</h4>
