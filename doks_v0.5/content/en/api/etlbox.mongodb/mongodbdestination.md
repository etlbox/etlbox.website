...
{{< rawhtml >}}
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.mongodb/mongodbdestination-1">MongoDbDestination</a>&lt;<span class="xref">ExpandoObject</span>&gt;</div>
...
```C#
    public class MongoDbDestination : MongoDbDestination<ExpandoObject>, ILoggableTask, IDataFlowLogging, IDataFlowBatchDestination<ExpandoObject>, IDataFlowDestination<ExpandoObject>, IDataFlowBatchDestination, IDataFlowDestination, IDataFlowComponent
```
