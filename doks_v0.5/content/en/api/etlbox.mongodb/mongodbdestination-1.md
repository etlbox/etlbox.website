...
description: "Details for Class MongoDbDestination<TInput> (ETLBox.MongoDb)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
  ...
  <div class="inheritance">
    ...
    <div class="level5"><span class="xref">MongoDbDestination&lt;TInput&gt;</span></div>
      <div class="level6"><a class="xref" href="/api/etlbox.mongodb/mongodbdestination">MongoDbDestination</a></div>
  </div>
...
<h6><strong>Namespace</strong>: ETLBox.MongoDb</h6>
  ...
  <h5 id="ETLBox_MongoDb_MongoDbDestination_1_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class MongoDbDestination<TInput> : DataFlowBatchDestination<TInput>, ILoggableTask, IDataFlowLogging, IDataFlowBatchDestination<TInput>, IDataFlowDestination<TInput>, IDataFlowBatchDestination, IDataFlowDestination, IDataFlowComponent
```
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_MongoDb_MongoDbDestination_1__ctor_" data-uid="ETLBox.MongoDb.MongoDbDestination`1.#ctor*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbDestination_1__ctor" data-uid="ETLBox.MongoDb.MongoDbDestination`1.#ctor">MongoDbDestination()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_MongoDb_MongoDbDestination_1__ctor_" data-uid="ETLBox.MongoDb.MongoDbDestination`1.#ctor*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbDestination_1__ctor_System_Int32_" data-uid="ETLBox.MongoDb.MongoDbDestination`1.#ctor(System.Int32)">MongoDbDestination(int)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_MongoDb_MongoDbDestination_1_CollectionName_" data-uid="ETLBox.MongoDb.MongoDbDestination`1.CollectionName*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbDestination_1_CollectionName" data-uid="ETLBox.MongoDb.MongoDbDestination`1.CollectionName">CollectionName</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_MongoDb_MongoDbDestination_1_ConnectionString_" data-uid="ETLBox.MongoDb.MongoDbDestination`1.ConnectionString*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbDestination_1_ConnectionString" data-uid="ETLBox.MongoDb.MongoDbDestination`1.ConnectionString">ConnectionString</h4>
...
use <a class="xref" href="/api/etlbox.mongodb/mongodbdestination-1#ETLBox_MongoDb_MongoDbDestination_1_DbClient">DbClient</a> instead to pass it directly to the component.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_MongoDb_MongoDbDestination_1_DatabaseName_" data-uid="ETLBox.MongoDb.MongoDbDestination`1.DatabaseName*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbDestination_1_DatabaseName" data-uid="ETLBox.MongoDb.MongoDbDestination`1.DatabaseName">DatabaseName</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_MongoDb_MongoDbDestination_1_DbClient_" data-uid="ETLBox.MongoDb.MongoDbDestination`1.DbClient*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbDestination_1_DbClient" data-uid="ETLBox.MongoDb.MongoDbDestination`1.DbClient">DbClient</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_MongoDb_MongoDbDestination_1_Session_" data-uid="ETLBox.MongoDb.MongoDbDestination`1.Session*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbDestination_1_Session" data-uid="ETLBox.MongoDb.MongoDbDestination`1.Session">Session</h4>
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">IClientSessionHandle</span></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  <a id="ETLBox_MongoDb_MongoDbDestination_1_TaskName_" data-uid="ETLBox.MongoDb.MongoDbDestination`1.TaskName*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbDestination_1_TaskName" data-uid="ETLBox.MongoDb.MongoDbDestination`1.TaskName">TaskName</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_MongoDb_MongoDbDestination_1_BulkInsertData_" data-uid="ETLBox.MongoDb.MongoDbDestination`1.BulkInsertData*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbDestination_1_BulkInsertData__0___" data-uid="ETLBox.MongoDb.MongoDbDestination`1.BulkInsertData(`0[])">BulkInsertData(TInput[])</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_MongoDb_MongoDbDestination_1_CheckParameter_" data-uid="ETLBox.MongoDb.MongoDbDestination`1.CheckParameter*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbDestination_1_CheckParameter" data-uid="ETLBox.MongoDb.MongoDbDestination`1.CheckParameter">CheckParameter()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_MongoDb_MongoDbDestination_1_FinishWrite_" data-uid="ETLBox.MongoDb.MongoDbDestination`1.FinishWrite*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbDestination_1_FinishWrite" data-uid="ETLBox.MongoDb.MongoDbDestination`1.FinishWrite">FinishWrite()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_MongoDb_MongoDbDestination_1_InitParameter_" data-uid="ETLBox.MongoDb.MongoDbDestination`1.InitParameter*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbDestination_1_InitParameter" data-uid="ETLBox.MongoDb.MongoDbDestination`1.InitParameter">InitParameter()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_MongoDb_MongoDbDestination_1_PrepareWrite_" data-uid="ETLBox.MongoDb.MongoDbDestination`1.PrepareWrite*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbDestination_1_PrepareWrite" data-uid="ETLBox.MongoDb.MongoDbDestination`1.PrepareWrite">PrepareWrite()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
