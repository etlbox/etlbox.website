...
description: "Details for Class MongoDbSource<TOutput> (ETLBox.MongoDb)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.MongoDb.MongoDbSource`1">
  <h1 id="ETLBox_MongoDb_MongoDbSource_1" data-uid="ETLBox.MongoDb.MongoDbSource`1" class="text-break">Class MongoDbSource&lt;TOutput&gt;
</h1>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><span class="xref">MongoDbSource&lt;TOutput&gt;</span></div>
      <div class="level6"><a class="xref" href="/api/etlbox.mongodb/mongodbsource">MongoDbSource</a></div>
  </div>
...
<h6><strong>Namespace</strong>: ETLBox.MongoDb</h6>
  ...
  <h5 id="ETLBox_MongoDb_MongoDbSource_1_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_MongoDb_MongoDbSource_1__ctor_" data-uid="ETLBox.MongoDb.MongoDbSource`1.#ctor*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbSource_1__ctor" data-uid="ETLBox.MongoDb.MongoDbSource`1.#ctor">MongoDbSource()</h4>
...
{{< rawhtml >}}
  ...
  <h4 id="ETLBox_MongoDb_MongoDbSource_1_DEFAULT_BATCH_SIZE" data-uid="ETLBox.MongoDb.MongoDbSource`1.DEFAULT_BATCH_SIZE">DEFAULT_BATCH_SIZE</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_MongoDb_MongoDbSource_1_CollectionName_" data-uid="ETLBox.MongoDb.MongoDbSource`1.CollectionName*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbSource_1_CollectionName" data-uid="ETLBox.MongoDb.MongoDbSource`1.CollectionName">CollectionName</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_MongoDb_MongoDbSource_1_ConnectionString_" data-uid="ETLBox.MongoDb.MongoDbSource`1.ConnectionString*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbSource_1_ConnectionString" data-uid="ETLBox.MongoDb.MongoDbSource`1.ConnectionString">ConnectionString</h4>
...
use <a class="xref" href="/api/etlbox.mongodb/mongodbsource-1#ETLBox_MongoDb_MongoDbSource_1_DbClient">DbClient</a> instead to pass it directly to the component.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_MongoDb_MongoDbSource_1_DatabaseName_" data-uid="ETLBox.MongoDb.MongoDbSource`1.DatabaseName*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbSource_1_DatabaseName" data-uid="ETLBox.MongoDb.MongoDbSource`1.DatabaseName">DatabaseName</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_MongoDb_MongoDbSource_1_DbClient_" data-uid="ETLBox.MongoDb.MongoDbSource`1.DbClient*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbSource_1_DbClient" data-uid="ETLBox.MongoDb.MongoDbSource`1.DbClient">DbClient</h4>
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">MongoClient</span></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  <a id="ETLBox_MongoDb_MongoDbSource_1_Filter_" data-uid="ETLBox.MongoDb.MongoDbSource`1.Filter*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbSource_1_Filter" data-uid="ETLBox.MongoDb.MongoDbSource`1.Filter">Filter</h4>
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">FilterDefinition&lt;&gt;</span>&lt;<span class="xref">BsonDocument</span>&gt;</td>
        <td></td>
      </tr>
    </tbody>
  </table>
  <a id="ETLBox_MongoDb_MongoDbSource_1_FindOptions_" data-uid="ETLBox.MongoDb.MongoDbSource`1.FindOptions*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbSource_1_FindOptions" data-uid="ETLBox.MongoDb.MongoDbSource`1.FindOptions">FindOptions</h4>
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">FindOptions</span></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  <a id="ETLBox_MongoDb_MongoDbSource_1_TaskName_" data-uid="ETLBox.MongoDb.MongoDbSource`1.TaskName*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbSource_1_TaskName" data-uid="ETLBox.MongoDb.MongoDbSource`1.TaskName">TaskName</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_MongoDb_MongoDbSource_1_CheckParameter_" data-uid="ETLBox.MongoDb.MongoDbSource`1.CheckParameter*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbSource_1_CheckParameter" data-uid="ETLBox.MongoDb.MongoDbSource`1.CheckParameter">CheckParameter()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_MongoDb_MongoDbSource_1_CleanUpOnFaulted_" data-uid="ETLBox.MongoDb.MongoDbSource`1.CleanUpOnFaulted*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbSource_1_CleanUpOnFaulted_System_Exception_" data-uid="ETLBox.MongoDb.MongoDbSource`1.CleanUpOnFaulted(System.Exception)">CleanUpOnFaulted(Exception)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_MongoDb_MongoDbSource_1_CleanUpOnSuccess_" data-uid="ETLBox.MongoDb.MongoDbSource`1.CleanUpOnSuccess*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbSource_1_CleanUpOnSuccess" data-uid="ETLBox.MongoDb.MongoDbSource`1.CleanUpOnSuccess">CleanUpOnSuccess()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_MongoDb_MongoDbSource_1_OnExecutionDoAsyncWork_" data-uid="ETLBox.MongoDb.MongoDbSource`1.OnExecutionDoAsyncWork*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbSource_1_OnExecutionDoAsyncWork" data-uid="ETLBox.MongoDb.MongoDbSource`1.OnExecutionDoAsyncWork">OnExecutionDoAsyncWork()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_MongoDb_MongoDbSource_1_OnExecutionDoSynchronousWork_" data-uid="ETLBox.MongoDb.MongoDbSource`1.OnExecutionDoSynchronousWork*"></a>
  <h4 id="ETLBox_MongoDb_MongoDbSource_1_OnExecutionDoSynchronousWork" data-uid="ETLBox.MongoDb.MongoDbSource`1.OnExecutionDoSynchronousWork">OnExecutionDoSynchronousWork()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
