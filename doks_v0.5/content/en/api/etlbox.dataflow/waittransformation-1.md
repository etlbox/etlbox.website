...
description: "Details for Class WaitTransformation<TInput> (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.WaitTransformation`1">
  <h1 id="ETLBox_DataFlow_WaitTransformation_1" data-uid="ETLBox.DataFlow.WaitTransformation`1" class="text-break">Class WaitTransformation&lt;TInput&gt;
</h1>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_WaitTransformation_1_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_WaitTransformation_1__ctor_" data-uid="ETLBox.DataFlow.WaitTransformation`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_WaitTransformation_1__ctor" data-uid="ETLBox.DataFlow.WaitTransformation`1.#ctor">WaitTransformation()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_WaitTransformation_1__ctor_" data-uid="ETLBox.DataFlow.WaitTransformation`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_WaitTransformation_1__ctor_ETLBox_DataFlow_DataFlowComponent___" data-uid="ETLBox.DataFlow.WaitTransformation`1.#ctor(ETLBox.DataFlow.DataFlowComponent[])">WaitTransformation(params DataFlowComponent[])</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_WaitTransformation_1__ctor_" data-uid="ETLBox.DataFlow.WaitTransformation`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_WaitTransformation_1__ctor_System_Threading_Tasks_TaskCompletionSource_System_Boolean____" data-uid="ETLBox.DataFlow.WaitTransformation`1.#ctor(System.Threading.Tasks.TaskCompletionSource{System.Boolean}[])">WaitTransformation(params TaskCompletionSource&lt;bool&gt;[])</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="https://learn.microsoft.com/dotnet/api/system.threading.tasks.taskcompletionsource-1">TaskCompletionSource</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.boolean">bool</a>&gt;[]</td>
  ...
  <a id="ETLBox_DataFlow_WaitTransformation_1_DataFlowComponents_" data-uid="ETLBox.DataFlow.WaitTransformation`1.DataFlowComponents*"></a>
  <h4 id="ETLBox_DataFlow_WaitTransformation_1_DataFlowComponents" data-uid="ETLBox.DataFlow.WaitTransformation`1.DataFlowComponents">DataFlowComponents</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_WaitTransformation_1_SourceBlock_" data-uid="ETLBox.DataFlow.WaitTransformation`1.SourceBlock*"></a>
  <h4 id="ETLBox_DataFlow_WaitTransformation_1_SourceBlock" data-uid="ETLBox.DataFlow.WaitTransformation`1.SourceBlock">SourceBlock</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_WaitTransformation_1_TargetBlock_" data-uid="ETLBox.DataFlow.WaitTransformation`1.TargetBlock*"></a>
  <h4 id="ETLBox_DataFlow_WaitTransformation_1_TargetBlock" data-uid="ETLBox.DataFlow.WaitTransformation`1.TargetBlock">TargetBlock</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_WaitTransformation_1_TaskCompletionSources_" data-uid="ETLBox.DataFlow.WaitTransformation`1.TaskCompletionSources*"></a>
  <h4 id="ETLBox_DataFlow_WaitTransformation_1_TaskCompletionSources" data-uid="ETLBox.DataFlow.WaitTransformation`1.TaskCompletionSources">TaskCompletionSources</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_WaitTransformation_1_TaskName_" data-uid="ETLBox.DataFlow.WaitTransformation`1.TaskName*"></a>
  <h4 id="ETLBox_DataFlow_WaitTransformation_1_TaskName" data-uid="ETLBox.DataFlow.WaitTransformation`1.TaskName">TaskName</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_WaitTransformation_1_CheckParameter_" data-uid="ETLBox.DataFlow.WaitTransformation`1.CheckParameter*"></a>
  <h4 id="ETLBox_DataFlow_WaitTransformation_1_CheckParameter" data-uid="ETLBox.DataFlow.WaitTransformation`1.CheckParameter">CheckParameter()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_WaitTransformation_1_CleanUpOnFaulted_" data-uid="ETLBox.DataFlow.WaitTransformation`1.CleanUpOnFaulted*"></a>
  <h4 id="ETLBox_DataFlow_WaitTransformation_1_CleanUpOnFaulted_System_Exception_" data-uid="ETLBox.DataFlow.WaitTransformation`1.CleanUpOnFaulted(System.Exception)">CleanUpOnFaulted(Exception)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_WaitTransformation_1_CleanUpOnSuccess_" data-uid="ETLBox.DataFlow.WaitTransformation`1.CleanUpOnSuccess*"></a>
  <h4 id="ETLBox_DataFlow_WaitTransformation_1_CleanUpOnSuccess" data-uid="ETLBox.DataFlow.WaitTransformation`1.CleanUpOnSuccess">CleanUpOnSuccess()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_WaitTransformation_1_InitComponent_" data-uid="ETLBox.DataFlow.WaitTransformation`1.InitComponent*"></a>
  <h4 id="ETLBox_DataFlow_WaitTransformation_1_InitComponent" data-uid="ETLBox.DataFlow.WaitTransformation`1.InitComponent">InitComponent()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
