---
title: "Sort"
description: "Details for Class Sort (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
This is a blocking transformation - no output will be produced until all input data has arrived in the transformation.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="ETLBox.DataFlow.Sort-1.html">Sort</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/sort-1#ETLBox_DataFlow_Sort_1_TaskName">Sort&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/sort-1#ETLBox_DataFlow_Sort_1_MaxBufferSize">Sort&lt;ExpandoObject&gt;.MaxBufferSize</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/sort-1#ETLBox_DataFlow_Sort_1_TargetBlock">Sort&lt;ExpandoObject&gt;.TargetBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/sort-1#ETLBox_DataFlow_Sort_1_ProgressCount">Sort&lt;ExpandoObject&gt;.ProgressCount</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/sort-1#ETLBox_DataFlow_Sort_1_CheckParameter">Sort&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/sort-1#ETLBox_DataFlow_Sort_1_InitComponent">Sort&lt;ExpandoObject&gt;.InitComponent()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/sort-1#ETLBox_DataFlow_Sort_1_CleanUpOnSuccess">Sort&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_Sort_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <h4 id="ETLBox_DataFlow_Sort__ctor" data-uid="ETLBox.DataFlow.Sort.#ctor">Sort()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_Sort__ctor_" data-uid="ETLBox.DataFlow.Sort.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Sort__ctor_System_Comparison_System_Dynamic_ExpandoObject__" data-uid="ETLBox.DataFlow.Sort.#ctor(System.Comparison{System.Dynamic.ExpandoObject})">Sort(Comparison&lt;ExpandoObject&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="https://learn.microsoft.com/dotnet/api/system.comparison-1">Comparison</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</td>
