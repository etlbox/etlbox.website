---
title: "RowMultiplication<TInput, TOutput>"
description: "Details for Class RowMultiplication<TInput, TOutput> (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
  ...
  <div class="inheritance">
    ...
    <div class="level5"><span class="xref">RowMultiplication&lt;TInput, TOutput&gt;</span></div>
      <div class="level6"><a class="xref" href="/api/etlbox.dataflow/rowmultiplication">RowMultiplication</a></div>
      <div class="level6"><a class="xref" href="/api/etlbox.dataflow/rowmultiplication-1">RowMultiplication&lt;TInput&gt;</a></div>
  </div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_RowMultiplication_2_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class RowMultiplication<TInput, TOutput> : DataFlowTransformation<TInput, TOutput>, IDataFlowLogging, IDataFlowTransformation<TInput, TOutput>, IDataFlowSource<TOutput>, IDataFlowSource, IDataFlowDestination<TInput>, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_RowMultiplication_2__ctor_" data-uid="ETLBox.DataFlow.RowMultiplication`2.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_RowMultiplication_2__ctor" data-uid="ETLBox.DataFlow.RowMultiplication`2.#ctor">RowMultiplication()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_RowMultiplication_2__ctor_" data-uid="ETLBox.DataFlow.RowMultiplication`2.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_RowMultiplication_2__ctor_System_Func__0_System_Collections_Generic_IEnumerable__1___" data-uid="ETLBox.DataFlow.RowMultiplication`2.#ctor(System.Func{`0,System.Collections.Generic.IEnumerable{`1}})">RowMultiplication(Func&lt;TInput, IEnumerable&lt;TOutput&gt;&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_RowMultiplication_2_MultiplicationFunc_" data-uid="ETLBox.DataFlow.RowMultiplication`2.MultiplicationFunc*"></a>
  <h4 id="ETLBox_DataFlow_RowMultiplication_2_MultiplicationFunc" data-uid="ETLBox.DataFlow.RowMultiplication`2.MultiplicationFunc">MultiplicationFunc</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_RowMultiplication_2_SourceBlock_" data-uid="ETLBox.DataFlow.RowMultiplication`2.SourceBlock*"></a>
  <h4 id="ETLBox_DataFlow_RowMultiplication_2_SourceBlock" data-uid="ETLBox.DataFlow.RowMultiplication`2.SourceBlock">SourceBlock</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_RowMultiplication_2_CheckParameter_" data-uid="ETLBox.DataFlow.RowMultiplication`2.CheckParameter*"></a>
  <h4 id="ETLBox_DataFlow_RowMultiplication_2_CheckParameter" data-uid="ETLBox.DataFlow.RowMultiplication`2.CheckParameter">CheckParameter()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_RowMultiplication_2_CleanUpOnFaulted_" data-uid="ETLBox.DataFlow.RowMultiplication`2.CleanUpOnFaulted*"></a>
  <h4 id="ETLBox_DataFlow_RowMultiplication_2_CleanUpOnFaulted_System_Exception_" data-uid="ETLBox.DataFlow.RowMultiplication`2.CleanUpOnFaulted(System.Exception)">CleanUpOnFaulted(Exception)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_RowMultiplication_2_CleanUpOnSuccess_" data-uid="ETLBox.DataFlow.RowMultiplication`2.CleanUpOnSuccess*"></a>
  <h4 id="ETLBox_DataFlow_RowMultiplication_2_CleanUpOnSuccess" data-uid="ETLBox.DataFlow.RowMultiplication`2.CleanUpOnSuccess">CleanUpOnSuccess()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_RowMultiplication_2_InitComponent_" data-uid="ETLBox.DataFlow.RowMultiplication`2.InitComponent*"></a>
  <h4 id="ETLBox_DataFlow_RowMultiplication_2_InitComponent" data-uid="ETLBox.DataFlow.RowMultiplication`2.InitComponent">InitComponent()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
