---
title: "MemorySource"
description: "Details for Class MemorySource (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
By default, an empty List&lt;T&gt; is created which can be filled with data.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="ETLBox.DataFlow.MemorySource-1.html">MemorySource</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/memorysource-1#ETLBox_DataFlow_MemorySource_1_TaskName">MemorySource&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/memorysource-1#ETLBox_DataFlow_MemorySource_1_Data">MemorySource&lt;ExpandoObject&gt;.Data</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/memorysource-1#ETLBox_DataFlow_MemorySource_1_DataAsList">MemorySource&lt;ExpandoObject&gt;.DataAsList</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/memorysource-1#ETLBox_DataFlow_MemorySource_1_CheckParameter">MemorySource&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/memorysource-1#ETLBox_DataFlow_MemorySource_1_OnExecutionDoSynchronousWork">MemorySource&lt;ExpandoObject&gt;.OnExecutionDoSynchronousWork()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/memorysource-1#ETLBox_DataFlow_MemorySource_1_OnExecutionDoAsyncWork">MemorySource&lt;ExpandoObject&gt;.OnExecutionDoAsyncWork()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/memorysource-1#ETLBox_DataFlow_MemorySource_1_CleanUpOnSuccess">MemorySource&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/memorysource-1#ETLBox_DataFlow_MemorySource_1_CleanUpOnFaulted_System_Exception_">MemorySource&lt;ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_MemorySource_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class MemorySource : MemorySource<ExpandoObject>, IDataFlowLogging, IDataFlowExecutableSource<ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowExecutableSource, IDataFlowSource, IDataFlowComponent, ILoggableTask
```
...
{{< rawhtml >}}
  ...
  <h4 id="ETLBox_DataFlow_MemorySource__ctor" data-uid="ETLBox.DataFlow.MemorySource.#ctor">MemorySource()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_MemorySource__ctor_" data-uid="ETLBox.DataFlow.MemorySource.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_MemorySource__ctor_System_Collections_Generic_IList_System_Dynamic_ExpandoObject__" data-uid="ETLBox.DataFlow.MemorySource.#ctor(System.Collections.Generic.IList{System.Dynamic.ExpandoObject})">MemorySource(IList&lt;ExpandoObject&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="https://learn.microsoft.com/dotnet/api/system.collections.generic.ilist-1">IList</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</td>
