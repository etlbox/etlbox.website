...
Use this target for data that you don't want to use in a destination, but you still want your dataflow to complete property.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level4"><a class="xref" href="ETLBox.DataFlow.VoidDestination-1.html">VoidDestination</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/voiddestination-1#ETLBox_DataFlow_VoidDestination_1_TaskName">VoidDestination&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
...
```C#
    public class VoidDestination : VoidDestination<ExpandoObject>, IDataFlowLogging, IDataFlowDestination<ExpandoObject>, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
