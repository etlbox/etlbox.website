...
description: "Details for Class CustomBatchSource<TOutput> (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.CustomBatchSource`1">
  <h1 id="ETLBox_DataFlow_CustomBatchSource_1" data-uid="ETLBox.DataFlow.CustomBatchSource`1" class="text-break">Class CustomBatchSource&lt;TOutput&gt;
</h1>
...
which are then send subsequently into your data flow.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><span class="xref">CustomBatchSource&lt;TOutput&gt;</span></div>
      <div class="level6"><a class="xref" href="/api/etlbox.dataflow/custombatchsource">CustomBatchSource</a></div>
  </div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_CustomBatchSource_1_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_CustomBatchSource_1__ctor_" data-uid="ETLBox.DataFlow.CustomBatchSource`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_CustomBatchSource_1__ctor" data-uid="ETLBox.DataFlow.CustomBatchSource`1.#ctor">CustomBatchSource()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_CustomBatchSource_1__ctor_" data-uid="ETLBox.DataFlow.CustomBatchSource`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_CustomBatchSource_1__ctor_System_Func_System_Int32_System_Collections_Generic_IEnumerable__0___System_Predicate_System_Int32__" data-uid="ETLBox.DataFlow.CustomBatchSource`1.#ctor(System.Func{System.Int32,System.Collections.Generic.IEnumerable{`0}},System.Predicate{System.Int32})">CustomBatchSource(Func&lt;int, IEnumerable&lt;TOutput&gt;&gt;, Predicate&lt;int&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="https://learn.microsoft.com/dotnet/api/system.func-2">Func</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.int32">int</a>, <a class="xref" href="https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1">IEnumerable</a>&lt;TOutput&gt;&gt;</td>
        <td><span class="parametername">readBatchFunc</span></td>
        <td><p>Sets the <a class="xref" href="/api/etlbox.dataflow/custombatchsource-1#ETLBox_DataFlow_CustomBatchSource_1_ReadBatchFunc">ReadBatchFunc</a></p>
</td>
      </tr>
      <tr>
        ...
        <td><p>Sets the <a class="xref" href="/api/etlbox.dataflow/custombatchsource-1#ETLBox_DataFlow_CustomBatchSource_1_ReadingCompleted">ReadingCompleted</a></p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="ETLBox_DataFlow_CustomBatchSource_1_ReadBatchFunc_" data-uid="ETLBox.DataFlow.CustomBatchSource`1.ReadBatchFunc*"></a>
  <h4 id="ETLBox_DataFlow_CustomBatchSource_1_ReadBatchFunc" data-uid="ETLBox.DataFlow.CustomBatchSource`1.ReadBatchFunc">ReadBatchFunc</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_CustomBatchSource_1_ReadingCompleted_" data-uid="ETLBox.DataFlow.CustomBatchSource`1.ReadingCompleted*"></a>
  <h4 id="ETLBox_DataFlow_CustomBatchSource_1_ReadingCompleted" data-uid="ETLBox.DataFlow.CustomBatchSource`1.ReadingCompleted">ReadingCompleted</h4>
  <div class="markdown level1 summary"><p>This predicate returns true when all rows for the flow are successfully returned from the <a class="xref" href="/api/etlbox.dataflow/custombatchsource-1#ETLBox_DataFlow_CustomBatchSource_1_ReadBatchFunc">ReadBatchFunc</a>. An integer value with the
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_CustomBatchSource_1_TaskName_" data-uid="ETLBox.DataFlow.CustomBatchSource`1.TaskName*"></a>
  <h4 id="ETLBox_DataFlow_CustomBatchSource_1_TaskName" data-uid="ETLBox.DataFlow.CustomBatchSource`1.TaskName">TaskName</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_CustomBatchSource_1_CheckParameter_" data-uid="ETLBox.DataFlow.CustomBatchSource`1.CheckParameter*"></a>
  <h4 id="ETLBox_DataFlow_CustomBatchSource_1_CheckParameter" data-uid="ETLBox.DataFlow.CustomBatchSource`1.CheckParameter">CheckParameter()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_CustomBatchSource_1_CleanUpOnFaulted_" data-uid="ETLBox.DataFlow.CustomBatchSource`1.CleanUpOnFaulted*"></a>
  <h4 id="ETLBox_DataFlow_CustomBatchSource_1_CleanUpOnFaulted_System_Exception_" data-uid="ETLBox.DataFlow.CustomBatchSource`1.CleanUpOnFaulted(System.Exception)">CleanUpOnFaulted(Exception)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_CustomBatchSource_1_CleanUpOnSuccess_" data-uid="ETLBox.DataFlow.CustomBatchSource`1.CleanUpOnSuccess*"></a>
  <h4 id="ETLBox_DataFlow_CustomBatchSource_1_CleanUpOnSuccess" data-uid="ETLBox.DataFlow.CustomBatchSource`1.CleanUpOnSuccess">CleanUpOnSuccess()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_CustomBatchSource_1_OnExecutionDoAsyncWork_" data-uid="ETLBox.DataFlow.CustomBatchSource`1.OnExecutionDoAsyncWork*"></a>
  <h4 id="ETLBox_DataFlow_CustomBatchSource_1_OnExecutionDoAsyncWork" data-uid="ETLBox.DataFlow.CustomBatchSource`1.OnExecutionDoAsyncWork">OnExecutionDoAsyncWork()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_CustomBatchSource_1_OnExecutionDoSynchronousWork_" data-uid="ETLBox.DataFlow.CustomBatchSource`1.OnExecutionDoSynchronousWork*"></a>
  <h4 id="ETLBox_DataFlow_CustomBatchSource_1_OnExecutionDoSynchronousWork" data-uid="ETLBox.DataFlow.CustomBatchSource`1.OnExecutionDoSynchronousWork">OnExecutionDoSynchronousWork()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
