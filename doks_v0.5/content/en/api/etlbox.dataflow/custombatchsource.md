...
which are then send subsequently into your data flow.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow/custombatchsource-1">CustomBatchSource</a>&lt;<span class="xref">ExpandoObject</span>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/custombatchsource-1#ETLBox_DataFlow_CustomBatchSource_1_TaskName">CustomBatchSource&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/custombatchsource-1#ETLBox_DataFlow_CustomBatchSource_1_OnExecutionDoSynchronousWork">CustomBatchSource&lt;ExpandoObject&gt;.OnExecutionDoSynchronousWork()</a>
    </div>
    <div>
...
```C#
    public class CustomBatchSource : CustomBatchSource<ExpandoObject>, ILoggableTask, IDataFlowLogging, IDataFlowExecutableSource<ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowExecutableSource, IDataFlowSource, IDataFlowComponent
```
