---
title: "MemoryDestination"
description: "Details for Class MemoryDestination (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.MemoryDestination">
  <h1 id="ETLBox_DataFlow_MemoryDestination" data-uid="ETLBox.DataFlow.MemoryDestination" class="text-break">Class MemoryDestination
</h1>
...
see the <a class="xref" href="/api/etlbox.dataflow/concurrentmemorydestination">ConcurrentMemoryDestination</a>.</p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level4"><a class="xref" href="ETLBox.DataFlow.MemoryDestination-1.html">MemoryDestination</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/memorydestination-1#ETLBox_DataFlow_MemoryDestination_1_TaskName">MemoryDestination&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/memorydestination-1#ETLBox_DataFlow_MemoryDestination_1_Data">MemoryDestination&lt;ExpandoObject&gt;.Data</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/memorydestination-1#ETLBox_DataFlow_MemoryDestination_1_CleanUpOnSuccess">MemoryDestination&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/memorydestination-1#ETLBox_DataFlow_MemoryDestination_1_CleanUpOnFaulted_System_Exception_">MemoryDestination&lt;ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/memorydestination-1#ETLBox_DataFlow_MemoryDestination_1_AddData__0_">MemoryDestination&lt;ExpandoObject&gt;.AddData(ExpandoObject)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_MemoryDestination_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  <h5 id="ETLBox_DataFlow_MemoryDestination_examples"><strong>Examples</strong></h5>
  <pre>
  <code class="lang-csharp">MemoryDestination&lt;MySimpleRow&gt; dest = new MemoryDestination&lt;MySimpleRow&gt;();
                       //data is accessible in dest.Data</code>
</pre>
  <h3 id="constructors">Constructors
</h3>
  <a id="ETLBox_DataFlow_MemoryDestination__ctor_" data-uid="ETLBox.DataFlow.MemoryDestination.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_MemoryDestination__ctor" data-uid="ETLBox.DataFlow.MemoryDestination.#ctor">MemoryDestination()</h4>
