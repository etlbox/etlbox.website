---
title: "MergeJoin"
description: "Details for Class MergeJoin (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.MergeJoin">
  <h1 id="ETLBox_DataFlow_MergeJoin" data-uid="ETLBox.DataFlow.MergeJoin" class="text-break">Class MergeJoin
</h1>
...
can be compared with a left or right join.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level4"><a class="xref" href="/api/etlbox.dataflow/mergejoin-3">MergeJoin</a>&lt;<span class="xref">ExpandoObject</span>, <span class="xref">ExpandoObject</span>, <span class="xref">ExpandoObject</span>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/mergejoin-3#ETLBox_DataFlow_MergeJoin_3_TaskName">MergeJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/mergejoin-3#ETLBox_DataFlow_MergeJoin_3_LeftInput">MergeJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.LeftInput</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/mergejoin-3#ETLBox_DataFlow_MergeJoin_3_RightInput">MergeJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.RightInput</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/mergejoin-3#ETLBox_DataFlow_MergeJoin_3_SourceBlock">MergeJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.SourceBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/mergejoin-3#ETLBox_DataFlow_MergeJoin_3_MergeJoinFunc">MergeJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.MergeJoinFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/mergejoin-3#ETLBox_DataFlow_MergeJoin_3_ComparisonFunc">MergeJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.ComparisonFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/mergejoin-3#ETLBox_DataFlow_MergeJoin_3_CheckParameter">MergeJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/mergejoin-3#ETLBox_DataFlow_MergeJoin_3_InitComponent">MergeJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.InitComponent()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/mergejoin-3#ETLBox_DataFlow_MergeJoin_3_CleanUpOnSuccess">MergeJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/mergejoin-3#ETLBox_DataFlow_MergeJoin_3_CleanUpOnFaulted_System_Exception_">MergeJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_MergeJoin_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class MergeJoin : MergeJoin<ExpandoObject, ExpandoObject, ExpandoObject>, IDataFlowLogging, IDataFlowSource<ExpandoObject>, IDataFlowSource, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```

{{< rawhtml >}}
  <h3 id="constructors">Constructors
</h3>
  <a id="ETLBox_DataFlow_MergeJoin__ctor_" data-uid="ETLBox.DataFlow.MergeJoin.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_MergeJoin__ctor" data-uid="ETLBox.DataFlow.MergeJoin.#ctor">MergeJoin()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_MergeJoin__ctor_" data-uid="ETLBox.DataFlow.MergeJoin.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_MergeJoin__ctor_System_Func_System_Dynamic_ExpandoObject_System_Dynamic_ExpandoObject_System_Dynamic_ExpandoObject__" data-uid="ETLBox.DataFlow.MergeJoin.#ctor(System.Func{System.Dynamic.ExpandoObject,System.Dynamic.ExpandoObject,System.Dynamic.ExpandoObject})">MergeJoin(Func&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
