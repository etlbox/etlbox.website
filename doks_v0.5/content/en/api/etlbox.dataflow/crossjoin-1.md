...
description: "Details for Class CrossJoin<TInput> (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
The InMemory target should always be the target of the smaller amount of data to reduce memory consumption and processing time.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level4"><a class="xref" href="/api/etlbox.dataflow/crossjoin-3">CrossJoin</a>&lt;TInput, TInput, TInput&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/crossjoin-3#ETLBox_DataFlow_CrossJoin_3_TaskName">CrossJoin&lt;TInput, TInput, TInput&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/crossjoin-3#ETLBox_DataFlow_CrossJoin_3_InMemoryTarget">CrossJoin&lt;TInput, TInput, TInput&gt;.InMemoryTarget</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/crossjoin-3#ETLBox_DataFlow_CrossJoin_3_PassingTarget">CrossJoin&lt;TInput, TInput, TInput&gt;.PassingTarget</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/crossjoin-3#ETLBox_DataFlow_CrossJoin_3_CrossJoinFunc">CrossJoin&lt;TInput, TInput, TInput&gt;.CrossJoinFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/crossjoin-3#ETLBox_DataFlow_CrossJoin_3_SourceBlock">CrossJoin&lt;TInput, TInput, TInput&gt;.SourceBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/crossjoin-3#ETLBox_DataFlow_CrossJoin_3_CheckParameter">CrossJoin&lt;TInput, TInput, TInput&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/crossjoin-3#ETLBox_DataFlow_CrossJoin_3_InitComponent">CrossJoin&lt;TInput, TInput, TInput&gt;.InitComponent()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/crossjoin-3#ETLBox_DataFlow_CrossJoin_3_CleanUpOnSuccess">CrossJoin&lt;TInput, TInput, TInput&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/crossjoin-3#ETLBox_DataFlow_CrossJoin_3_CleanUpOnFaulted_System_Exception_">CrossJoin&lt;TInput, TInput, TInput&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/crossjoin-3#ETLBox_DataFlow_CrossJoin_3_Buffer">CrossJoin&lt;TInput, TInput, TInput&gt;.Buffer</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_CrossJoin_1_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class CrossJoin<TInput> : CrossJoin<TInput, TInput, TInput>, ILoggableTask, IDataFlowLogging, IDataFlowSource<TInput>, IDataFlowSource, IDataFlowDestination, IDataFlowComponent
```
...
{{< rawhtml >}}
  ...
  <h4 id="ETLBox_DataFlow_CrossJoin_1__ctor" data-uid="ETLBox.DataFlow.CrossJoin`1.#ctor">CrossJoin()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_CrossJoin_1__ctor_" data-uid="ETLBox.DataFlow.CrossJoin`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_CrossJoin_1__ctor_System_Func__0__0__0__" data-uid="ETLBox.DataFlow.CrossJoin`1.#ctor(System.Func{`0,`0,`0})">CrossJoin(Func&lt;TInput, TInput, TInput&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
