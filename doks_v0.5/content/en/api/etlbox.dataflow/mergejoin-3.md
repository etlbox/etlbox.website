...
```C#
    public class MergeJoin<TInput1, TInput2, TOutput> : DataFlowSource<TOutput>, ILoggableTask, IDataFlowLogging, IDataFlowSource<TOutput>, IDataFlowSource, IDataFlowDestination, IDataFlowComponent
```
