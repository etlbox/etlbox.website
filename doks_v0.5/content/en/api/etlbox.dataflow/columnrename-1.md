---
title: "ColumnRename<TInput>"
description: "Details for Class ColumnRename<TInput> (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.ColumnRename`1">
  <h1 id="ETLBox_DataFlow_ColumnRename_1" data-uid="ETLBox.DataFlow.ColumnRename`1" class="text-break">Class ColumnRename&lt;TInput&gt;
</h1>
...
existing ColumnMap attributes. For arrays provide the array index and the new name.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level4"><a class="xref" href="ETLBox.DataFlow.DataFlowTransformation-2.html">DataFlowTransformation</a>&lt;TInput, <a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
    <div class="level5"><span class="xref">ColumnRename&lt;TInput&gt;</span></div>
      <div class="level6"><a class="xref" href="/api/etlbox.dataflow/columnrename">ColumnRename</a></div>
  </div>
  <div class="implements">
    <h5>Implements</h5>
    <div><a class="xref" href="/api/etlbox/idataflowlogging">IDataFlowLogging</a></div>
    <div><a class="xref" href="ETLBox.IDataFlowTransformation-2.html">IDataFlowTransformation</a>&lt;TInput, <a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_ColumnRename_1_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_ColumnRename_1__ctor_" data-uid="ETLBox.DataFlow.ColumnRename`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_ColumnRename_1__ctor" data-uid="ETLBox.DataFlow.ColumnRename`1.#ctor">ColumnRename()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_ColumnRename_1__ctor_" data-uid="ETLBox.DataFlow.ColumnRename`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_ColumnRename_1__ctor_System_Collections_Generic_ICollection_ETLBox_RenameColumn__" data-uid="ETLBox.DataFlow.ColumnRename`1.#ctor(System.Collections.Generic.ICollection{ETLBox.RenameColumn})">ColumnRename(ICollection&lt;RenameColumn&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1">ICollection</a>&lt;<a class="xref" href="ETLBox.RenameColumn.html">RenameColumn</a>&gt;</td>
  ...
  <a id="ETLBox_DataFlow_ColumnRename_1_ProgressCount_" data-uid="ETLBox.DataFlow.ColumnRename`1.ProgressCount*"></a>
  <h4 id="ETLBox_DataFlow_ColumnRename_1_ProgressCount" data-uid="ETLBox.DataFlow.ColumnRename`1.ProgressCount">ProgressCount</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_ColumnRename_1_RenameColumns_" data-uid="ETLBox.DataFlow.ColumnRename`1.RenameColumns*"></a>
  <h4 id="ETLBox_DataFlow_ColumnRename_1_RenameColumns" data-uid="ETLBox.DataFlow.ColumnRename`1.RenameColumns">RenameColumns</h4>
  <div class="markdown level1 summary"><p>The column mapping defines how existing properties or columns are renamed.
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_ColumnRename_1_RenameFunc_" data-uid="ETLBox.DataFlow.ColumnRename`1.RenameFunc*"></a>
  <h4 id="ETLBox_DataFlow_ColumnRename_1_RenameFunc" data-uid="ETLBox.DataFlow.ColumnRename`1.RenameFunc">RenameFunc</h4>
  <div class="markdown level1 summary"><p>Instead (or additional) to existing column renaming provided via the <a class="xref" href="/api/etlbox.dataflow/columnrename-1#ETLBox_DataFlow_ColumnRename_1_RenameColumns">RenameColumns</a> property or
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_ColumnRename_1_SourceBlock_" data-uid="ETLBox.DataFlow.ColumnRename`1.SourceBlock*"></a>
  <h4 id="ETLBox_DataFlow_ColumnRename_1_SourceBlock" data-uid="ETLBox.DataFlow.ColumnRename`1.SourceBlock">SourceBlock</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_ColumnRename_1_TargetBlock_" data-uid="ETLBox.DataFlow.ColumnRename`1.TargetBlock*"></a>
  <h4 id="ETLBox_DataFlow_ColumnRename_1_TargetBlock" data-uid="ETLBox.DataFlow.ColumnRename`1.TargetBlock">TargetBlock</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_ColumnRename_1_TaskName_" data-uid="ETLBox.DataFlow.ColumnRename`1.TaskName*"></a>
  <h4 id="ETLBox_DataFlow_ColumnRename_1_TaskName" data-uid="ETLBox.DataFlow.ColumnRename`1.TaskName">TaskName</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_ColumnRename_1_CheckParameter_" data-uid="ETLBox.DataFlow.ColumnRename`1.CheckParameter*"></a>
  <h4 id="ETLBox_DataFlow_ColumnRename_1_CheckParameter" data-uid="ETLBox.DataFlow.ColumnRename`1.CheckParameter">CheckParameter()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_ColumnRename_1_CleanUpOnFaulted_" data-uid="ETLBox.DataFlow.ColumnRename`1.CleanUpOnFaulted*"></a>
  <h4 id="ETLBox_DataFlow_ColumnRename_1_CleanUpOnFaulted_System_Exception_" data-uid="ETLBox.DataFlow.ColumnRename`1.CleanUpOnFaulted(System.Exception)">CleanUpOnFaulted(Exception)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_ColumnRename_1_CleanUpOnSuccess_" data-uid="ETLBox.DataFlow.ColumnRename`1.CleanUpOnSuccess*"></a>
  <h4 id="ETLBox_DataFlow_ColumnRename_1_CleanUpOnSuccess" data-uid="ETLBox.DataFlow.ColumnRename`1.CleanUpOnSuccess">CleanUpOnSuccess()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_ColumnRename_1_InitComponent_" data-uid="ETLBox.DataFlow.ColumnRename`1.InitComponent*"></a>
  <h4 id="ETLBox_DataFlow_ColumnRename_1_InitComponent" data-uid="ETLBox.DataFlow.ColumnRename`1.InitComponent">InitComponent()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_ColumnRename_1_LinkErrorTo_" data-uid="ETLBox.DataFlow.ColumnRename`1.LinkErrorTo*"></a>
  <h4 id="ETLBox_DataFlow_ColumnRename_1_LinkErrorTo_ETLBox_IDataFlowDestination_ETLBox_ETLBoxError__" data-uid="ETLBox.DataFlow.ColumnRename`1.LinkErrorTo(ETLBox.IDataFlowDestination{ETLBox.ETLBoxError})">LinkErrorTo(IDataFlowDestination&lt;ETLBoxError&gt;)</h4>
...
{{< rawhtml >}}
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="/api/etlbox.dataflow/dataflowsource-1#ETLBox_DataFlow_DataFlowSource_1_LinkErrorTo_ETLBox_IDataFlowDestination_ETLBox_ETLBoxError__">DataFlowSource&lt;ExpandoObject&gt;.LinkErrorTo(IDataFlowDestination&lt;ETLBoxError&gt;)</a></div>
  <a id="ETLBox_DataFlow_ColumnRename_1_PrepareParameter_" data-uid="ETLBox.DataFlow.ColumnRename`1.PrepareParameter*"></a>
  <h4 id="ETLBox_DataFlow_ColumnRename_1_PrepareParameter" data-uid="ETLBox.DataFlow.ColumnRename`1.PrepareParameter">PrepareParameter()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
