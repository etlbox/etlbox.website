...
```C#
    public class CrossJoin : CrossJoin<ExpandoObject, ExpandoObject, ExpandoObject>, IDataFlowLogging, IDataFlowSource<ExpandoObject>, IDataFlowSource, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
