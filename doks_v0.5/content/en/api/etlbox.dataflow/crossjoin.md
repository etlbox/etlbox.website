---
title: "CrossJoin"
description: "Details for Class CrossJoin (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.CrossJoin">
  <h1 id="ETLBox_DataFlow_CrossJoin" data-uid="ETLBox.DataFlow.CrossJoin" class="text-break">Class CrossJoin
</h1>
...
The InMemory target should always be the target of the smaller amount of data to reduce memory consumption and processing time.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level4"><a class="xref" href="/api/etlbox.dataflow/crossjoin-3">CrossJoin</a>&lt;<span class="xref">ExpandoObject</span>, <span class="xref">ExpandoObject</span>, <span class="xref">ExpandoObject</span>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/crossjoin-3#ETLBox_DataFlow_CrossJoin_3_TaskName">CrossJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/crossjoin-3#ETLBox_DataFlow_CrossJoin_3_InMemoryTarget">CrossJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.InMemoryTarget</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/crossjoin-3#ETLBox_DataFlow_CrossJoin_3_PassingTarget">CrossJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.PassingTarget</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/crossjoin-3#ETLBox_DataFlow_CrossJoin_3_CrossJoinFunc">CrossJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.CrossJoinFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/crossjoin-3#ETLBox_DataFlow_CrossJoin_3_SourceBlock">CrossJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.SourceBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/crossjoin-3#ETLBox_DataFlow_CrossJoin_3_CheckParameter">CrossJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/crossjoin-3#ETLBox_DataFlow_CrossJoin_3_InitComponent">CrossJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.InitComponent()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/crossjoin-3#ETLBox_DataFlow_CrossJoin_3_CleanUpOnSuccess">CrossJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/crossjoin-3#ETLBox_DataFlow_CrossJoin_3_CleanUpOnFaulted_System_Exception_">CrossJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_CrossJoin_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class CrossJoin : CrossJoin<ExpandoObject, ExpandoObject, ExpandoObject>, ILoggableTask, IDataFlowLogging, IDataFlowSource<ExpandoObject>, IDataFlowSource, IDataFlowDestination, IDataFlowComponent
```

{{< rawhtml >}}
  <h3 id="constructors">Constructors
</h3>
  <a id="ETLBox_DataFlow_CrossJoin__ctor_" data-uid="ETLBox.DataFlow.CrossJoin.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_CrossJoin__ctor" data-uid="ETLBox.DataFlow.CrossJoin.#ctor">CrossJoin()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_CrossJoin__ctor_" data-uid="ETLBox.DataFlow.CrossJoin.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_CrossJoin__ctor_System_Func_System_Dynamic_ExpandoObject_System_Dynamic_ExpandoObject_System_Dynamic_ExpandoObject__" data-uid="ETLBox.DataFlow.CrossJoin.#ctor(System.Func{System.Dynamic.ExpandoObject,System.Dynamic.ExpandoObject,System.Dynamic.ExpandoObject})">CrossJoin(Func&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
