---
title: "DbSource"
description: "Details for Class DbSource (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
Multiple database are supported. Use the corresponding connection manager that fits to your database.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow/dbsource-1">DbSource</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbsource-1#ETLBox_DataFlow_DbSource_1_TaskName">DbSource&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbsource-1#ETLBox_DataFlow_DbSource_1_TableDefinition">DbSource&lt;ExpandoObject&gt;.TableDefinition</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbsource-1#ETLBox_DataFlow_DbSource_1_ColumnMapping">DbSource&lt;ExpandoObject&gt;.ColumnMapping</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbsource-1#ETLBox_DataFlow_DbSource_1_ColumnConverters">DbSource&lt;ExpandoObject&gt;.ColumnConverters</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbsource-1#ETLBox_DataFlow_DbSource_1_SqlParameter">DbSource&lt;ExpandoObject&gt;.SqlParameter</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbsource-1#ETLBox_DataFlow_DbSource_1_SelectColumns">DbSource&lt;ExpandoObject&gt;.SelectColumns</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbsource-1#ETLBox_DataFlow_DbSource_1_IdColumns">DbSource&lt;ExpandoObject&gt;.IdColumns</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbsource-1#ETLBox_DataFlow_DbSource_1_FilterRows">DbSource&lt;ExpandoObject&gt;.FilterRows</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbsource-1#ETLBox_DataFlow_DbSource_1_SelectMode">DbSource&lt;ExpandoObject&gt;.SelectMode</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbsource-1#ETLBox_DataFlow_DbSource_1_PrepareParameter">DbSource&lt;ExpandoObject&gt;.PrepareParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbsource-1#ETLBox_DataFlow_DbSource_1_CheckParameter">DbSource&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbsource-1#ETLBox_DataFlow_DbSource_1_InitParameter">DbSource&lt;ExpandoObject&gt;.InitParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbsource-1#ETLBox_DataFlow_DbSource_1_OnExecutionDoSynchronousWork">DbSource&lt;ExpandoObject&gt;.OnExecutionDoSynchronousWork()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbsource-1#ETLBox_DataFlow_DbSource_1_OnExecutionDoAsyncWork">DbSource&lt;ExpandoObject&gt;.OnExecutionDoAsyncWork()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbsource-1#ETLBox_DataFlow_DbSource_1_CleanUpOnSuccess">DbSource&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbsource-1#ETLBox_DataFlow_DbSource_1_CleanUpOnFaulted_System_Exception_">DbSource&lt;ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_DbSource_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <h4 id="ETLBox_DataFlow_DbSource__ctor" data-uid="ETLBox.DataFlow.DbSource.#ctor">DbSource()</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_DbSource__ctor_" data-uid="ETLBox.DataFlow.DbSource.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_DbSource__ctor_System_String_" data-uid="ETLBox.DataFlow.DbSource.#ctor(System.String)">DbSource(string)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
