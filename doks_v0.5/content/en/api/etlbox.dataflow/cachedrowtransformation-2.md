...
description: "Details for Class CachedRowTransformation<TInput, TOutput> (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.CachedRowTransformation`2">
  <h1 id="ETLBox_DataFlow_CachedRowTransformation_2" data-uid="ETLBox.DataFlow.CachedRowTransformation`2" class="text-break">Class CachedRowTransformation&lt;TInput, TOutput&gt;
</h1>
  ...
  <div class="inheritance">
    ...
    <div class="level6"><a class="xref" href="/api/etlbox.dataflow/cachedrowtransformation-3">CachedRowTransformation</a>&lt;TInput, TOutput, TInput&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/cachedrowtransformation-3#ETLBox_DataFlow_CachedRowTransformation_3_TaskName">CachedRowTransformation&lt;TInput, TOutput, TInput&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/cachedrowtransformation-3#ETLBox_DataFlow_CachedRowTransformation_3_TransformationFunc">CachedRowTransformation&lt;TInput, TOutput, TInput&gt;.TransformationFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/cachedrowtransformation-3#ETLBox_DataFlow_CachedRowTransformation_3_CacheManager">CachedRowTransformation&lt;TInput, TOutput, TInput&gt;.CacheManager</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/cachedrowtransformation-3#ETLBox_DataFlow_CachedRowTransformation_3_CheckParameter">CachedRowTransformation&lt;TInput, TOutput, TInput&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/cachedrowtransformation-3#ETLBox_DataFlow_CachedRowTransformation_3_InvokeInitActionOnce">CachedRowTransformation&lt;TInput, TOutput, TInput&gt;.InvokeInitActionOnce()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/cachedrowtransformation-3#ETLBox_DataFlow_CachedRowTransformation_3_InvokeTransformationFunc__0_">CachedRowTransformation&lt;TInput, TOutput, TInput&gt;.InvokeTransformationFunc(TInput)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_CachedRowTransformation_2_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class CachedRowTransformation<TInput, TOutput> : CachedRowTransformation<TInput, TOutput, TInput>, IDataFlowLogging, IDataFlowTransformation<TInput, TOutput>, IDataFlowSource<TOutput>, IDataFlowSource, IDataFlowDestination<TInput>, IDataFlowDestination, IDataFlowComponent, ILoggableTask where TInput : class
```
...
{{< rawhtml >}}
  ...
  <h4 id="ETLBox_DataFlow_CachedRowTransformation_2__ctor" data-uid="ETLBox.DataFlow.CachedRowTransformation`2.#ctor">CachedRowTransformation()</h4>
