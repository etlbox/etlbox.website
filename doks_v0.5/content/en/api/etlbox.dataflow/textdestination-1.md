...
description: "Details for Class TextDestination<TInput> (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
<a class="xref" href="/api/etlbox.dataflow/textdestination-1#ETLBox_DataFlow_TextDestination_1_WriteLineFunc">WriteLineFunc</a> or by invoking ToString() on the object.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><span class="xref">TextDestination&lt;TInput&gt;</span></div>
      <div class="level6"><a class="xref" href="/api/etlbox.dataflow/textdestination">TextDestination</a></div>
  </div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_TextDestination_1_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <h4 id="ETLBox_DataFlow_TextDestination_1__ctor" data-uid="ETLBox.DataFlow.TextDestination`1.#ctor">TextDestination()</h4>
  <div class="markdown level1 summary"><p>The default <a class="xref" href="/api/etlbox/resourcetype">ResourceType</a> for a TextDestination is a file.</p>
</div>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_TextDestination_1_TaskName_" data-uid="ETLBox.DataFlow.TextDestination`1.TaskName*"></a>
  <h4 id="ETLBox_DataFlow_TextDestination_1_TaskName" data-uid="ETLBox.DataFlow.TextDestination`1.TaskName">TaskName</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_TextDestination_1_WriteHeaderFunc_" data-uid="ETLBox.DataFlow.TextDestination`1.WriteHeaderFunc*"></a>
  <h4 id="ETLBox_DataFlow_TextDestination_1_WriteHeaderFunc" data-uid="ETLBox.DataFlow.TextDestination`1.WriteHeaderFunc">WriteHeaderFunc</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_TextDestination_1_WriteLineFunc_" data-uid="ETLBox.DataFlow.TextDestination`1.WriteLineFunc*"></a>
  <h4 id="ETLBox_DataFlow_TextDestination_1_WriteLineFunc" data-uid="ETLBox.DataFlow.TextDestination`1.WriteLineFunc">WriteLineFunc</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_TextDestination_1_CheckParameter_" data-uid="ETLBox.DataFlow.TextDestination`1.CheckParameter*"></a>
  <h4 id="ETLBox_DataFlow_TextDestination_1_CheckParameter" data-uid="ETLBox.DataFlow.TextDestination`1.CheckParameter">CheckParameter()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
