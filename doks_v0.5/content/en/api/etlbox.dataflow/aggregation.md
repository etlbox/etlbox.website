...
When all rows have been processed by the aggregation, the aggregated values are written into the output.</p>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/aggregation-2#ETLBox_DataFlow_Aggregation_2_TaskName">Aggregation&lt;ExpandoObject, ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/aggregation-2#ETLBox_DataFlow_Aggregation_2_PrepareParameter">Aggregation&lt;ExpandoObject, ExpandoObject&gt;.PrepareParameter()</a>
    </div>
    <div>
