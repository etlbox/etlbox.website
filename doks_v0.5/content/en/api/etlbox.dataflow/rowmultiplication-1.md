---
title: "RowMultiplication<TInput>"
description: "Details for Class RowMultiplication<TInput> (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.RowMultiplication`1">
  <h1 id="ETLBox_DataFlow_RowMultiplication_1" data-uid="ETLBox.DataFlow.RowMultiplication`1" class="text-break">Class RowMultiplication&lt;TInput&gt;
</h1>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow/rowmultiplication-2">RowMultiplication</a>&lt;TInput, TInput&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowmultiplication-2#ETLBox_DataFlow_RowMultiplication_2_TaskName">RowMultiplication&lt;TInput, TInput&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowmultiplication-2#ETLBox_DataFlow_RowMultiplication_2_SourceBlock">RowMultiplication&lt;TInput, TInput&gt;.SourceBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowmultiplication-2#ETLBox_DataFlow_RowMultiplication_2_TargetBlock">RowMultiplication&lt;TInput, TInput&gt;.TargetBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowmultiplication-2#ETLBox_DataFlow_RowMultiplication_2_MultiplicationFunc">RowMultiplication&lt;TInput, TInput&gt;.MultiplicationFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowmultiplication-2#ETLBox_DataFlow_RowMultiplication_2_CheckParameter">RowMultiplication&lt;TInput, TInput&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowmultiplication-2#ETLBox_DataFlow_RowMultiplication_2_InitComponent">RowMultiplication&lt;TInput, TInput&gt;.InitComponent()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowmultiplication-2#ETLBox_DataFlow_RowMultiplication_2_CleanUpOnSuccess">RowMultiplication&lt;TInput, TInput&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowmultiplication-2#ETLBox_DataFlow_RowMultiplication_2_CleanUpOnFaulted_System_Exception_">RowMultiplication&lt;TInput, TInput&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_RowMultiplication_1_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class RowMultiplication<TInput> : RowMultiplication<TInput, TInput>, IDataFlowLogging, IDataFlowTransformation<TInput, TInput>, IDataFlowSource<TInput>, IDataFlowSource, IDataFlowDestination<TInput>, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_RowMultiplication_1__ctor_" data-uid="ETLBox.DataFlow.RowMultiplication`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_RowMultiplication_1__ctor" data-uid="ETLBox.DataFlow.RowMultiplication`1.#ctor">RowMultiplication()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_RowMultiplication_1__ctor_" data-uid="ETLBox.DataFlow.RowMultiplication`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_RowMultiplication_1__ctor_System_Func__0_System_Collections_Generic_IEnumerable__0___" data-uid="ETLBox.DataFlow.RowMultiplication`1.#ctor(System.Func{`0,System.Collections.Generic.IEnumerable{`0}})">RowMultiplication(Func&lt;TInput, IEnumerable&lt;TInput&gt;&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="https://learn.microsoft.com/dotnet/api/system.func-2">Func</a>&lt;TInput, <a class="xref" href="https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1">IEnumerable</a>&lt;TInput&gt;&gt;</td>
