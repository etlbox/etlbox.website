...
can be redirected as an <a class="xref" href="/api/etlbox/etlboxerror">ETLBoxError</a> using LinkErrorTo(..)</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="ETLBox.DataFlow.DbTypeCheck-1.html">DbTypeCheck</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
