...
description: "Details for Class RowMultiplication (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.RowMultiplication">
  <h1 id="ETLBox_DataFlow_RowMultiplication" data-uid="ETLBox.DataFlow.RowMultiplication" class="text-break">Class RowMultiplication
</h1>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="ETLBox.DataFlow.RowMultiplication-2.html">RowMultiplication</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>, <a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowmultiplication-2#ETLBox_DataFlow_RowMultiplication_2_TaskName">RowMultiplication&lt;ExpandoObject, ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowmultiplication-2#ETLBox_DataFlow_RowMultiplication_2_SourceBlock">RowMultiplication&lt;ExpandoObject, ExpandoObject&gt;.SourceBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowmultiplication-2#ETLBox_DataFlow_RowMultiplication_2_TargetBlock">RowMultiplication&lt;ExpandoObject, ExpandoObject&gt;.TargetBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowmultiplication-2#ETLBox_DataFlow_RowMultiplication_2_MultiplicationFunc">RowMultiplication&lt;ExpandoObject, ExpandoObject&gt;.MultiplicationFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowmultiplication-2#ETLBox_DataFlow_RowMultiplication_2_CheckParameter">RowMultiplication&lt;ExpandoObject, ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowmultiplication-2#ETLBox_DataFlow_RowMultiplication_2_InitComponent">RowMultiplication&lt;ExpandoObject, ExpandoObject&gt;.InitComponent()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowmultiplication-2#ETLBox_DataFlow_RowMultiplication_2_CleanUpOnSuccess">RowMultiplication&lt;ExpandoObject, ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_RowMultiplication_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_RowMultiplication__ctor_" data-uid="ETLBox.DataFlow.RowMultiplication.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_RowMultiplication__ctor" data-uid="ETLBox.DataFlow.RowMultiplication.#ctor">RowMultiplication()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_RowMultiplication__ctor_" data-uid="ETLBox.DataFlow.RowMultiplication.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_RowMultiplication__ctor_System_Func_System_Dynamic_ExpandoObject_System_Collections_Generic_IEnumerable_System_Dynamic_ExpandoObject___" data-uid="ETLBox.DataFlow.RowMultiplication.#ctor(System.Func{System.Dynamic.ExpandoObject,System.Collections.Generic.IEnumerable{System.Dynamic.ExpandoObject}})">RowMultiplication(Func&lt;ExpandoObject, IEnumerable&lt;ExpandoObject&gt;&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
