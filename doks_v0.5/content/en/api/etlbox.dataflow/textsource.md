---
title: "TextSource"
description: "Details for Class TextSource (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.TextSource">
  <h1 id="ETLBox_DataFlow_TextSource" data-uid="ETLBox.DataFlow.TextSource" class="text-break">Class TextSource
</h1>
...
or a carriage return immediately followed by a line feed(&quot;\r\n&quot;).</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="ETLBox.DataFlow.DataFlowStreamSource-1.html">DataFlowStreamSource</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
    <div class="level6"><a class="xref" href="ETLBox.DataFlow.TextSource-1.html">TextSource</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
    <div class="level7"><span class="xref">TextSource</span></div>
  </div>
  <div class="implements">
    <h5>Implements</h5>
    <div><a class="xref" href="/api/etlbox/idataflowlogging">IDataFlowLogging</a></div>
    <div><a class="xref" href="ETLBox.IDataFlowStreamSource-1.html">IDataFlowStreamSource</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/textsource-1#ETLBox_DataFlow_TextSource_1_TaskName">TextSource&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/textsource-1#ETLBox_DataFlow_TextSource_1_ParseLineFunc">TextSource&lt;ExpandoObject&gt;.ParseLineFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/textsource-1#ETLBox_DataFlow_TextSource_1_CheckParameter">TextSource&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/textsource-1#ETLBox_DataFlow_TextSource_1_InitReader">TextSource&lt;ExpandoObject&gt;.InitReader()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/textsource-1#ETLBox_DataFlow_TextSource_1_ReadAllRecords">TextSource&lt;ExpandoObject&gt;.ReadAllRecords()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/textsource-1#ETLBox_DataFlow_TextSource_1_CloseReader">TextSource&lt;ExpandoObject&gt;.CloseReader()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_TextSource_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_TextSource__ctor_" data-uid="ETLBox.DataFlow.TextSource.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_TextSource__ctor" data-uid="ETLBox.DataFlow.TextSource.#ctor">TextSource()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_TextSource__ctor_" data-uid="ETLBox.DataFlow.TextSource.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_TextSource__ctor_System_String_" data-uid="ETLBox.DataFlow.TextSource.#ctor(System.String)">TextSource(string)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_TextSource__ctor_" data-uid="ETLBox.DataFlow.TextSource.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_TextSource__ctor_System_String_System_Func_System_String_System_Int32_System_Dynamic_ExpandoObject__" data-uid="ETLBox.DataFlow.TextSource.#ctor(System.String,System.Func{System.String,System.Int32,System.Dynamic.ExpandoObject})">TextSource(string, Func&lt;string, int, ExpandoObject&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-condensed">
    ...
    <tbody>
      ...
      <tr>
        <td><a class="xref" href="https://learn.microsoft.com/dotnet/api/system.func-3">Func</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.string">string</a>, <a class="xref" href="https://learn.microsoft.com/dotnet/api/system.int32">int</a>, <a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</td>
