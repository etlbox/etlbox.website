...
{{< rawhtml >}}
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.csv/csvdestination-1">CsvDestination</a>&lt;<span class="xref">ExpandoObject</span>&gt;</div>
...
```C#
    public class CsvDestination : CsvDestination<ExpandoObject>, ILoggableTask, IDataFlowLogging, IDataFlowStreamDestination<ExpandoObject>, IDataFlowDestination<ExpandoObject>, IDataFlowStreamDestination, IDataFlowDestination, IDataFlowComponent
```
