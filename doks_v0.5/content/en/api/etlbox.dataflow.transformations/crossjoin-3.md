  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><p>Sets the <a class="xref" href="/api/etlbox.dataflow.transformations/crossjoin-3#ETLBox_DataFlow_Transformations_CrossJoin_3_CrossJoinFunc">CrossJoinFunc</a></p>
</td>
      </tr>
    </tbody>
  </table>
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="ETLBox.DataFlow.Transformations.CrossJoin-3.InMemoryDestination-1.html">CrossJoin.InMemoryDestination</a>&lt;TInput1&gt;</td>
        <td></td>
      </tr>
    </tbody>
  </table>
