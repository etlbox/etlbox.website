---
title: "WaitTransformation"
description: "Details for Class WaitTransformation (ETLBox.DataFlow.Transformations)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.Transformations.WaitTransformation">
  <h1 id="ETLBox_DataFlow_Transformations_WaitTransformation" data-uid="ETLBox.DataFlow.Transformations.WaitTransformation" class="text-break">Class WaitTransformation
</h1>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow.transformations/waittransformation-1">WaitTransformation</a>&lt;<span class="xref">System.Dynamic.ExpandoObject</span>&gt;</div>
    <div class="level6"><span class="xref">WaitTransformation</span></div>
  </div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/waittransformation-1#ETLBox_DataFlow_Transformations_WaitTransformation_1_TaskName">WaitTransformation&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/waittransformation-1#ETLBox_DataFlow_Transformations_WaitTransformation_1_TargetBlock">WaitTransformation&lt;ExpandoObject&gt;.TargetBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/waittransformation-1#ETLBox_DataFlow_Transformations_WaitTransformation_1_SourceBlock">WaitTransformation&lt;ExpandoObject&gt;.SourceBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/waittransformation-1#ETLBox_DataFlow_Transformations_WaitTransformation_1_DataFlowComponents">WaitTransformation&lt;ExpandoObject&gt;.DataFlowComponents</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/waittransformation-1#ETLBox_DataFlow_Transformations_WaitTransformation_1_TaskCompletionSources">WaitTransformation&lt;ExpandoObject&gt;.TaskCompletionSources</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/waittransformation-1#ETLBox_DataFlow_Transformations_WaitTransformation_1_CheckParameter">WaitTransformation&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/waittransformation-1#ETLBox_DataFlow_Transformations_WaitTransformation_1_InitComponent">WaitTransformation&lt;ExpandoObject&gt;.InitComponent()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/waittransformation-1#ETLBox_DataFlow_Transformations_WaitTransformation_1_CleanUpOnSuccess">WaitTransformation&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/waittransformation-1#ETLBox_DataFlow_Transformations_WaitTransformation_1_CleanUpOnFaulted_System_Exception_">WaitTransformation&lt;ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Transformations</h6>
  ...
  <h5 id="ETLBox_DataFlow_Transformations_WaitTransformation_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Transformations_WaitTransformation__ctor_" data-uid="ETLBox.DataFlow.Transformations.WaitTransformation.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Transformations_WaitTransformation__ctor" data-uid="ETLBox.DataFlow.Transformations.WaitTransformation.#ctor">WaitTransformation()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_Transformations_WaitTransformation__ctor_" data-uid="ETLBox.DataFlow.Transformations.WaitTransformation.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Transformations_WaitTransformation__ctor_ETLBox_DataFlow_DataFlowComponent___" data-uid="ETLBox.DataFlow.Transformations.WaitTransformation.#ctor(ETLBox.DataFlow.DataFlowComponent[])">WaitTransformation(DataFlowComponent[])</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
