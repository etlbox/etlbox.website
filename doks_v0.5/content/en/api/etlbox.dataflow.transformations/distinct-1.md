...
description: "Details for Class Distinct<TInput> (ETLBox.DataFlow.Transformations)"
draft: false
images: []
menu:
  api:
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Transformations</h6>
  ...
  <h5 id="ETLBox_DataFlow_Transformations_Distinct_1_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">System.Collections.Generic.ICollection&lt;T&gt;</span>&lt;<a class="xref" href="/api/etlbox.dataflow/distinctcolumn">DistinctColumn</a>&gt;</td>
        <td></td>
      </tr>
    </tbody>
  </table>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Transformations_Distinct_1_CleanUpOnFaulted_" data-uid="ETLBox.DataFlow.Transformations.Distinct`1.CleanUpOnFaulted*"></a>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Transformations_Distinct_1_CleanUpOnSuccess_" data-uid="ETLBox.DataFlow.Transformations.Distinct`1.CleanUpOnSuccess*"></a>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Transformations_Distinct_1_InitComponent_" data-uid="ETLBox.DataFlow.Transformations.Distinct`1.InitComponent*"></a>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Transformations_Distinct_1_InitParameter_" data-uid="ETLBox.DataFlow.Transformations.Distinct`1.InitParameter*"></a>
