...
description: "Details for Class RowMultiplication<TInput> (ETLBox.DataFlow.Transformations)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/rowmultiplication-2#ETLBox_DataFlow_Transformations_RowMultiplication_2_TaskName">RowMultiplication&lt;TInput, TInput&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/rowmultiplication-2#ETLBox_DataFlow_Transformations_RowMultiplication_2_SourceBlock">RowMultiplication&lt;TInput, TInput&gt;.SourceBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/rowmultiplication-2#ETLBox_DataFlow_Transformations_RowMultiplication_2_TargetBlock">RowMultiplication&lt;TInput, TInput&gt;.TargetBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/rowmultiplication-2#ETLBox_DataFlow_Transformations_RowMultiplication_2_MultiplicationFunc">RowMultiplication&lt;TInput, TInput&gt;.MultiplicationFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/rowmultiplication-2#ETLBox_DataFlow_Transformations_RowMultiplication_2_CheckParameter">RowMultiplication&lt;TInput, TInput&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/rowmultiplication-2#ETLBox_DataFlow_Transformations_RowMultiplication_2_InitComponent">RowMultiplication&lt;TInput, TInput&gt;.InitComponent()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/rowmultiplication-2#ETLBox_DataFlow_Transformations_RowMultiplication_2_CleanUpOnSuccess">RowMultiplication&lt;TInput, TInput&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/rowmultiplication-2#ETLBox_DataFlow_Transformations_RowMultiplication_2_CleanUpOnFaulted_System_Exception_">RowMultiplication&lt;TInput, TInput&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Transformations</h6>
  ...
  <h5 id="ETLBox_DataFlow_Transformations_RowMultiplication_1_syntax">Syntax</h5>
{{< /rawhtml >}}
