---
title: "MergeJoin<TInput>"
description: "Details for Class MergeJoin<TInput> (ETLBox.DataFlow.Transformations)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.Transformations.MergeJoin`1">
  <h1 id="ETLBox_DataFlow_Transformations_MergeJoin_1" data-uid="ETLBox.DataFlow.Transformations.MergeJoin`1" class="text-break">Class MergeJoin&lt;TInput&gt;
</h1>
...
can be compared with a left or right join.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level4"><a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3">MergeJoin</a>&lt;TInput, TInput, TInput&gt;</div>
    <div class="level5"><span class="xref">MergeJoin&lt;TInput&gt;</span></div>
  </div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_TaskName">MergeJoin&lt;TInput, TInput, TInput&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_LeftInput">MergeJoin&lt;TInput, TInput, TInput&gt;.LeftInput</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_RightInput">MergeJoin&lt;TInput, TInput, TInput&gt;.RightInput</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_SourceBlock">MergeJoin&lt;TInput, TInput, TInput&gt;.SourceBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_MergeJoinFunc">MergeJoin&lt;TInput, TInput, TInput&gt;.MergeJoinFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_ComparisonFunc">MergeJoin&lt;TInput, TInput, TInput&gt;.ComparisonFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_CheckParameter">MergeJoin&lt;TInput, TInput, TInput&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_InitComponent">MergeJoin&lt;TInput, TInput, TInput&gt;.InitComponent()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_CleanUpOnSuccess">MergeJoin&lt;TInput, TInput, TInput&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_CleanUpOnFaulted_System_Exception_">MergeJoin&lt;TInput, TInput, TInput&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_Buffer">MergeJoin&lt;TInput, TInput, TInput&gt;.Buffer</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Transformations</h6>
  ...
  <h5 id="ETLBox_DataFlow_Transformations_MergeJoin_1_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class MergeJoin<TInput> : MergeJoin<TInput, TInput, TInput>, ILoggableTask, IDataFlowLogging, IDataFlowTransformation<TInput>, IDataFlowSource<TInput>, IDataFlowSource, IDataFlowDestination, IDataFlowComponent
```
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Transformations_MergeJoin_1__ctor_" data-uid="ETLBox.DataFlow.Transformations.MergeJoin`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Transformations_MergeJoin_1__ctor" data-uid="ETLBox.DataFlow.Transformations.MergeJoin`1.#ctor">MergeJoin()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_Transformations_MergeJoin_1__ctor_" data-uid="ETLBox.DataFlow.Transformations.MergeJoin`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Transformations_MergeJoin_1__ctor_System_Func__0__0__0__" data-uid="ETLBox.DataFlow.Transformations.MergeJoin`1.#ctor(System.Func{`0,`0,`0})">MergeJoin(Func&lt;TInput, TInput, TInput&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
