---
title: "MergeJoin"
description: "Details for Class MergeJoin (ETLBox.DataFlow.Transformations)"
draft: false
images: []
menu:
  api:
...
can be compared with a left or right join.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level4"><a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3">MergeJoin</a>&lt;<span class="xref">ExpandoObject</span>, <span class="xref">ExpandoObject</span>, <span class="xref">ExpandoObject</span>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_TaskName">MergeJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_LeftInput">MergeJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.LeftInput</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_RightInput">MergeJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.RightInput</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_SourceBlock">MergeJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.SourceBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_MergeJoinFunc">MergeJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.MergeJoinFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_ComparisonFunc">MergeJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.ComparisonFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_CheckParameter">MergeJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_InitComponent">MergeJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.InitComponent()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_CleanUpOnSuccess">MergeJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_CleanUpOnFaulted_System_Exception_">MergeJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/mergejoin-3#ETLBox_DataFlow_Transformations_MergeJoin_3_Buffer">MergeJoin&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.Buffer</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Transformations</h6>
  ...
  <h5 id="ETLBox_DataFlow_Transformations_MergeJoin_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class MergeJoin : MergeJoin<ExpandoObject, ExpandoObject, ExpandoObject>, ILoggableTask, IDataFlowLogging, IDataFlowTransformation<ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowSource, IDataFlowDestination, IDataFlowComponent
```
