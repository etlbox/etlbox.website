...
Rows with a schema that is not valid are send to the error output..</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow.transformations/xmlschemavalidation-1">XmlSchemaValidation</a>&lt;<span class="xref">ExpandoObject</span>&gt;</div>
