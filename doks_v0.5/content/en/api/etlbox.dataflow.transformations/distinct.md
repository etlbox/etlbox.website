---
title: "Distinct"
description: "Details for Class Distinct (ETLBox.DataFlow.Transformations)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow.transformations/distinct-1">Distinct</a>&lt;<span class="xref">ExpandoObject</span>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/distinct-1#ETLBox_DataFlow_Transformations_Distinct_1_TaskName">Distinct&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/distinct-1#ETLBox_DataFlow_Transformations_Distinct_1_DistinctColumns">Distinct&lt;ExpandoObject&gt;.DistinctColumns</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/distinct-1#ETLBox_DataFlow_Transformations_Distinct_1_PrepareParameter">Distinct&lt;ExpandoObject&gt;.PrepareParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/distinct-1#ETLBox_DataFlow_Transformations_Distinct_1_CheckParameter">Distinct&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/distinct-1#ETLBox_DataFlow_Transformations_Distinct_1_InitParameter">Distinct&lt;ExpandoObject&gt;.InitParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/distinct-1#ETLBox_DataFlow_Transformations_Distinct_1_InitComponent">Distinct&lt;ExpandoObject&gt;.InitComponent()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/distinct-1#ETLBox_DataFlow_Transformations_Distinct_1_CleanUpOnSuccess">Distinct&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Transformations</h6>
  ...
  <h5 id="ETLBox_DataFlow_Transformations_Distinct_syntax">Syntax</h5>
{{< /rawhtml >}}
