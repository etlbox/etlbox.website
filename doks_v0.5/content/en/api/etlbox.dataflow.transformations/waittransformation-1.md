...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_Transformations_WaitTransformation_1__ctor_" data-uid="ETLBox.DataFlow.Transformations.WaitTransformation`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Transformations_WaitTransformation_1__ctor_ETLBox_DataFlow_DataFlowComponent___" data-uid="ETLBox.DataFlow.Transformations.WaitTransformation`1.#ctor(ETLBox.DataFlow.DataFlowComponent[])">WaitTransformation(params DataFlowComponent[])</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
