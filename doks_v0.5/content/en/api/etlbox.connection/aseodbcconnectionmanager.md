---
title: "AseOdbcConnectionManager"
description: "Details for Class AseOdbcConnectionManager (ETLBox.Connection)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.Connection.AseOdbcConnectionManager">
  <h1 id="ETLBox_Connection_AseOdbcConnectionManager" data-uid="ETLBox.Connection.AseOdbcConnectionManager" class="text-break">Class AseOdbcConnectionManager
</h1>
...
<h6><strong>Namespace</strong>: ETLBox.Connection</h6>
  ...
  <h5 id="ETLBox_Connection_AseOdbcConnectionManager_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class AseOdbcConnectionManager : OdbcConnectionManager, IConnectionManager<OdbcConnection, OdbcTransaction>, IConnectionManager, IDisposable
```
...
```C#
    public AseOdbcConnectionManager()
```
...
```C#
    public AseOdbcConnectionManager(OdbcConnectionString connectionString)
```
...
```C#
    public AseOdbcConnectionManager(string connectionString)
```
