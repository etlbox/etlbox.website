---
title: "MySqlOdbcConnectionManager"
description: "Details for Class MySqlOdbcConnectionManager (ETLBox.Connection)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.Connection.MySqlOdbcConnectionManager">
  <h1 id="ETLBox_Connection_MySqlOdbcConnectionManager" data-uid="ETLBox.Connection.MySqlOdbcConnectionManager" class="text-break">Class MySqlOdbcConnectionManager
</h1>
  <div class="markdown level0 summary"><p>MySql Connection manager for an ODBC connection based on ADO.NET to Sql Server.
...
Reduce the batch size if you encounter issues here.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level3"><span class="xref">MySqlOdbcConnectionManager</span></div>
  </div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.connection/odbcconnectionmanager#ETLBox_Connection_OdbcConnectionManager_ConnectionManagerType">OdbcConnectionManager.ConnectionManagerType</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.connection/odbcconnectionmanager#ETLBox_Connection_OdbcConnectionManager_QB">OdbcConnectionManager.QB</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.connection/odbcconnectionmanager#ETLBox_Connection_OdbcConnectionManager_QE">OdbcConnectionManager.QE</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.connection/dbconnectionmanager-3#ETLBox_Connection_DbConnectionManager_3_HasTransaction">DbConnectionManager&lt;OdbcConnection, OdbcTransaction, OdbcParameter&gt;.HasTransaction</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.connection/dbconnectionmanager-3#ETLBox_Connection_DbConnectionManager_3_ValueToSqlConversionFunc">DbConnectionManager&lt;OdbcConnection, OdbcTransaction, OdbcParameter&gt;.ValueToSqlConversionFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.connection/dbconnectionmanager-3#ETLBox_Connection_DbConnectionManager_3_UseValueToSqlConversionFunc">DbConnectionManager&lt;OdbcConnection, OdbcTransaction, OdbcParameter&gt;.UseValueToSqlConversionFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.connection/dbconnectionmanager-3#ETLBox_Connection_DbConnectionManager_3_OverrideConnectionSpecifics_ETLBox_Connection_ConnectionManagerType_System_String_System_String_System_String_System_Int32_System_Int32_">DbConnectionManager&lt;OdbcConnection, OdbcTransaction, OdbcParameter&gt;.OverrideConnectionSpecifics(ConnectionManagerType, string, string, string, int, int)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.connection/dbconnectionmanager-3#ETLBox_Connection_DbConnectionManager_3_ConfigureByConnectionType_ETLBox_Connection_ConnectionManagerType_">DbConnectionManager&lt;OdbcConnection, OdbcTransaction, OdbcParameter&gt;.ConfigureByConnectionType(ConnectionManagerType)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.connection/dbconnectionmanager-3#ETLBox_Connection_DbConnectionManager_3_SetValueToSqlConversionFunc_System_Func_ETLBox_Helper_ConversionContext_System_String__">DbConnectionManager&lt;OdbcConnection, OdbcTransaction, OdbcParameter&gt;.SetValueToSqlConversionFunc(Func&lt;ConversionContext, string&gt;)</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.connection/dbconnectionmanager-3#ETLBox_Connection_DbConnectionManager_3_BulkNonQueryAsync_System_String_System_Collections_Generic_IEnumerable__2__">DbConnectionManager&lt;OdbcConnection, OdbcTransaction, OdbcParameter&gt;.BulkNonQueryAsync(string, IEnumerable&lt;OdbcParameter&gt;)</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.connection/dbconnectionmanager-3#ETLBox_Connection_DbConnectionManager_3_OpenAsync">DbConnectionManager&lt;OdbcConnection, OdbcTransaction, OdbcParameter&gt;.OpenAsync()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.connection/dbconnectionmanager-3#ETLBox_Connection_DbConnectionManager_3_OpenCoreAsync_System_Boolean_">DbConnectionManager&lt;OdbcConnection, OdbcTransaction, OdbcParameter&gt;.OpenCoreAsync(bool)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.Connection</h6>
  ...
  <h5 id="ETLBox_Connection_MySqlOdbcConnectionManager_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Connection_MySqlOdbcConnectionManager__ctor_" data-uid="ETLBox.Connection.MySqlOdbcConnectionManager.#ctor*"></a>
  <h4 id="ETLBox_Connection_MySqlOdbcConnectionManager__ctor" data-uid="ETLBox.Connection.MySqlOdbcConnectionManager.#ctor">MySqlOdbcConnectionManager()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_Connection_MySqlOdbcConnectionManager__ctor_" data-uid="ETLBox.Connection.MySqlOdbcConnectionManager.#ctor*"></a>
  <h4 id="ETLBox_Connection_MySqlOdbcConnectionManager__ctor_ETLBox_Connection_OdbcConnectionString_" data-uid="ETLBox.Connection.MySqlOdbcConnectionManager.#ctor(ETLBox.Connection.OdbcConnectionString)">MySqlOdbcConnectionManager(OdbcConnectionString)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Connection_MySqlOdbcConnectionManager__ctor_" data-uid="ETLBox.Connection.MySqlOdbcConnectionManager.#ctor*"></a>
  <h4 id="ETLBox_Connection_MySqlOdbcConnectionManager__ctor_System_String_" data-uid="ETLBox.Connection.MySqlOdbcConnectionManager.#ctor(System.String)">MySqlOdbcConnectionManager(string)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Connection_MySqlOdbcConnectionManager_SupportSchemas_" data-uid="ETLBox.Connection.MySqlOdbcConnectionManager.SupportSchemas*"></a>
  <h4 id="ETLBox_Connection_MySqlOdbcConnectionManager_SupportSchemas" data-uid="ETLBox.Connection.MySqlOdbcConnectionManager.SupportSchemas">SupportSchemas</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Connection_MySqlOdbcConnectionManager_Clone_" data-uid="ETLBox.Connection.MySqlOdbcConnectionManager.Clone*"></a>
  <h4 id="ETLBox_Connection_MySqlOdbcConnectionManager_Clone" data-uid="ETLBox.Connection.MySqlOdbcConnectionManager.Clone">Clone()</h4>
