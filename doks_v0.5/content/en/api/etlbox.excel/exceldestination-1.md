...
```C#
    public class ExcelDestination<TInput> : DataFlowStreamDestination<TInput>, ILoggableTask, IDataFlowLogging, IDataFlowStreamDestination<TInput>, IDataFlowDestination<TInput>, IDataFlowStreamDestination, IDataFlowDestination, IDataFlowComponent
```
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Excel_ExcelDestination_1_TaskName_" data-uid="ETLBox.Excel.ExcelDestination`1.TaskName*"></a>
  <h4 id="ETLBox_Excel_ExcelDestination_1_TaskName" data-uid="ETLBox.Excel.ExcelDestination`1.TaskName">TaskName</h4>
