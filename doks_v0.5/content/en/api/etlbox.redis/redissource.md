---
title: "RedisSource"
description: "Details for Class RedisSource (ETLBox.Redis)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.Redis.RedisSource">
  <h1 id="ETLBox_Redis_RedisSource" data-uid="ETLBox.Redis.RedisSource" class="text-break">Class RedisSource
</h1>
...
works only if your values contain json - for other values you can define your own serialization function.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="ETLBox.Redis.RedisSource-1.html">RedisSource</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.redis/redissource-1#ETLBox_Redis_RedisSource_1_TaskName">RedisSource&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redissource-1#ETLBox_Redis_RedisSource_1_ConnectionString">RedisSource&lt;ExpandoObject&gt;.ConnectionString</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redissource-1#ETLBox_Redis_RedisSource_1_RedisConnection">RedisSource&lt;ExpandoObject&gt;.RedisConnection</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redissource-1#ETLBox_Redis_RedisSource_1_DatabaseNumber">RedisSource&lt;ExpandoObject&gt;.DatabaseNumber</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redissource-1#ETLBox_Redis_RedisSource_1_DeserializerSettings">RedisSource&lt;ExpandoObject&gt;.DeserializerSettings</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redissource-1#ETLBox_Redis_RedisSource_1_DeserializationFunc">RedisSource&lt;ExpandoObject&gt;.DeserializationFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redissource-1#ETLBox_Redis_RedisSource_1_ScanPattern">RedisSource&lt;ExpandoObject&gt;.ScanPattern</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redissource-1#ETLBox_Redis_RedisSource_1_ScanCountSize">RedisSource&lt;ExpandoObject&gt;.ScanCountSize</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redissource-1#ETLBox_Redis_RedisSource_1_CheckParameter">RedisSource&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redissource-1#ETLBox_Redis_RedisSource_1_OnExecutionDoSynchronousWork">RedisSource&lt;ExpandoObject&gt;.OnExecutionDoSynchronousWork()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redissource-1#ETLBox_Redis_RedisSource_1_OnExecutionDoAsyncWork">RedisSource&lt;ExpandoObject&gt;.OnExecutionDoAsyncWork()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redissource-1#ETLBox_Redis_RedisSource_1_CleanUpOnSuccess">RedisSource&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redissource-1#ETLBox_Redis_RedisSource_1_CleanUpOnFaulted_System_Exception_">RedisSource&lt;ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.Redis</h6>
  ...
  <h5 id="ETLBox_Redis_RedisSource_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Redis_RedisSource__ctor_" data-uid="ETLBox.Redis.RedisSource.#ctor*"></a>
  <h4 id="ETLBox_Redis_RedisSource__ctor" data-uid="ETLBox.Redis.RedisSource.#ctor">RedisSource()</h4>
