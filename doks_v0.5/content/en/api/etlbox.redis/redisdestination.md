...
description: "Details for Class RedisDestination (ETLBox.Redis)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.Redis.RedisDestination">
  <h1 id="ETLBox_Redis_RedisDestination" data-uid="ETLBox.Redis.RedisDestination" class="text-break">Class RedisDestination
</h1>
...
The stored value will contain your serialized object using Newtonsoft.Json and JsonConvert.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="ETLBox.Redis.RedisDestination-1.html">RedisDestination</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.redis/redisdestination-1#ETLBox_Redis_RedisDestination_1_TaskName">RedisDestination&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redisdestination-1#ETLBox_Redis_RedisDestination_1_ConnectionString">RedisDestination&lt;ExpandoObject&gt;.ConnectionString</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redisdestination-1#ETLBox_Redis_RedisDestination_1_RedisConnection">RedisDestination&lt;ExpandoObject&gt;.RedisConnection</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redisdestination-1#ETLBox_Redis_RedisDestination_1_DatabaseNumber">RedisDestination&lt;ExpandoObject&gt;.DatabaseNumber</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redisdestination-1#ETLBox_Redis_RedisDestination_1_SerializerSettings">RedisDestination&lt;ExpandoObject&gt;.SerializerSettings</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redisdestination-1#ETLBox_Redis_RedisDestination_1_SerializationFunc">RedisDestination&lt;ExpandoObject&gt;.SerializationFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redisdestination-1#ETLBox_Redis_RedisDestination_1_KeyColumn">RedisDestination&lt;ExpandoObject&gt;.KeyColumn</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redisdestination-1#ETLBox_Redis_RedisDestination_1_SetParameter">RedisDestination&lt;ExpandoObject&gt;.SetParameter</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redisdestination-1#ETLBox_Redis_RedisDestination_1_PrepareParameter">RedisDestination&lt;ExpandoObject&gt;.PrepareParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redisdestination-1#ETLBox_Redis_RedisDestination_1_CheckParameter">RedisDestination&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redisdestination-1#ETLBox_Redis_RedisDestination_1_InitParameter">RedisDestination&lt;ExpandoObject&gt;.InitParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redisdestination-1#ETLBox_Redis_RedisDestination_1_PrepareWrite">RedisDestination&lt;ExpandoObject&gt;.PrepareWrite()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redisdestination-1#ETLBox_Redis_RedisDestination_1_BulkInsertData__0___">RedisDestination&lt;ExpandoObject&gt;.BulkInsertData(ExpandoObject[])</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.redis/redisdestination-1#ETLBox_Redis_RedisDestination_1_FinishWrite">RedisDestination&lt;ExpandoObject&gt;.FinishWrite()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.Redis</h6>
  ...
  <h5 id="ETLBox_Redis_RedisDestination_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Redis_RedisDestination__ctor_" data-uid="ETLBox.Redis.RedisDestination.#ctor*"></a>
  <h4 id="ETLBox_Redis_RedisDestination__ctor" data-uid="ETLBox.Redis.RedisDestination.#ctor">RedisDestination()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_Redis_RedisDestination__ctor_" data-uid="ETLBox.Redis.RedisDestination.#ctor*"></a>
  <h4 id="ETLBox_Redis_RedisDestination__ctor_System_Int32_" data-uid="ETLBox.Redis.RedisDestination.#ctor(System.Int32)">RedisDestination(int)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
