---
title: "ParquetSource"
description: "Details for Class ParquetSource (ETLBox.DataFlow.Connectors)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
  ...
  <div class="inheritance">
    ...
    <div class="level6"><a class="xref" href="/api/etlbox.dataflow.connectors/parquetsource-1">ParquetSource</a>&lt;<span class="xref">ExpandoObject</span>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/parquetsource-1#ETLBox_DataFlow_Connectors_ParquetSource_1_TaskName">ParquetSource&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/parquetsource-1#ETLBox_DataFlow_Connectors_ParquetSource_1_ParquetColumns">ParquetSource&lt;ExpandoObject&gt;.ParquetColumns</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/parquetsource-1#ETLBox_DataFlow_Connectors_ParquetSource_1_PrepareParameter">ParquetSource&lt;ExpandoObject&gt;.PrepareParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/parquetsource-1#ETLBox_DataFlow_Connectors_ParquetSource_1_CheckParameter">ParquetSource&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/parquetsource-1#ETLBox_DataFlow_Connectors_ParquetSource_1_InitReader">ParquetSource&lt;ExpandoObject&gt;.InitReader()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/parquetsource-1#ETLBox_DataFlow_Connectors_ParquetSource_1_SupportedDataTypes">ParquetSource&lt;ExpandoObject&gt;.SupportedDataTypes</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/parquetsource-1#ETLBox_DataFlow_Connectors_ParquetSource_1_ReadAllRecords">ParquetSource&lt;ExpandoObject&gt;.ReadAllRecords()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/parquetsource-1#ETLBox_DataFlow_Connectors_ParquetSource_1_FindPropNameMapping_System_String_">ParquetSource&lt;ExpandoObject&gt;.FindPropNameMapping(string)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/parquetsource-1#ETLBox_DataFlow_Connectors_ParquetSource_1_CloseReader">ParquetSource&lt;ExpandoObject&gt;.CloseReader()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Connectors</h6>
  ...
  <h5 id="ETLBox_DataFlow_Connectors_ParquetSource_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class ParquetSource : ParquetSource<ExpandoObject>, ILoggableTask, IDataFlowLogging, IDataFlowStreamSource<ExpandoObject>, IDataFlowExecutableSource<ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowSource, IDataFlowComponent, IDataFlowExecutableSource, IDataFlowStreamSource
```
