...
description: "Details for Class TextDestination (ETLBox.DataFlow.Connectors)"
draft: false
images: []
menu:
  api:
...
<a class="xref" href="/api/etlbox.dataflow.connectors/textdestination-1#ETLBox_DataFlow_Connectors_TextDestination_1_WriteLineFunc">WriteLineFunc</a> or by invoking ToString() on the object.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow.connectors/textdestination-1">TextDestination</a>&lt;<span class="xref">ExpandoObject</span>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/textdestination-1#ETLBox_DataFlow_Connectors_TextDestination_1_TaskName">TextDestination&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/textdestination-1#ETLBox_DataFlow_Connectors_TextDestination_1_InitStream">TextDestination&lt;ExpandoObject&gt;.InitStream()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/textdestination-1#ETLBox_DataFlow_Connectors_TextDestination_1_WriteIntoStream__0_">TextDestination&lt;ExpandoObject&gt;.WriteIntoStream(ExpandoObject)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/textdestination-1#ETLBox_DataFlow_Connectors_TextDestination_1_CloseStream">TextDestination&lt;ExpandoObject&gt;.CloseStream()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Connectors</h6>
  ...
  <h5 id="ETLBox_DataFlow_Connectors_TextDestination_syntax">Syntax</h5>
{{< /rawhtml >}}
