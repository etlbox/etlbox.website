---
title: "CsvSource"
description: "Details for Class CsvSource (ETLBox.DataFlow.Connectors)"
draft: false
images: []
menu:
  api:
...
Data is read a as string from the source and dynamically converted into the corresponding data format.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level6"><a class="xref" href="/api/etlbox.dataflow.connectors/csvsource-1">CsvSource</a>&lt;<span class="xref">ExpandoObject</span>&gt;</div>
    <div class="level7"><span class="xref">CsvSource</span></div>
  </div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/csvsource-1#ETLBox_DataFlow_Connectors_CsvSource_1_TaskName">CsvSource&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/csvsource-1#ETLBox_DataFlow_Connectors_CsvSource_1_Configuration">CsvSource&lt;ExpandoObject&gt;.Configuration</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/csvsource-1#ETLBox_DataFlow_Connectors_CsvSource_1_CsvContext">CsvSource&lt;ExpandoObject&gt;.CsvContext</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/csvsource-1#ETLBox_DataFlow_Connectors_CsvSource_1_FieldHeaders">CsvSource&lt;ExpandoObject&gt;.FieldHeaders</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/csvsource-1#ETLBox_DataFlow_Connectors_CsvSource_1_IsHeaderRead">CsvSource&lt;ExpandoObject&gt;.IsHeaderRead</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/csvsource-1#ETLBox_DataFlow_Connectors_CsvSource_1_CheckParameter">CsvSource&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/csvsource-1#ETLBox_DataFlow_Connectors_CsvSource_1_InitReader">CsvSource&lt;ExpandoObject&gt;.InitReader()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/csvsource-1#ETLBox_DataFlow_Connectors_CsvSource_1_ReadAllRecords">CsvSource&lt;ExpandoObject&gt;.ReadAllRecords()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/csvsource-1#ETLBox_DataFlow_Connectors_CsvSource_1_CloseReader">CsvSource&lt;ExpandoObject&gt;.CloseReader()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/csvsource-1#ETLBox_DataFlow_Connectors_CsvSource_1_ReadFieldHeaders_System_String_">CsvSource&lt;ExpandoObject&gt;.ReadFieldHeaders(string)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Connectors</h6>
  ...
  <h5 id="ETLBox_DataFlow_Connectors_CsvSource_syntax">Syntax</h5>
{{< /rawhtml >}}
