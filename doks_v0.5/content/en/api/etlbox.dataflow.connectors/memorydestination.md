...
description: "Details for Class MemoryDestination (ETLBox.DataFlow.Connectors)"
draft: false
images: []
menu:
  api:
...
see the <a class="xref" href="/api/etlbox.dataflow.connectors/concurrentmemorydestination">ConcurrentMemoryDestination</a>.</p>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/memorydestination-1#ETLBox_DataFlow_Connectors_MemoryDestination_1_TaskName">MemoryDestination&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/memorydestination-1#ETLBox_DataFlow_Connectors_MemoryDestination_1_Data">MemoryDestination&lt;ExpandoObject&gt;.Data</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/memorydestination-1#ETLBox_DataFlow_Connectors_MemoryDestination_1_CleanUpOnSuccess">MemoryDestination&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/memorydestination-1#ETLBox_DataFlow_Connectors_MemoryDestination_1_CleanUpOnFaulted_System_Exception_">MemoryDestination&lt;ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/memorydestination-1#ETLBox_DataFlow_Connectors_MemoryDestination_1_AddData__0_">MemoryDestination&lt;ExpandoObject&gt;.AddData(ExpandoObject)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Connectors</h6>
  ...
  <h5 id="ETLBox_DataFlow_Connectors_MemoryDestination_syntax">Syntax</h5>
{{< /rawhtml >}}
