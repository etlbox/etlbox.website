...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_Connectors_CouchbaseDestination_1__ctor_" data-uid="ETLBox.DataFlow.Connectors.CouchbaseDestination`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CouchbaseDestination_1__ctor_System_Int32_" data-uid="ETLBox.DataFlow.Connectors.CouchbaseDestination`1.#ctor(System.Int32)">CouchbaseDestination(int)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
