---
title: "DbSource"
description: "Details for Class DbSource (ETLBox.DataFlow.Connectors)"
draft: false
images: []
menu:
  api:
...
Multiple database are supported. Use the corresponding connection manager that fits to your database.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow.connectors/dbsource-1">DbSource</a>&lt;<span class="xref">ExpandoObject</span>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/dbsource-1#ETLBox_DataFlow_Connectors_DbSource_1_TaskName">DbSource&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/dbsource-1#ETLBox_DataFlow_Connectors_DbSource_1_SourceTableDefinition">DbSource&lt;ExpandoObject&gt;.SourceTableDefinition</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/dbsource-1#ETLBox_DataFlow_Connectors_DbSource_1_ColumnMapping">DbSource&lt;ExpandoObject&gt;.ColumnMapping</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/dbsource-1#ETLBox_DataFlow_Connectors_DbSource_1_ColumnConverters">DbSource&lt;ExpandoObject&gt;.ColumnConverters</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/dbsource-1#ETLBox_DataFlow_Connectors_DbSource_1_TableName">DbSource&lt;ExpandoObject&gt;.TableName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/dbsource-1#ETLBox_DataFlow_Connectors_DbSource_1_Sql">DbSource&lt;ExpandoObject&gt;.Sql</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/dbsource-1#ETLBox_DataFlow_Connectors_DbSource_1_PrepareParameter">DbSource&lt;ExpandoObject&gt;.PrepareParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/dbsource-1#ETLBox_DataFlow_Connectors_DbSource_1_CheckParameter">DbSource&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/dbsource-1#ETLBox_DataFlow_Connectors_DbSource_1_InitParameter">DbSource&lt;ExpandoObject&gt;.InitParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/dbsource-1#ETLBox_DataFlow_Connectors_DbSource_1_OnExecutionDoSynchronousWork">DbSource&lt;ExpandoObject&gt;.OnExecutionDoSynchronousWork()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/dbsource-1#ETLBox_DataFlow_Connectors_DbSource_1_OnExecutionDoAsyncWork">DbSource&lt;ExpandoObject&gt;.OnExecutionDoAsyncWork()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/dbsource-1#ETLBox_DataFlow_Connectors_DbSource_1_CleanUpOnSuccess">DbSource&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/dbsource-1#ETLBox_DataFlow_Connectors_DbSource_1_CleanUpOnFaulted_System_Exception_">DbSource&lt;ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Connectors</h6>
  ...
  <h5 id="ETLBox_DataFlow_Connectors_DbSource_syntax">Syntax</h5>
{{< /rawhtml >}}
