...
description: "Details for Class VoidDestination (ETLBox.DataFlow.Connectors)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.Connectors.VoidDestination">
  <h1 id="ETLBox_DataFlow_Connectors_VoidDestination" data-uid="ETLBox.DataFlow.Connectors.VoidDestination" class="text-break">Class VoidDestination
</h1>
  ...
  <div class="inheritance">
    ...
    <div class="level4"><a class="xref" href="/api/etlbox.dataflow.connectors/voiddestination-1">VoidDestination</a>&lt;<span class="xref">System.Dynamic.ExpandoObject</span>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/voiddestination-1#ETLBox_DataFlow_Connectors_VoidDestination_1_TaskName">VoidDestination&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/voiddestination-1#ETLBox_DataFlow_Connectors_VoidDestination_1_CheckParameter">VoidDestination&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/voiddestination-1#ETLBox_DataFlow_Connectors_VoidDestination_1_InitComponent">VoidDestination&lt;ExpandoObject&gt;.InitComponent()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/voiddestination-1#ETLBox_DataFlow_Connectors_VoidDestination_1_CleanUpOnSuccess">VoidDestination&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/voiddestination-1#ETLBox_DataFlow_Connectors_VoidDestination_1_CleanUpOnFaulted_System_Exception_">VoidDestination&lt;ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Connectors</h6>
  ...
  <h5 id="ETLBox_DataFlow_Connectors_VoidDestination_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Connectors_VoidDestination__ctor_" data-uid="ETLBox.DataFlow.Connectors.VoidDestination.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_VoidDestination__ctor" data-uid="ETLBox.DataFlow.Connectors.VoidDestination.#ctor">VoidDestination()</h4>
