---
title: "RedisSource"
description: "Details for Class RedisSource (ETLBox.DataFlow.Connectors)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.Connectors.RedisSource">
  <h1 id="ETLBox_DataFlow_Connectors_RedisSource" data-uid="ETLBox.DataFlow.Connectors.RedisSource" class="text-break">Class RedisSource
</h1>
...
works only if your values contain json - for other values you can define your own serialization function.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow.connectors/redissource-1">RedisSource</a>&lt;<span class="xref">ExpandoObject</span>&gt;</div>
    <div class="level6"><span class="xref">RedisSource</span></div>
  </div>
  <div class="implements">
    <h5>Implements</h5>
    <div><a class="xref" href="/api/etlbox.controlflow/iloggabletask">ILoggableTask</a></div>
    <div><a class="xref" href="/api/etlbox.dataflow/idataflowlogging">IDataFlowLogging</a></div>
    <div><a class="xref" href="/api/etlbox.dataflow/idataflowexecutablesource-1">IDataFlowExecutableSource</a>&lt;<span class="xref">ExpandoObject</span>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/redissource-1#ETLBox_DataFlow_Connectors_RedisSource_1_TaskName">RedisSource&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/redissource-1#ETLBox_DataFlow_Connectors_RedisSource_1_ConnectionString">RedisSource&lt;ExpandoObject&gt;.ConnectionString</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/redissource-1#ETLBox_DataFlow_Connectors_RedisSource_1_RedisConnection">RedisSource&lt;ExpandoObject&gt;.RedisConnection</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/redissource-1#ETLBox_DataFlow_Connectors_RedisSource_1_DatabaseNumber">RedisSource&lt;ExpandoObject&gt;.DatabaseNumber</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/redissource-1#ETLBox_DataFlow_Connectors_RedisSource_1_DeserializerSettings">RedisSource&lt;ExpandoObject&gt;.DeserializerSettings</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/redissource-1#ETLBox_DataFlow_Connectors_RedisSource_1_DeserializationFunc">RedisSource&lt;ExpandoObject&gt;.DeserializationFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/redissource-1#ETLBox_DataFlow_Connectors_RedisSource_1_ScanPattern">RedisSource&lt;ExpandoObject&gt;.ScanPattern</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/redissource-1#ETLBox_DataFlow_Connectors_RedisSource_1_ScanCountSize">RedisSource&lt;ExpandoObject&gt;.ScanCountSize</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/redissource-1#ETLBox_DataFlow_Connectors_RedisSource_1_CheckParameter">RedisSource&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/redissource-1#ETLBox_DataFlow_Connectors_RedisSource_1_OnExecutionDoSynchronousWork">RedisSource&lt;ExpandoObject&gt;.OnExecutionDoSynchronousWork()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/redissource-1#ETLBox_DataFlow_Connectors_RedisSource_1_OnExecutionDoAsyncWork">RedisSource&lt;ExpandoObject&gt;.OnExecutionDoAsyncWork()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/redissource-1#ETLBox_DataFlow_Connectors_RedisSource_1_CleanUpOnSuccess">RedisSource&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/redissource-1#ETLBox_DataFlow_Connectors_RedisSource_1_CleanUpOnFaulted_System_Exception_">RedisSource&lt;ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Connectors</h6>
  ...
  <h5 id="ETLBox_DataFlow_Connectors_RedisSource_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class RedisSource : RedisSource<ExpandoObject>, ILoggableTask, IDataFlowLogging, IDataFlowExecutableSource<ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowSource, IDataFlowComponent, IDataFlowExecutableSource
```

{{< rawhtml >}}
  <h3 id="constructors">Constructors
</h3>
  <a id="ETLBox_DataFlow_Connectors_RedisSource__ctor_" data-uid="ETLBox.DataFlow.Connectors.RedisSource.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_RedisSource__ctor" data-uid="ETLBox.DataFlow.Connectors.RedisSource.#ctor">RedisSource()</h4>
