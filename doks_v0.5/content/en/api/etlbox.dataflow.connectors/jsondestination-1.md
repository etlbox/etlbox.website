...
dest.Wait(); //Wait for all data to arrive</code></pre>
  ...
  <div class="markdown level1 summary"><p>A Json destination defines a json file where data from the flow is inserted.</p>
</div>
...
{{< rawhtml >}}
  <h5 id="ETLBox_DataFlow_Connectors_JsonDestination_1__ctor_examples">Examples</h5>
  <pre><code>JsonDestination&lt;MyRow> dest = new JsonDestination&lt;MyRow>(&quot;/path/to/file.json&quot;);
dest.Wait(); //Wait for all data to arrive</code></pre>
  <a id="ETLBox_DataFlow_Connectors_JsonDestination_1__ctor_" data-uid="ETLBox.DataFlow.Connectors.JsonDestination`1.#ctor*"></a>
...
{{< rawhtml >}}
  ...
  <h5 id="ETLBox_DataFlow_Connectors_JsonDestination_1_CheckParameter_examples">Examples</h5>
  <pre><code>JsonDestination&lt;MyRow> dest = new JsonDestination&lt;MyRow>(&quot;/path/to/file.json&quot;);
dest.Wait(); //Wait for all data to arrive</code></pre>
...
{{< rawhtml >}}
  ...
  <h5 id="ETLBox_DataFlow_Connectors_JsonDestination_1_CloseStream_examples">Examples</h5>
  <pre><code>JsonDestination&lt;MyRow> dest = new JsonDestination&lt;MyRow>(&quot;/path/to/file.json&quot;);
dest.Wait(); //Wait for all data to arrive</code></pre>
...
{{< rawhtml >}}
  ...
  <h5 id="ETLBox_DataFlow_Connectors_JsonDestination_1_InitStream_examples">Examples</h5>
  <pre><code>JsonDestination&lt;MyRow> dest = new JsonDestination&lt;MyRow>(&quot;/path/to/file.json&quot;);
dest.Wait(); //Wait for all data to arrive</code></pre>
...
{{< rawhtml >}}
  ...
  <h5 id="ETLBox_DataFlow_Connectors_JsonDestination_1_WriteIntoStream__0__examples">Examples</h5>
  <pre><code>JsonDestination&lt;MyRow> dest = new JsonDestination&lt;MyRow>(&quot;/path/to/file.json&quot;);
dest.Wait(); //Wait for all data to arrive</code></pre>
