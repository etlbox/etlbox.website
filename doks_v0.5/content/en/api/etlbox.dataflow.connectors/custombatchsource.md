...
description: "Details for Class CustomBatchSource (ETLBox.DataFlow.Connectors)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.Connectors.CustomBatchSource">
  <h1 id="ETLBox_DataFlow_Connectors_CustomBatchSource" data-uid="ETLBox.DataFlow.Connectors.CustomBatchSource" class="text-break">Class CustomBatchSource
</h1>
...
which are then send subsequently into your data flow.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow.connectors/custombatchsource-1">CustomBatchSource</a>&lt;<span class="xref">ExpandoObject</span>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/custombatchsource-1#ETLBox_DataFlow_Connectors_CustomBatchSource_1_TaskName">CustomBatchSource&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/custombatchsource-1#ETLBox_DataFlow_Connectors_CustomBatchSource_1_ReadBatchFunc">CustomBatchSource&lt;ExpandoObject&gt;.ReadBatchFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/custombatchsource-1#ETLBox_DataFlow_Connectors_CustomBatchSource_1_ReadingCompleted">CustomBatchSource&lt;ExpandoObject&gt;.ReadingCompleted</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/custombatchsource-1#ETLBox_DataFlow_Connectors_CustomBatchSource_1_CheckParameter">CustomBatchSource&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/custombatchsource-1#ETLBox_DataFlow_Connectors_CustomBatchSource_1_OnExecutionDoSynchronousWork">CustomBatchSource&lt;ExpandoObject&gt;.OnExecutionDoSynchronousWork()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/custombatchsource-1#ETLBox_DataFlow_Connectors_CustomBatchSource_1_OnExecutionDoAsyncWork">CustomBatchSource&lt;ExpandoObject&gt;.OnExecutionDoAsyncWork()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/custombatchsource-1#ETLBox_DataFlow_Connectors_CustomBatchSource_1_CleanUpOnSuccess">CustomBatchSource&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/custombatchsource-1#ETLBox_DataFlow_Connectors_CustomBatchSource_1_CleanUpOnFaulted_System_Exception_">CustomBatchSource&lt;ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Connectors</h6>
  ...
  <h5 id="ETLBox_DataFlow_Connectors_CustomBatchSource_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Connectors_CustomBatchSource__ctor_" data-uid="ETLBox.DataFlow.Connectors.CustomBatchSource.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CustomBatchSource__ctor" data-uid="ETLBox.DataFlow.Connectors.CustomBatchSource.#ctor">CustomBatchSource()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_Connectors_CustomBatchSource__ctor_" data-uid="ETLBox.DataFlow.Connectors.CustomBatchSource.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CustomBatchSource__ctor_System_Func_System_Int32_System_Collections_Generic_IEnumerable_System_Dynamic_ExpandoObject___System_Predicate_System_Int32__" data-uid="ETLBox.DataFlow.Connectors.CustomBatchSource.#ctor(System.Func{System.Int32,System.Collections.Generic.IEnumerable{System.Dynamic.ExpandoObject}},System.Predicate{System.Int32})">CustomBatchSource(Func&lt;int, IEnumerable&lt;ExpandoObject&gt;&gt;, Predicate&lt;int&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">System.Func&lt;T, TResult&gt;</span>&lt;<span class="xref">int</span>, <span class="xref">System.Collections.Generic.IEnumerable&lt;T&gt;</span>&lt;<span class="xref">ExpandoObject</span>&gt;&gt;</td>
