...
description: "Details for Class ConcurrentMemoryDestination (ETLBox.DataFlow.Connectors)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.Connectors.ConcurrentMemoryDestination">
  <h1 id="ETLBox_DataFlow_Connectors_ConcurrentMemoryDestination" data-uid="ETLBox.DataFlow.Connectors.ConcurrentMemoryDestination" class="text-break">Class ConcurrentMemoryDestination
</h1>
...
the <a class="xref" href="/api/etlbox.dataflow.connectors/memorydestination">MemoryDestination</a> which uses a regular List&lt;T&gt;.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level4"><a class="xref" href="/api/etlbox.dataflow.connectors/memorydestination-1">MemoryDestination</a>&lt;<span class="xref">ExpandoObject</span>&gt;</div>
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow.connectors/concurrentmemorydestination-1">ConcurrentMemoryDestination</a>&lt;<span class="xref">ExpandoObject</span>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/concurrentmemorydestination-1#ETLBox_DataFlow_Connectors_ConcurrentMemoryDestination_1_TaskName">ConcurrentMemoryDestination&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/concurrentmemorydestination-1#ETLBox_DataFlow_Connectors_ConcurrentMemoryDestination_1_Data">ConcurrentMemoryDestination&lt;ExpandoObject&gt;.Data</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/concurrentmemorydestination-1#ETLBox_DataFlow_Connectors_ConcurrentMemoryDestination_1_CleanUpOnSuccess">ConcurrentMemoryDestination&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/concurrentmemorydestination-1#ETLBox_DataFlow_Connectors_ConcurrentMemoryDestination_1_CleanUpOnFaulted_System_Exception_">ConcurrentMemoryDestination&lt;ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/concurrentmemorydestination-1#ETLBox_DataFlow_Connectors_ConcurrentMemoryDestination_1_AddData__0_">ConcurrentMemoryDestination&lt;ExpandoObject&gt;.AddData(ExpandoObject)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/memorydestination-1#ETLBox_DataFlow_Connectors_MemoryDestination_1_CheckParameter">MemoryDestination&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/memorydestination-1#ETLBox_DataFlow_Connectors_MemoryDestination_1_InitComponent">MemoryDestination&lt;ExpandoObject&gt;.InitComponent()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Connectors</h6>
  ...
  <h5 id="ETLBox_DataFlow_Connectors_ConcurrentMemoryDestination_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Connectors_ConcurrentMemoryDestination__ctor_" data-uid="ETLBox.DataFlow.Connectors.ConcurrentMemoryDestination.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_ConcurrentMemoryDestination__ctor" data-uid="ETLBox.DataFlow.Connectors.ConcurrentMemoryDestination.#ctor">ConcurrentMemoryDestination()</h4>
