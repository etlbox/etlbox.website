---
title: "JsonSource"
description: "Details for Class JsonSource (ETLBox.DataFlow.Connectors)"
draft: false
images: []
menu:
  api:
...
By default, data is pulled via httpclient. Use the ResourceType property to read data from a file.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level6"><a class="xref" href="/api/etlbox.dataflow.connectors/jsonsource-1">JsonSource</a>&lt;<span class="xref">ExpandoObject</span>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/jsonsource-1#ETLBox_DataFlow_Connectors_JsonSource_1_TaskName">JsonSource&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/jsonsource-1#ETLBox_DataFlow_Connectors_JsonSource_1_InitReader">JsonSource&lt;ExpandoObject&gt;.InitReader()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/jsonsource-1#ETLBox_DataFlow_Connectors_JsonSource_1_ReadAllRecords">JsonSource&lt;ExpandoObject&gt;.ReadAllRecords()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/jsonsource-1#ETLBox_DataFlow_Connectors_JsonSource_1_CloseReader">JsonSource&lt;ExpandoObject&gt;.CloseReader()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Connectors</h6>
  ...
  <h5 id="ETLBox_DataFlow_Connectors_JsonSource_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class JsonSource : JsonSource<ExpandoObject>, ILoggableTask, IDataFlowLogging, IDataFlowStreamSource<ExpandoObject>, IDataFlowExecutableSource<ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowSource, IDataFlowComponent, IDataFlowExecutableSource, IDataFlowStreamSource
```
