---
title: "XmlSource"
description: "Details for Class XmlSource (ETLBox.DataFlow.Connectors)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.Connectors.XmlSource">
  <h1 id="ETLBox_DataFlow_Connectors_XmlSource" data-uid="ETLBox.DataFlow.Connectors.XmlSource" class="text-break">Class XmlSource
</h1>
...
By default, data is pulled via httpclient. Use the ResourceType property to read data from a file.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level6"><a class="xref" href="/api/etlbox.dataflow.connectors/xmlsource-1">XmlSource</a>&lt;<span class="xref">ExpandoObject</span>&gt;</div>
    <div class="level7"><span class="xref">XmlSource</span></div>
  </div>
  <div class="implements">
    <h5>Implements</h5>
    <div><a class="xref" href="/api/etlbox.controlflow/iloggabletask">ILoggableTask</a></div>
    <div><a class="xref" href="/api/etlbox.dataflow/idataflowlogging">IDataFlowLogging</a></div>
    <div><a class="xref" href="/api/etlbox.dataflow/idataflowstreamsource-1">IDataFlowStreamSource</a>&lt;<span class="xref">ExpandoObject</span>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/xmlsource-1#ETLBox_DataFlow_Connectors_XmlSource_1_TaskName">XmlSource&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/xmlsource-1#ETLBox_DataFlow_Connectors_XmlSource_1_XmlSerializer">XmlSource&lt;ExpandoObject&gt;.XmlSerializer</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/xmlsource-1#ETLBox_DataFlow_Connectors_XmlSource_1_XmlReaderSettings">XmlSource&lt;ExpandoObject&gt;.XmlReaderSettings</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/xmlsource-1#ETLBox_DataFlow_Connectors_XmlSource_1_ElementName">XmlSource&lt;ExpandoObject&gt;.ElementName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/xmlsource-1#ETLBox_DataFlow_Connectors_XmlSource_1_CollectUnparsedData">XmlSource&lt;ExpandoObject&gt;.CollectUnparsedData</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/xmlsource-1#ETLBox_DataFlow_Connectors_XmlSource_1_ElementNameRetrievalFunc">XmlSource&lt;ExpandoObject&gt;.ElementNameRetrievalFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/xmlsource-1#ETLBox_DataFlow_Connectors_XmlSource_1_CheckParameter">XmlSource&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/xmlsource-1#ETLBox_DataFlow_Connectors_XmlSource_1_InitReader">XmlSource&lt;ExpandoObject&gt;.InitReader()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/xmlsource-1#ETLBox_DataFlow_Connectors_XmlSource_1_ReadAllRecords">XmlSource&lt;ExpandoObject&gt;.ReadAllRecords()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/xmlsource-1#ETLBox_DataFlow_Connectors_XmlSource_1_CloseReader">XmlSource&lt;ExpandoObject&gt;.CloseReader()</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dataflowstreamsource-1#ETLBox_DataFlow_DataFlowStreamSource_1_PrepareParameter">DataFlowStreamSource&lt;ExpandoObject&gt;.PrepareParameter()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Connectors</h6>
  ...
  <h5 id="ETLBox_DataFlow_Connectors_XmlSource_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Connectors_XmlSource__ctor_" data-uid="ETLBox.DataFlow.Connectors.XmlSource.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_XmlSource__ctor" data-uid="ETLBox.DataFlow.Connectors.XmlSource.#ctor">XmlSource()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_Connectors_XmlSource__ctor_" data-uid="ETLBox.DataFlow.Connectors.XmlSource.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_XmlSource__ctor_System_String_ETLBox_DataFlow_ResourceType_" data-uid="ETLBox.DataFlow.Connectors.XmlSource.#ctor(System.String,ETLBox.DataFlow.ResourceType)">XmlSource(string, ResourceType)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Connectors_XmlSource__ctor_" data-uid="ETLBox.DataFlow.Connectors.XmlSource.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_XmlSource__ctor_System_String_" data-uid="ETLBox.DataFlow.Connectors.XmlSource.#ctor(System.String)">XmlSource(string)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
