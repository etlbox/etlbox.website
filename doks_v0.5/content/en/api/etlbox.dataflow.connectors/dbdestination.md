---
title: "DbDestination"
description: "Details for Class DbDestination (ETLBox.DataFlow.Connectors)"
draft: false
images: []
menu:
  api:
...
Inserts are done in batches (using Bulk insert or an equivalent INSERT statement).</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow.connectors/dbdestination-1">DbDestination</a>&lt;<span class="xref">ExpandoObject</span>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/dbdestination-1#ETLBox_DataFlow_Connectors_DbDestination_1_TaskName">DbDestination&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/dbdestination-1#ETLBox_DataFlow_Connectors_DbDestination_1_DestinationTableDefinition">DbDestination&lt;ExpandoObject&gt;.DestinationTableDefinition</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/dbdestination-1#ETLBox_DataFlow_Connectors_DbDestination_1_TableName">DbDestination&lt;ExpandoObject&gt;.TableName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/dbdestination-1#ETLBox_DataFlow_Connectors_DbDestination_1_BulkInsertConnectionManager">DbDestination&lt;ExpandoObject&gt;.BulkInsertConnectionManager</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/dbdestination-1#ETLBox_DataFlow_Connectors_DbDestination_1_PrepareParameter">DbDestination&lt;ExpandoObject&gt;.PrepareParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/dbdestination-1#ETLBox_DataFlow_Connectors_DbDestination_1_CheckParameter">DbDestination&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/dbdestination-1#ETLBox_DataFlow_Connectors_DbDestination_1_PrepareWrite">DbDestination&lt;ExpandoObject&gt;.PrepareWrite()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Connectors</h6>
  ...
  <h5 id="ETLBox_DataFlow_Connectors_DbDestination_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_Connectors_DbDestination__ctor_" data-uid="ETLBox.DataFlow.Connectors.DbDestination.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_DbDestination__ctor_ETLBox_Connection_IConnectionManager_System_String_System_Int32_" data-uid="ETLBox.DataFlow.Connectors.DbDestination.#ctor(ETLBox.Connection.IConnectionManager,System.String,System.Int32)">DbDestination(IConnectionManager, string, int)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Connectors_DbDestination__ctor_" data-uid="ETLBox.DataFlow.Connectors.DbDestination.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_DbDestination__ctor_System_String_System_Int32_" data-uid="ETLBox.DataFlow.Connectors.DbDestination.#ctor(System.String,System.Int32)">DbDestination(string, int)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
