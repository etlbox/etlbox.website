---
title: "CustomSource"
description: "Details for Class CustomSource (ETLBox.DataFlow.Connectors)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.Connectors.CustomSource">
  <h1 id="ETLBox_DataFlow_Connectors_CustomSource" data-uid="ETLBox.DataFlow.Connectors.CustomSource" class="text-break">Class CustomSource
</h1>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow.connectors/customsource-1">CustomSource</a>&lt;<span class="xref">ExpandoObject</span>&gt;</div>
    <div class="level6"><span class="xref">CustomSource</span></div>
  </div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/customsource-1#ETLBox_DataFlow_Connectors_CustomSource_1_TaskName">CustomSource&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/customsource-1#ETLBox_DataFlow_Connectors_CustomSource_1_ReadFunc">CustomSource&lt;ExpandoObject&gt;.ReadFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/customsource-1#ETLBox_DataFlow_Connectors_CustomSource_1_ReadingCompleted">CustomSource&lt;ExpandoObject&gt;.ReadingCompleted</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/customsource-1#ETLBox_DataFlow_Connectors_CustomSource_1_CheckParameter">CustomSource&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/customsource-1#ETLBox_DataFlow_Connectors_CustomSource_1_OnExecutionDoSynchronousWork">CustomSource&lt;ExpandoObject&gt;.OnExecutionDoSynchronousWork()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/customsource-1#ETLBox_DataFlow_Connectors_CustomSource_1_OnExecutionDoAsyncWork">CustomSource&lt;ExpandoObject&gt;.OnExecutionDoAsyncWork()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/customsource-1#ETLBox_DataFlow_Connectors_CustomSource_1_CleanUpOnSuccess">CustomSource&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/customsource-1#ETLBox_DataFlow_Connectors_CustomSource_1_CleanUpOnFaulted_System_Exception_">CustomSource&lt;ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Connectors</h6>
  ...
  <h5 id="ETLBox_DataFlow_Connectors_CustomSource_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class CustomSource : CustomSource<ExpandoObject>, ILoggableTask, IDataFlowLogging, IDataFlowExecutableSource<ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowSource, IDataFlowComponent, IDataFlowExecutableSource
```

{{< rawhtml >}}
  <h3 id="constructors">Constructors
</h3>
  <a id="ETLBox_DataFlow_Connectors_CustomSource__ctor_" data-uid="ETLBox.DataFlow.Connectors.CustomSource.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CustomSource__ctor" data-uid="ETLBox.DataFlow.Connectors.CustomSource.#ctor">CustomSource()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_Connectors_CustomSource__ctor_" data-uid="ETLBox.DataFlow.Connectors.CustomSource.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CustomSource__ctor_System_Func_System_Int32_System_Dynamic_ExpandoObject__System_Predicate_System_Int32__" data-uid="ETLBox.DataFlow.Connectors.CustomSource.#ctor(System.Func{System.Int32,System.Dynamic.ExpandoObject},System.Predicate{System.Int32})">CustomSource(Func&lt;int, ExpandoObject&gt;, Predicate&lt;int&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">System.Func&lt;T, TResult&gt;</span>&lt;<span class="xref">int</span>, <span class="xref">ExpandoObject</span>&gt;</td>
