---
title: "MariaDbOdbcConnectionManager"
description: "Details for Class MariaDbOdbcConnectionManager (ETLBox.Odbc)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.Odbc.MariaDbOdbcConnectionManager">
  <h1 id="ETLBox_Odbc_MariaDbOdbcConnectionManager" data-uid="ETLBox.Odbc.MariaDbOdbcConnectionManager" class="text-break">Class MariaDbOdbcConnectionManager
</h1>
  <div class="markdown level0 summary"><p>MariaDb Connection manager for an ODBC connection.
...
Reduce the batch size if you encounter issues here.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level3"><span class="xref">MariaDbOdbcConnectionManager</span></div>
  </div>
...
<h6><strong>Namespace</strong>: ETLBox.Odbc</h6>
  ...
  <h5 id="ETLBox_Odbc_MariaDbOdbcConnectionManager_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class MariaDbOdbcConnectionManager : OdbcConnectionManager, IConnectionManager<OdbcConnection, OdbcTransaction>, IConnectionManager, IDisposable
```

{{< rawhtml >}}
  <h3 id="constructors">Constructors
</h3>
  <a id="ETLBox_Odbc_MariaDbOdbcConnectionManager__ctor_" data-uid="ETLBox.Odbc.MariaDbOdbcConnectionManager.#ctor*"></a>
  <h4 id="ETLBox_Odbc_MariaDbOdbcConnectionManager__ctor" data-uid="ETLBox.Odbc.MariaDbOdbcConnectionManager.#ctor">MariaDbOdbcConnectionManager()</h4>
...
```C#
    public MariaDbOdbcConnectionManager()
```

{{< rawhtml >}}
  <a id="ETLBox_Odbc_MariaDbOdbcConnectionManager__ctor_" data-uid="ETLBox.Odbc.MariaDbOdbcConnectionManager.#ctor*"></a>
  <h4 id="ETLBox_Odbc_MariaDbOdbcConnectionManager__ctor_ETLBox_Odbc_OdbcConnectionString_" data-uid="ETLBox.Odbc.MariaDbOdbcConnectionManager.#ctor(ETLBox.Odbc.OdbcConnectionString)">MariaDbOdbcConnectionManager(OdbcConnectionString)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
```C#
    public MariaDbOdbcConnectionManager(OdbcConnectionString connectionString)
```
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Odbc_MariaDbOdbcConnectionManager__ctor_" data-uid="ETLBox.Odbc.MariaDbOdbcConnectionManager.#ctor*"></a>
  <h4 id="ETLBox_Odbc_MariaDbOdbcConnectionManager__ctor_System_String_" data-uid="ETLBox.Odbc.MariaDbOdbcConnectionManager.#ctor(System.String)">MariaDbOdbcConnectionManager(string)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
```C#
    public MariaDbOdbcConnectionManager(string connectionString)
```
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Odbc_MariaDbOdbcConnectionManager_SupportSchemas_" data-uid="ETLBox.Odbc.MariaDbOdbcConnectionManager.SupportSchemas*"></a>
  <h4 id="ETLBox_Odbc_MariaDbOdbcConnectionManager_SupportSchemas" data-uid="ETLBox.Odbc.MariaDbOdbcConnectionManager.SupportSchemas">SupportSchemas</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Odbc_MariaDbOdbcConnectionManager_Clone_" data-uid="ETLBox.Odbc.MariaDbOdbcConnectionManager.Clone*"></a>
  <h4 id="ETLBox_Odbc_MariaDbOdbcConnectionManager_Clone" data-uid="ETLBox.Odbc.MariaDbOdbcConnectionManager.Clone">Clone()</h4>
