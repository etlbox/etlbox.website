...
description: "Details for Class PostgresConnectionString (ETLBox.Postgres)"
draft: false
images: []
menu:
  api:
...
Internally the NpgsqlConnectionStringBuilder is used to access the values of the given connection string.</p>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox/dbconnectionstring-2#ETLBox_DbConnectionString_2_Builder">DbConnectionString&lt;PostgresConnectionString, NpgsqlConnectionStringBuilder&gt;.Builder</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox/dbconnectionstring-2#ETLBox_DbConnectionString_2_Value">DbConnectionString&lt;PostgresConnectionString, NpgsqlConnectionStringBuilder&gt;.Value</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox/dbconnectionstring-2#ETLBox_DbConnectionString_2_ToString">DbConnectionString&lt;PostgresConnectionString, NpgsqlConnectionStringBuilder&gt;.ToString()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox/dbconnectionstring-2#ETLBox_DbConnectionString_2_DbName">DbConnectionString&lt;PostgresConnectionString, NpgsqlConnectionStringBuilder&gt;.DbName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox/dbconnectionstring-2#ETLBox_DbConnectionString_2_DbNameKeyword">DbConnectionString&lt;PostgresConnectionString, NpgsqlConnectionStringBuilder&gt;.DbNameKeyword</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox/dbconnectionstring-2#ETLBox_DbConnectionString_2_Clone">DbConnectionString&lt;PostgresConnectionString, NpgsqlConnectionStringBuilder&gt;.Clone()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox/dbconnectionstring-2#ETLBox_DbConnectionString_2_CloneWithoutDbName">DbConnectionString&lt;PostgresConnectionString, NpgsqlConnectionStringBuilder&gt;.CloneWithoutDbName()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.Postgres</h6>
  ...
  <h5 id="ETLBox_Postgres_PostgresConnectionString_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Postgres_PostgresConnectionString__ctor_" data-uid="ETLBox.Postgres.PostgresConnectionString.#ctor*"></a>
  <h4 id="ETLBox_Postgres_PostgresConnectionString__ctor" data-uid="ETLBox.Postgres.PostgresConnectionString.#ctor">PostgresConnectionString()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_Postgres_PostgresConnectionString__ctor_" data-uid="ETLBox.Postgres.PostgresConnectionString.#ctor*"></a>
  <h4 id="ETLBox_Postgres_PostgresConnectionString__ctor_System_String_" data-uid="ETLBox.Postgres.PostgresConnectionString.#ctor(System.String)">PostgresConnectionString(string)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Postgres_PostgresConnectionString_DbName_" data-uid="ETLBox.Postgres.PostgresConnectionString.DbName*"></a>
  <h4 id="ETLBox_Postgres_PostgresConnectionString_DbName" data-uid="ETLBox.Postgres.PostgresConnectionString.DbName">DbName</h4>
...
{{< rawhtml >}}
  ...
  <h4 id="ETLBox_Postgres_PostgresConnectionString_op_Implicit_System_String__ETLBox_Postgres_PostgresConnectionString" data-uid="ETLBox.Postgres.PostgresConnectionString.op_Implicit(System.String)~ETLBox.Postgres.PostgresConnectionString">implicit operator PostgresConnectionString(string)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
