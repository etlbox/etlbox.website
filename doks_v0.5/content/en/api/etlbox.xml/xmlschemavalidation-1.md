...
description: "Details for Class XmlSchemaValidation<TInput> (ETLBox.Xml)"
draft: false
images: []
menu:
  api:
...
Rows with a schema that is not valid are send to the error output..</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><span class="xref">XmlSchemaValidation&lt;TInput&gt;</span></div>
      <div class="level6"><a class="xref" href="/api/etlbox.xml/xmlschemavalidation">XmlSchemaValidation</a></div>
  </div>
...
<h6><strong>Namespace</strong>: ETLBox.Xml</h6>
  ...
  <h5 id="ETLBox_Xml_XmlSchemaValidation_1_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class XmlSchemaValidation<TInput> : DataFlowTransformation<TInput, TInput>, IDataFlowLogging, IDataFlowTransformation<TInput, TInput>, IDataFlowSource<TInput>, IDataFlowSource, IDataFlowDestination<TInput>, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
...
schemaValidation.LinkErrorTo(error);</code></pre>
  ...
  <h4 id="ETLBox_Xml_XmlSchemaValidation_1__ctor" data-uid="ETLBox.Xml.XmlSchemaValidation`1.#ctor">XmlSchemaValidation()</h4>
...
{{< rawhtml >}}
  ...
  <h4 id="ETLBox_Xml_XmlSchemaValidation_1_SourceBlock" data-uid="ETLBox.Xml.XmlSchemaValidation`1.SourceBlock">SourceBlock</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Xml_XmlSchemaValidation_1_XmlSchema_" data-uid="ETLBox.Xml.XmlSchemaValidation`1.XmlSchema*"></a>
  <h4 id="ETLBox_Xml_XmlSchemaValidation_1_XmlSchema" data-uid="ETLBox.Xml.XmlSchemaValidation`1.XmlSchema">XmlSchema</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Xml_XmlSchemaValidation_1_XmlSelector_" data-uid="ETLBox.Xml.XmlSchemaValidation`1.XmlSelector*"></a>
  <h4 id="ETLBox_Xml_XmlSchemaValidation_1_XmlSelector" data-uid="ETLBox.Xml.XmlSchemaValidation`1.XmlSelector">XmlSelector</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Xml_XmlSchemaValidation_1_CheckParameter_" data-uid="ETLBox.Xml.XmlSchemaValidation`1.CheckParameter*"></a>
  <h4 id="ETLBox_Xml_XmlSchemaValidation_1_CheckParameter" data-uid="ETLBox.Xml.XmlSchemaValidation`1.CheckParameter">CheckParameter()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Xml_XmlSchemaValidation_1_Reset_" data-uid="ETLBox.Xml.XmlSchemaValidation`1.Reset*"></a>
  <h4 id="ETLBox_Xml_XmlSchemaValidation_1_Reset" data-uid="ETLBox.Xml.XmlSchemaValidation`1.Reset">Reset()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
