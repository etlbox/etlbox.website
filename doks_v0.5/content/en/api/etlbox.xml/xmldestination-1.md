...
{{< rawhtml >}}
  <h5 id="ETLBox_Xml_XmlDestination_1__ctor_examples">Examples</h5>
  <pre><code>XmlDestination&lt;MyRow> dest = new XmlDestination&lt;MyRow>(&quot;/path/to/file.json&quot;);
dest.Wait(); //Wait for all data to arrive</code></pre>
  <a id="ETLBox_Xml_XmlDestination_1__ctor_" data-uid="ETLBox.Xml.XmlDestination`1.#ctor*"></a>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Xml_XmlDestination_1_TaskName_" data-uid="ETLBox.Xml.XmlDestination`1.TaskName*"></a>
  <h4 id="ETLBox_Xml_XmlDestination_1_TaskName" data-uid="ETLBox.Xml.XmlDestination`1.TaskName">TaskName</h4>
...
{{< rawhtml >}}
  ...
  <h5 id="ETLBox_Xml_XmlDestination_1_CheckParameter_examples">Examples</h5>
  <pre><code>XmlDestination&lt;MyRow> dest = new XmlDestination&lt;MyRow>(&quot;/path/to/file.json&quot;);
dest.Wait(); //Wait for all data to arrive</code></pre>
...
{{< rawhtml >}}
  ...
  <h5 id="ETLBox_Xml_XmlDestination_1_CloseStream_examples">Examples</h5>
  <pre><code>XmlDestination&lt;MyRow> dest = new XmlDestination&lt;MyRow>(&quot;/path/to/file.json&quot;);
dest.Wait(); //Wait for all data to arrive</code></pre>
...
{{< rawhtml >}}
  ...
  <h5 id="ETLBox_Xml_XmlDestination_1_InitStream_examples">Examples</h5>
  <pre><code>XmlDestination&lt;MyRow> dest = new XmlDestination&lt;MyRow>(&quot;/path/to/file.json&quot;);
dest.Wait(); //Wait for all data to arrive</code></pre>
...
{{< rawhtml >}}
  ...
  <h5 id="ETLBox_Xml_XmlDestination_1_WriteIntoStream__0__examples">Examples</h5>
  <pre><code>XmlDestination&lt;MyRow> dest = new XmlDestination&lt;MyRow>(&quot;/path/to/file.json&quot;);
dest.Wait(); //Wait for all data to arrive</code></pre>
