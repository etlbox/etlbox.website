...
{{< rawhtml >}}
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.xml/xmldestination-1">XmlDestination</a>&lt;<span class="xref">ExpandoObject</span>&gt;</div>
...
```C#
    public class XmlDestination : XmlDestination<ExpandoObject>, ILoggableTask, IDataFlowLogging, IDataFlowStreamDestination<ExpandoObject>, IDataFlowDestination<ExpandoObject>, IDataFlowStreamDestination, IDataFlowDestination, IDataFlowComponent
```
