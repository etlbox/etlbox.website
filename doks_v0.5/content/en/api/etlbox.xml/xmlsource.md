---
title: "XmlSource"
description: "Details for Class XmlSource (ETLBox.Xml)"
draft: false
images: []
menu:
  api:
...
By default, data is pulled via httpclient. Use the ResourceType property to read data from a file.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level6"><a class="xref" href="ETLBox.Xml.XmlSource-1.html">XmlSource</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.xml/xmlsource-1#ETLBox_Xml_XmlSource_1_TaskName">XmlSource&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.xml/xmlsource-1#ETLBox_Xml_XmlSource_1_XmlSerializer">XmlSource&lt;ExpandoObject&gt;.XmlSerializer</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.xml/xmlsource-1#ETLBox_Xml_XmlSource_1_XmlReaderSettings">XmlSource&lt;ExpandoObject&gt;.XmlReaderSettings</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.xml/xmlsource-1#ETLBox_Xml_XmlSource_1_TextPrefixForDynamic">XmlSource&lt;ExpandoObject&gt;.TextPrefixForDynamic</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.xml/xmlsource-1#ETLBox_Xml_XmlSource_1_CheckParameter">XmlSource&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.xml/xmlsource-1#ETLBox_Xml_XmlSource_1_InitReader">XmlSource&lt;ExpandoObject&gt;.InitReader()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.xml/xmlsource-1#ETLBox_Xml_XmlSource_1_ReadAllRecords">XmlSource&lt;ExpandoObject&gt;.ReadAllRecords()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.xml/xmlsource-1#ETLBox_Xml_XmlSource_1_CloseReader">XmlSource&lt;ExpandoObject&gt;.CloseReader()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.Xml</h6>
  ...
  <h5 id="ETLBox_Xml_XmlSource_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <h4 id="ETLBox_Xml_XmlSource__ctor" data-uid="ETLBox.Xml.XmlSource.#ctor">XmlSource()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_Xml_XmlSource__ctor_" data-uid="ETLBox.Xml.XmlSource.#ctor*"></a>
  <h4 id="ETLBox_Xml_XmlSource__ctor_System_String_" data-uid="ETLBox.Xml.XmlSource.#ctor(System.String)">XmlSource(string)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Xml_XmlSource__ctor_" data-uid="ETLBox.Xml.XmlSource.#ctor*"></a>
  <h4 id="ETLBox_Xml_XmlSource__ctor_System_String_ETLBox_ResourceType_" data-uid="ETLBox.Xml.XmlSource.#ctor(System.String,ETLBox.ResourceType)">XmlSource(string, ResourceType)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
