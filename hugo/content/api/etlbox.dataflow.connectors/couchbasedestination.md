---
title: "CouchbaseDestination"
description: "Details for Class CouchbaseDestination (ETLBox.DataFlow.Connectors)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.Connectors.CouchbaseDestination">
  <h1 id="ETLBox_DataFlow_Connectors_CouchbaseDestination" data-uid="ETLBox.DataFlow.Connectors.CouchbaseDestination" class="text-break">Class CouchbaseDestination
  </h1>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow.connectors/couchbasedestination-1">CouchbaseDestination</a>&lt;<span class="xref">System.Dynamic.ExpandoObject</span>&gt;</div>
    <div class="level6"><span class="xref">CouchbaseDestination</span></div>
  </div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/couchbasedestination-1#ETLBox_DataFlow_Connectors_CouchbaseDestination_1_TaskName">CouchbaseDestination&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/couchbasedestination-1#ETLBox_DataFlow_Connectors_CouchbaseDestination_1_ConnectionString">CouchbaseDestination&lt;ExpandoObject&gt;.ConnectionString</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/couchbasedestination-1#ETLBox_DataFlow_Connectors_CouchbaseDestination_1_ClusterOptions">CouchbaseDestination&lt;ExpandoObject&gt;.ClusterOptions</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/couchbasedestination-1#ETLBox_DataFlow_Connectors_CouchbaseDestination_1_CouchbaseCluster">CouchbaseDestination&lt;ExpandoObject&gt;.CouchbaseCluster</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/couchbasedestination-1#ETLBox_DataFlow_Connectors_CouchbaseDestination_1_BucketName">CouchbaseDestination&lt;ExpandoObject&gt;.BucketName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/couchbasedestination-1#ETLBox_DataFlow_Connectors_CouchbaseDestination_1_Options">CouchbaseDestination&lt;ExpandoObject&gt;.Options</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/couchbasedestination-1#ETLBox_DataFlow_Connectors_CouchbaseDestination_1_KeyColumn">CouchbaseDestination&lt;ExpandoObject&gt;.KeyColumn</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/couchbasedestination-1#ETLBox_DataFlow_Connectors_CouchbaseDestination_1_PrepareParameter">CouchbaseDestination&lt;ExpandoObject&gt;.PrepareParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/couchbasedestination-1#ETLBox_DataFlow_Connectors_CouchbaseDestination_1_CheckParameter">CouchbaseDestination&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/couchbasedestination-1#ETLBox_DataFlow_Connectors_CouchbaseDestination_1_PrepareWrite">CouchbaseDestination&lt;ExpandoObject&gt;.PrepareWrite()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/couchbasedestination-1#ETLBox_DataFlow_Connectors_CouchbaseDestination_1_BulkInsertData__0___">CouchbaseDestination&lt;ExpandoObject&gt;.BulkInsertData(ExpandoObject[])</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/couchbasedestination-1#ETLBox_DataFlow_Connectors_CouchbaseDestination_1_FinishWrite">CouchbaseDestination&lt;ExpandoObject&gt;.FinishWrite()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Connectors</h6>
  ...
  <h5 id="ETLBox_DataFlow_Connectors_CouchbaseDestination_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Connectors_CouchbaseDestination__ctor_" data-uid="ETLBox.DataFlow.Connectors.CouchbaseDestination.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CouchbaseDestination__ctor" data-uid="ETLBox.DataFlow.Connectors.CouchbaseDestination.#ctor">CouchbaseDestination()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_Connectors_CouchbaseDestination__ctor_" data-uid="ETLBox.DataFlow.Connectors.CouchbaseDestination.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CouchbaseDestination__ctor_System_Int32_" data-uid="ETLBox.DataFlow.Connectors.CouchbaseDestination.#ctor(System.Int32)">CouchbaseDestination(Int32)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
{{< /rawhtml >}}
