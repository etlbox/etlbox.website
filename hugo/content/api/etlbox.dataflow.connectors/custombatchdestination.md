...
description: "Details for Class CustomBatchDestination (ETLBox.DataFlow.Connectors)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.Connectors.CustomBatchDestination">
  <h1 id="ETLBox_DataFlow_Connectors_CustomBatchDestination" data-uid="ETLBox.DataFlow.Connectors.CustomBatchDestination" class="text-break">Class CustomBatchDestination
  </h1>
...
which can be processed with the WriteBatchAction.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow.connectors/custombatchdestination-1">CustomBatchDestination</a>&lt;<span class="xref">System.Dynamic.ExpandoObject</span>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/custombatchdestination-1#ETLBox_DataFlow_Connectors_CustomBatchDestination_1_TaskName">CustomBatchDestination&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/custombatchdestination-1#ETLBox_DataFlow_Connectors_CustomBatchDestination_1_WriteBatchAction">CustomBatchDestination&lt;ExpandoObject&gt;.WriteBatchAction</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/custombatchdestination-1#ETLBox_DataFlow_Connectors_CustomBatchDestination_1_CheckParameter">CustomBatchDestination&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/custombatchdestination-1#ETLBox_DataFlow_Connectors_CustomBatchDestination_1_PrepareWrite">CustomBatchDestination&lt;ExpandoObject&gt;.PrepareWrite()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/custombatchdestination-1#ETLBox_DataFlow_Connectors_CustomBatchDestination_1_BulkInsertData__0___">CustomBatchDestination&lt;ExpandoObject&gt;.BulkInsertData(ExpandoObject[])</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/custombatchdestination-1#ETLBox_DataFlow_Connectors_CustomBatchDestination_1_FinishWrite">CustomBatchDestination&lt;ExpandoObject&gt;.FinishWrite()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Connectors</h6>
  ...
  <h5 id="ETLBox_DataFlow_Connectors_CustomBatchDestination_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Connectors_CustomBatchDestination__ctor_" data-uid="ETLBox.DataFlow.Connectors.CustomBatchDestination.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CustomBatchDestination__ctor" data-uid="ETLBox.DataFlow.Connectors.CustomBatchDestination.#ctor">CustomBatchDestination()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_Connectors_CustomBatchDestination__ctor_" data-uid="ETLBox.DataFlow.Connectors.CustomBatchDestination.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CustomBatchDestination__ctor_System_Action_System_Dynamic_ExpandoObject___System_Int32__" data-uid="ETLBox.DataFlow.Connectors.CustomBatchDestination.#ctor(System.Action{System.Dynamic.ExpandoObject[],System.Int32})">CustomBatchDestination(Action&lt;ExpandoObject[], Int32&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">System.Action</span>&lt;<span class="xref">System.Dynamic.ExpandoObject</span>[], <span class="xref">System.Int32</span>&gt;</td>
  ...
  <a id="ETLBox_DataFlow_Connectors_CustomBatchDestination__ctor_" data-uid="ETLBox.DataFlow.Connectors.CustomBatchDestination.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_CustomBatchDestination__ctor_System_Int32_System_Action_System_Dynamic_ExpandoObject___System_Int32__" data-uid="ETLBox.DataFlow.Connectors.CustomBatchDestination.#ctor(System.Int32,System.Action{System.Dynamic.ExpandoObject[],System.Int32})">CustomBatchDestination(Int32, Action&lt;ExpandoObject[], Int32&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
{{< /rawhtml >}}
