...
description: "Details for Class JsonDestination (ETLBox.DataFlow.Connectors)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.Connectors.JsonDestination">
  <h1 id="ETLBox_DataFlow_Connectors_JsonDestination" data-uid="ETLBox.DataFlow.Connectors.JsonDestination" class="text-break">Class JsonDestination
  </h1>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow.connectors/jsondestination-1">JsonDestination</a>&lt;<span class="xref">System.Dynamic.ExpandoObject</span>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/jsondestination-1#ETLBox_DataFlow_Connectors_JsonDestination_1_TaskName">JsonDestination&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/jsondestination-1#ETLBox_DataFlow_Connectors_JsonDestination_1_JsonSerializer">JsonDestination&lt;ExpandoObject&gt;.JsonSerializer</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/jsondestination-1#ETLBox_DataFlow_Connectors_JsonDestination_1_HttpContentType">JsonDestination&lt;ExpandoObject&gt;.HttpContentType</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/jsondestination-1#ETLBox_DataFlow_Connectors_JsonDestination_1_CheckParameter">JsonDestination&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/jsondestination-1#ETLBox_DataFlow_Connectors_JsonDestination_1_InitStream">JsonDestination&lt;ExpandoObject&gt;.InitStream()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/jsondestination-1#ETLBox_DataFlow_Connectors_JsonDestination_1_WriteIntoStream__0_">JsonDestination&lt;ExpandoObject&gt;.WriteIntoStream(ExpandoObject)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.connectors/jsondestination-1#ETLBox_DataFlow_Connectors_JsonDestination_1_CloseStream">JsonDestination&lt;ExpandoObject&gt;.CloseStream()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Connectors</h6>
  ...
  <h5 id="ETLBox_DataFlow_Connectors_JsonDestination_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Connectors_JsonDestination__ctor_" data-uid="ETLBox.DataFlow.Connectors.JsonDestination.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_JsonDestination__ctor" data-uid="ETLBox.DataFlow.Connectors.JsonDestination.#ctor">JsonDestination()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_Connectors_JsonDestination__ctor_" data-uid="ETLBox.DataFlow.Connectors.JsonDestination.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Connectors_JsonDestination__ctor_System_String_" data-uid="ETLBox.DataFlow.Connectors.JsonDestination.#ctor(System.String)">JsonDestination(String)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
{{< /rawhtml >}}
