---
title: "Sort"
description: "Details for Class Sort (ETLBox.DataFlow.Transformations)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.Transformations.Sort">
  <h1 id="ETLBox_DataFlow_Transformations_Sort" data-uid="ETLBox.DataFlow.Transformations.Sort" class="text-break">Class Sort
  </h1>
...
This is a blocking transformation - no output will be produced until all input data has arrived in the transformation.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow.transformations/sort-1">Sort</a>&lt;<span class="xref">System.Dynamic.ExpandoObject</span>&gt;</div>
    <div class="level6"><span class="xref">Sort</span></div>
  </div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/sort-1#ETLBox_DataFlow_Transformations_Sort_1_TaskName">Sort&lt;ExpandoObject&gt;.TaskName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/sort-1#ETLBox_DataFlow_Transformations_Sort_1_MaxBufferSize">Sort&lt;ExpandoObject&gt;.MaxBufferSize</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/sort-1#ETLBox_DataFlow_Transformations_Sort_1_SortFunction">Sort&lt;ExpandoObject&gt;.SortFunction</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/sort-1#ETLBox_DataFlow_Transformations_Sort_1_SourceBlock">Sort&lt;ExpandoObject&gt;.SourceBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/sort-1#ETLBox_DataFlow_Transformations_Sort_1_TargetBlock">Sort&lt;ExpandoObject&gt;.TargetBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/sort-1#ETLBox_DataFlow_Transformations_Sort_1_ProgressCount">Sort&lt;ExpandoObject&gt;.ProgressCount</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/sort-1#ETLBox_DataFlow_Transformations_Sort_1_CheckParameter">Sort&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/sort-1#ETLBox_DataFlow_Transformations_Sort_1_InitComponent">Sort&lt;ExpandoObject&gt;.InitComponent()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/sort-1#ETLBox_DataFlow_Transformations_Sort_1_CleanUpOnSuccess">Sort&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/sort-1#ETLBox_DataFlow_Transformations_Sort_1_CleanUpOnFaulted_System_Exception_">Sort&lt;ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow.transformations/sort-1#ETLBox_DataFlow_Transformations_Sort_1_LinkErrorTo_ETLBox_DataFlow_IDataFlowDestination_ETLBox_DataFlow_ETLBoxError__">Sort&lt;ExpandoObject&gt;.LinkErrorTo(IDataFlowDestination&lt;ETLBoxError&gt;)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow.Transformations</h6>
  ...
  <h5 id="ETLBox_DataFlow_Transformations_Sort_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Transformations_Sort__ctor_" data-uid="ETLBox.DataFlow.Transformations.Sort.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Transformations_Sort__ctor" data-uid="ETLBox.DataFlow.Transformations.Sort.#ctor">Sort()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_Transformations_Sort__ctor_" data-uid="ETLBox.DataFlow.Transformations.Sort.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Transformations_Sort__ctor_System_Comparison_System_Dynamic_ExpandoObject__" data-uid="ETLBox.DataFlow.Transformations.Sort.#ctor(System.Comparison{System.Dynamic.ExpandoObject})">Sort(Comparison&lt;ExpandoObject&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">System.Comparison</span>&lt;<span class="xref">System.Dynamic.ExpandoObject</span>&gt;</td>
