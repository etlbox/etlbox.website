...
{{< tab "Package Manager" >}}
```ps1
PM> NuGet\Install-Package ETLBox -Version 3.8.0
PM> NuGet\Install-Package ETLBox.Json -Version 3.8.0
```
{{< smallnote >}}
...
```xml
<PackageReference Include="ETLBox" Version="3.8.0" />
<PackageReference Include="ETLBox.Json" Version="3.8.0" />
```
{{< smallnote >}}
...
```cmd
> #r "nuget: ETLBox, 3.8.0"
> #r "nuget: ETLBox.Json, 3.8.0"
```
{{< smallnote >}}
