---
title: "ServiceBusSource"
description: "Details for Class ServiceBusSource (ETLBox.Azure.ServiceBus)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.Azure.ServiceBus.ServiceBusSource">
  <h1 id="ETLBox_Azure_ServiceBus_ServiceBusSource" data-uid="ETLBox.Azure.ServiceBus.ServiceBusSource" class="text-break">Class ServiceBusSource</h1>
...
a request or if no new messages can be read from the source.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.azure.servicebus/servicebussource-1">ServiceBusSource</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.azure.servicebus/servicebussource-1#ETLBox_Azure_ServiceBus_ServiceBusSource_1_InitCheckedParameter">ServiceBusSource&lt;ExpandoObject&gt;.InitCheckedParameter()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.Azure.ServiceBus</h6>
  ...
  <h5 id="ETLBox_Azure_ServiceBus_ServiceBusSource_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class ServiceBusSource : ServiceBusSource<ExpandoObject>, IDataFlowExecutableSource<ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowExecutableSource, IDataFlowSource, IDataFlowComponent, ILoggableTask
```

{{< rawhtml >}}
  <h3 id="constructors">Constructors
</h3>
  <a id="ETLBox_Azure_ServiceBus_ServiceBusSource__ctor_" data-uid="ETLBox.Azure.ServiceBus.ServiceBusSource.#ctor*"></a>
  <h4 id="ETLBox_Azure_ServiceBus_ServiceBusSource__ctor" data-uid="ETLBox.Azure.ServiceBus.ServiceBusSource.#ctor">ServiceBusSource()</h4>
