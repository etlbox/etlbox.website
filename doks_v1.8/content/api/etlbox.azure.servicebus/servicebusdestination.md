---
title: "ServiceBusDestination"
description: "Details for Class ServiceBusDestination (ETLBox.Azure.ServiceBus)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.Azure.ServiceBus.ServiceBusDestination">
  <h1 id="ETLBox_Azure_ServiceBus_ServiceBusDestination" data-uid="ETLBox.Azure.ServiceBus.ServiceBusDestination" class="text-break">Class ServiceBusDestination</h1>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.azure.servicebus/servicebusdestination-1">ServiceBusDestination</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.azure.servicebus/servicebusdestination-1#ETLBox_Azure_ServiceBus_ServiceBusDestination_1_PrepareParameterForCheck">ServiceBusDestination&lt;ExpandoObject&gt;.PrepareParameterForCheck()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.Azure.ServiceBus</h6>
  ...
  <h5 id="ETLBox_Azure_ServiceBus_ServiceBusDestination_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class ServiceBusDestination : ServiceBusDestination<ExpandoObject>, IDataFlowBatchDestination<ExpandoObject>, IDataFlowDestination<ExpandoObject>, IDataFlowBatchDestination, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```

{{< rawhtml >}}
  <h3 id="constructors">Constructors
</h3>
  <a id="ETLBox_Azure_ServiceBus_ServiceBusDestination__ctor_" data-uid="ETLBox.Azure.ServiceBus.ServiceBusDestination.#ctor*"></a>
  <h4 id="ETLBox_Azure_ServiceBus_ServiceBusDestination__ctor" data-uid="ETLBox.Azure.ServiceBus.ServiceBusDestination.#ctor">ServiceBusDestination()</h4>
