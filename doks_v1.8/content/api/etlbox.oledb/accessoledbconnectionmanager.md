---
title: "AccessOleDbConnectionManager"
description: "Details for Class AccessOleDbConnectionManager (ETLBox.OleDb)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.OleDb.AccessOleDbConnectionManager">
  <h1 id="ETLBox_OleDb_AccessOleDbConnectionManager" data-uid="ETLBox.OleDb.AccessOleDbConnectionManager" class="text-break">Class AccessOleDbConnectionManager</h1>
  ...
  <div class="inheritance">
    ...
    <div class="level3"><span class="xref">AccessOleDbConnectionManager</span></div>
  </div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.oledb/oledbconnectionmanager#ETLBox_OleDb_OleDbConnectionManager_ConnectionType">OleDbConnectionManager.ConnectionType</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.oledb/oledbconnectionmanager#ETLBox_OleDb_OleDbConnectionManager_QB">OleDbConnectionManager.QB</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.oledb/oledbconnectionmanager#ETLBox_OleDb_OleDbConnectionManager_QE">OleDbConnectionManager.QE</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.oledb/oledbconnectionmanager#ETLBox_OleDb_OleDbConnectionManager_IsOdbcOrOleDbConnection">OleDbConnectionManager.IsOdbcOrOleDbConnection</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.oledb/oledbconnectionmanager#ETLBox_OleDb_OleDbConnectionManager_BulkInsert_ETLBox_ITableData_">OleDbConnectionManager.BulkInsert(ITableData)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.oledb/oledbconnectionmanager#ETLBox_OleDb_OleDbConnectionManager_PrepareBulkInsert_System_String_">OleDbConnectionManager.PrepareBulkInsert(string)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.oledb/oledbconnectionmanager#ETLBox_OleDb_OleDbConnectionManager_CleanUpBulkInsert_System_String_">OleDbConnectionManager.CleanUpBulkInsert(string)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.oledb/oledbconnectionmanager#ETLBox_OleDb_OleDbConnectionManager_BulkDelete_ETLBox_ITableData_">OleDbConnectionManager.BulkDelete(ITableData)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.oledb/oledbconnectionmanager#ETLBox_OleDb_OleDbConnectionManager_BulkUpdate_ETLBox_ITableData_System_Collections_Generic_ICollection_System_String__System_Collections_Generic_ICollection_System_String__">OleDbConnectionManager.BulkUpdate(ITableData, ICollection&lt;string&gt;, ICollection&lt;string&gt;)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.oledb/oledbconnectionmanager#ETLBox_OleDb_OleDbConnectionManager_BulkSelect_ETLBox_ITableData_System_Collections_Generic_ICollection_System_String__System_Action_System_Action_System_Action_System_Object____">OleDbConnectionManager.BulkSelect(ITableData, ICollection&lt;string&gt;, Action, Action, params Action&lt;object&gt;[])</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox/dbconnectionmanager-3#ETLBox_DbConnectionManager_3_OpenAsync_System_Nullable_System_Threading_CancellationToken__">DbConnectionManager&lt;OleDbConnection, OleDbTransaction, OleDbParameter&gt;.OpenAsync(CancellationToken?)</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox/dbconnectionmanager-3#ETLBox_DbConnectionManager_3_GetSchemaFromTableName_System_String_">DbConnectionManager&lt;OleDbConnection, OleDbTransaction, OleDbParameter&gt;.GetSchemaFromTableName(string)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox/dbconnectionmanager-3#ETLBox_DbConnectionManager_3_GetSchemaFromSql_System_String_">DbConnectionManager&lt;OleDbConnection, OleDbTransaction, OleDbParameter&gt;.GetSchemaFromSql(string)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.OleDb</h6>
  ...
  <h5 id="ETLBox_OleDb_AccessOleDbConnectionManager_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class AccessOleDbConnectionManager : OleDbConnectionManager, IConnectionManager<OleDbConnection, OleDbTransaction>, IConnectionManager, IDisposable
```

{{< rawhtml >}}
  <h3 id="constructors">Constructors
</h3>
  <a id="ETLBox_OleDb_AccessOleDbConnectionManager__ctor_" data-uid="ETLBox.OleDb.AccessOleDbConnectionManager.#ctor*"></a>
  <h4 id="ETLBox_OleDb_AccessOleDbConnectionManager__ctor" data-uid="ETLBox.OleDb.AccessOleDbConnectionManager.#ctor">AccessOleDbConnectionManager()</h4>
...
```C#
    public AccessOleDbConnectionManager()
```

{{< rawhtml >}}
  <a id="ETLBox_OleDb_AccessOleDbConnectionManager__ctor_" data-uid="ETLBox.OleDb.AccessOleDbConnectionManager.#ctor*"></a>
  <h4 id="ETLBox_OleDb_AccessOleDbConnectionManager__ctor_ETLBox_OleDb_OleDbConnectionString_" data-uid="ETLBox.OleDb.AccessOleDbConnectionManager.#ctor(ETLBox.OleDb.OleDbConnectionString)">AccessOleDbConnectionManager(OleDbConnectionString)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
```C#
    public AccessOleDbConnectionManager(OleDbConnectionString connectionString)
```
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_OleDb_AccessOleDbConnectionManager__ctor_" data-uid="ETLBox.OleDb.AccessOleDbConnectionManager.#ctor*"></a>
  <h4 id="ETLBox_OleDb_AccessOleDbConnectionManager__ctor_System_String_" data-uid="ETLBox.OleDb.AccessOleDbConnectionManager.#ctor(System.String)">AccessOleDbConnectionManager(string)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
```C#
    public AccessOleDbConnectionManager(string connectionString)
```
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_OleDb_AccessOleDbConnectionManager_Clone_" data-uid="ETLBox.OleDb.AccessOleDbConnectionManager.Clone*"></a>
  <h4 id="ETLBox_OleDb_AccessOleDbConnectionManager_Clone" data-uid="ETLBox.OleDb.AccessOleDbConnectionManager.Clone">Clone()</h4>
...
{{< rawhtml >}}
  ...
  <div><a class="xref" href="/api/etlbox.oledb/oledbconnectionmanager#ETLBox_OleDb_OleDbConnectionManager_Clone">OleDbConnectionManager.Clone()</a></div>
