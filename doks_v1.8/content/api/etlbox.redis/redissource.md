...
{{< rawhtml >}}
  ...
  <h1 id="ETLBox_Redis_RedisSource" data-uid="ETLBox.Redis.RedisSource" class="text-break">Class RedisSource</h1>
...
```C#
    public class RedisSource : RedisSource<ExpandoObject>, IDataFlowExecutableSource<ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowExecutableSource, IDataFlowSource, IDataFlowComponent, ILoggableTask
```
