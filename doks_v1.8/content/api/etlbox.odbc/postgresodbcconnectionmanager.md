...
description: "Details for Class PostgresOdbcConnectionManager (ETLBox.Odbc)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.Odbc.PostgresOdbcConnectionManager">
  <h1 id="ETLBox_Odbc_PostgresOdbcConnectionManager" data-uid="ETLBox.Odbc.PostgresOdbcConnectionManager" class="text-break">Class PostgresOdbcConnectionManager</h1>
...
<h6><strong>Namespace</strong>: ETLBox.Odbc</h6>
  ...
  <h5 id="ETLBox_Odbc_PostgresOdbcConnectionManager_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Odbc_PostgresOdbcConnectionManager__ctor_" data-uid="ETLBox.Odbc.PostgresOdbcConnectionManager.#ctor*"></a>
  <h4 id="ETLBox_Odbc_PostgresOdbcConnectionManager__ctor" data-uid="ETLBox.Odbc.PostgresOdbcConnectionManager.#ctor">PostgresOdbcConnectionManager()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_Odbc_PostgresOdbcConnectionManager__ctor_" data-uid="ETLBox.Odbc.PostgresOdbcConnectionManager.#ctor*"></a>
  <h4 id="ETLBox_Odbc_PostgresOdbcConnectionManager__ctor_ETLBox_Odbc_OdbcConnectionString_" data-uid="ETLBox.Odbc.PostgresOdbcConnectionManager.#ctor(ETLBox.Odbc.OdbcConnectionString)">PostgresOdbcConnectionManager(OdbcConnectionString)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Odbc_PostgresOdbcConnectionManager__ctor_" data-uid="ETLBox.Odbc.PostgresOdbcConnectionManager.#ctor*"></a>
  <h4 id="ETLBox_Odbc_PostgresOdbcConnectionManager__ctor_System_String_" data-uid="ETLBox.Odbc.PostgresOdbcConnectionManager.#ctor(System.String)">PostgresOdbcConnectionManager(string)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Odbc_PostgresOdbcConnectionManager_Clone_" data-uid="ETLBox.Odbc.PostgresOdbcConnectionManager.Clone*"></a>
  <h4 id="ETLBox_Odbc_PostgresOdbcConnectionManager_Clone" data-uid="ETLBox.Odbc.PostgresOdbcConnectionManager.Clone">Clone()</h4>
