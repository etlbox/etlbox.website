...
```C#
    public class ConcurrentMemoryDestination : ConcurrentMemoryDestination<ExpandoObject>, IDataFlowDestination<ExpandoObject>, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
