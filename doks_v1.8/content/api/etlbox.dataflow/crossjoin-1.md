...
The InMemory target should always be the target of the smaller amount of data to reduce memory consumption and processing time.</p>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/crossjoin-3#ETLBox_DataFlow_CrossJoin_3_Reset">CrossJoin&lt;TInput, TInput, TInput&gt;.Reset()</a>
    </div>
    <div>
...
```C#
    public class CrossJoin<TInput> : CrossJoin<TInput, TInput, TInput>, IDataFlowSource<TInput>, IDataFlowSource, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
