---
title: "RowValidation"
description: "Details for Class RowValidation (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.RowValidation">
  <h1 id="ETLBox_DataFlow_RowValidation" data-uid="ETLBox.DataFlow.RowValidation" class="text-break">Class RowValidation</h1>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow/rowvalidation-1">RowValidation</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
    <div class="level6"><span class="xref">RowValidation</span></div>
  </div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowvalidation-1#ETLBox_DataFlow_RowValidation_1_SourceBlock">RowValidation&lt;ExpandoObject&gt;.SourceBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowvalidation-1#ETLBox_DataFlow_RowValidation_1_InvalidSourceBlock">RowValidation&lt;ExpandoObject&gt;.InvalidSourceBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowvalidation-1#ETLBox_DataFlow_RowValidation_1_TargetBlock">RowValidation&lt;ExpandoObject&gt;.TargetBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowvalidation-1#ETLBox_DataFlow_RowValidation_1_SkipValidationOfRowAfterFirstError">RowValidation&lt;ExpandoObject&gt;.SkipValidationOfRowAfterFirstError</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowvalidation-1#ETLBox_DataFlow_RowValidation_1_AddValidationErrorToRow">RowValidation&lt;ExpandoObject&gt;.AddValidationErrorToRow</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowvalidation-1#ETLBox_DataFlow_RowValidation_1_ValidateColumns">RowValidation&lt;ExpandoObject&gt;.ValidateColumns</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowvalidation-1#ETLBox_DataFlow_RowValidation_1_ValidateRowFunc">RowValidation&lt;ExpandoObject&gt;.ValidateRowFunc</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowvalidation-1#ETLBox_DataFlow_RowValidation_1_PrepareParameterForCheck">RowValidation&lt;ExpandoObject&gt;.PrepareParameterForCheck()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowvalidation-1#ETLBox_DataFlow_RowValidation_1_CheckParameter">RowValidation&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowvalidation-1#ETLBox_DataFlow_RowValidation_1_InitComponent">RowValidation&lt;ExpandoObject&gt;.InitComponent()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowvalidation-1#ETLBox_DataFlow_RowValidation_1_CleanUpOnSuccess">RowValidation&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowvalidation-1#ETLBox_DataFlow_RowValidation_1_LinkInvalidTo_ETLBox_IDataFlowDestination__0__System_Predicate__0__">RowValidation&lt;ExpandoObject&gt;.LinkInvalidTo(IDataFlowDestination&lt;ExpandoObject&gt;, Predicate&lt;ExpandoObject&gt;)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowvalidation-1#ETLBox_DataFlow_RowValidation_1_LinkInvalidTo_ETLBox_IDataFlowDestination__0__System_Predicate__0__System_Predicate__0__">RowValidation&lt;ExpandoObject&gt;.LinkInvalidTo(IDataFlowDestination&lt;ExpandoObject&gt;, Predicate&lt;ExpandoObject&gt;, Predicate&lt;ExpandoObject&gt;)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_RowValidation_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class RowValidation : RowValidation<ExpandoObject>, IDataFlowTransformation<ExpandoObject, ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowSource, IDataFlowDestination<ExpandoObject>, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```

{{< rawhtml >}}
  <h3 id="constructors">Constructors
</h3>
  <a id="ETLBox_DataFlow_RowValidation__ctor_" data-uid="ETLBox.DataFlow.RowValidation.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_RowValidation__ctor" data-uid="ETLBox.DataFlow.RowValidation.#ctor">RowValidation()</h4>
