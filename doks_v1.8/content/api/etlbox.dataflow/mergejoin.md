...
{{< rawhtml >}}
  ...
  <h1 id="ETLBox_DataFlow_MergeJoin" data-uid="ETLBox.DataFlow.MergeJoin" class="text-break">Class MergeJoin</h1>
...
```C#
    public class MergeJoin : MergeJoin<ExpandoObject, ExpandoObject, ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowSource, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
