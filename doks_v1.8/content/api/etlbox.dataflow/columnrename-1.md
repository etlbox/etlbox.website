...
```C#
    public class ColumnRename<TInput> : DataFlowTransformation<TInput, ExpandoObject>, IDataFlowTransformation<TInput, ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowSource, IDataFlowDestination<TInput>, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_ColumnRename_1_PrepareParameterForCheck_" data-uid="ETLBox.DataFlow.ColumnRename`1.PrepareParameterForCheck*"></a>
  <h4 id="ETLBox_DataFlow_ColumnRename_1_PrepareParameterForCheck" data-uid="ETLBox.DataFlow.ColumnRename`1.PrepareParameterForCheck">PrepareParameterForCheck()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_ColumnRename_1_Reset_" data-uid="ETLBox.DataFlow.ColumnRename`1.Reset*"></a>
  <h4 id="ETLBox_DataFlow_ColumnRename_1_Reset" data-uid="ETLBox.DataFlow.ColumnRename`1.Reset">Reset()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
