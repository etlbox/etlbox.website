---
title: "DbTypeCheck"
description: "Details for Class DbTypeCheck (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.DbTypeCheck">
  <h1 id="ETLBox_DataFlow_DbTypeCheck" data-uid="ETLBox.DataFlow.DbTypeCheck" class="text-break">Class DbTypeCheck</h1>
...
can be redirected as an <a class="xref" href="/api/etlbox/etlboxerror">ETLBoxError</a> using LinkErrorTo(..)</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow/dbtypecheck-1">DbTypeCheck</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
    <div class="level6"><span class="xref">DbTypeCheck</span></div>
  </div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbtypecheck-1#ETLBox_DataFlow_DbTypeCheck_1_TableDefinition">DbTypeCheck&lt;ExpandoObject&gt;.TableDefinition</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbtypecheck-1#ETLBox_DataFlow_DbTypeCheck_1_TableName">DbTypeCheck&lt;ExpandoObject&gt;.TableName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbtypecheck-1#ETLBox_DataFlow_DbTypeCheck_1_ColumnMapping">DbTypeCheck&lt;ExpandoObject&gt;.ColumnMapping</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbtypecheck-1#ETLBox_DataFlow_DbTypeCheck_1_SourceBlock">DbTypeCheck&lt;ExpandoObject&gt;.SourceBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbtypecheck-1#ETLBox_DataFlow_DbTypeCheck_1_FlawedSourceBlock">DbTypeCheck&lt;ExpandoObject&gt;.FlawedSourceBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbtypecheck-1#ETLBox_DataFlow_DbTypeCheck_1_TargetBlock">DbTypeCheck&lt;ExpandoObject&gt;.TargetBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbtypecheck-1#ETLBox_DataFlow_DbTypeCheck_1_IncludeIdentityColumn">DbTypeCheck&lt;ExpandoObject&gt;.IncludeIdentityColumn</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbtypecheck-1#ETLBox_DataFlow_DbTypeCheck_1_AllPropertiesMustMatch">DbTypeCheck&lt;ExpandoObject&gt;.AllPropertiesMustMatch</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbtypecheck-1#ETLBox_DataFlow_DbTypeCheck_1_CustomCheck">DbTypeCheck&lt;ExpandoObject&gt;.CustomCheck</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbtypecheck-1#ETLBox_DataFlow_DbTypeCheck_1_IncludeCharLength">DbTypeCheck&lt;ExpandoObject&gt;.IncludeCharLength</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbtypecheck-1#ETLBox_DataFlow_DbTypeCheck_1_IncludeBinaryLength">DbTypeCheck&lt;ExpandoObject&gt;.IncludeBinaryLength</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbtypecheck-1#ETLBox_DataFlow_DbTypeCheck_1_PrepareParameterForCheck">DbTypeCheck&lt;ExpandoObject&gt;.PrepareParameterForCheck()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbtypecheck-1#ETLBox_DataFlow_DbTypeCheck_1_CheckParameter">DbTypeCheck&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbtypecheck-1#ETLBox_DataFlow_DbTypeCheck_1_InitCheckedParameter">DbTypeCheck&lt;ExpandoObject&gt;.InitCheckedParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbtypecheck-1#ETLBox_DataFlow_DbTypeCheck_1_InitComponent">DbTypeCheck&lt;ExpandoObject&gt;.InitComponent()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbtypecheck-1#ETLBox_DataFlow_DbTypeCheck_1_CleanUpOnSuccess">DbTypeCheck&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbtypecheck-1#ETLBox_DataFlow_DbTypeCheck_1_LinkFlawedTo_ETLBox_IDataFlowDestination__0__System_Predicate__0__">DbTypeCheck&lt;ExpandoObject&gt;.LinkFlawedTo(IDataFlowDestination&lt;ExpandoObject&gt;, Predicate&lt;ExpandoObject&gt;)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbtypecheck-1#ETLBox_DataFlow_DbTypeCheck_1_LinkFlawedTo_ETLBox_IDataFlowDestination__0__System_Predicate__0__System_Predicate__0__">DbTypeCheck&lt;ExpandoObject&gt;.LinkFlawedTo(IDataFlowDestination&lt;ExpandoObject&gt;, Predicate&lt;ExpandoObject&gt;, Predicate&lt;ExpandoObject&gt;)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_DbTypeCheck_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class DbTypeCheck : DbTypeCheck<ExpandoObject>, IDataFlowTransformation<ExpandoObject, ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowSource, IDataFlowDestination<ExpandoObject>, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```

{{< rawhtml >}}
  <h3 id="constructors">Constructors
</h3>
  <a id="ETLBox_DataFlow_DbTypeCheck__ctor_" data-uid="ETLBox.DataFlow.DbTypeCheck.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_DbTypeCheck__ctor" data-uid="ETLBox.DataFlow.DbTypeCheck.#ctor">DbTypeCheck()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_DbTypeCheck__ctor_" data-uid="ETLBox.DataFlow.DbTypeCheck.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_DbTypeCheck__ctor_ETLBox_IConnectionManager_System_String_" data-uid="ETLBox.DataFlow.DbTypeCheck.#ctor(ETLBox.IConnectionManager,System.String)">DbTypeCheck(IConnectionManager, string)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_DbTypeCheck__ctor_" data-uid="ETLBox.DataFlow.DbTypeCheck.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_DbTypeCheck__ctor_System_String_" data-uid="ETLBox.DataFlow.DbTypeCheck.#ctor(System.String)">DbTypeCheck(string)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
