...
description: "Details for Class CachedBatchTransformation<TInput, TOutput, TCache> (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
memory to store a whole batch.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level6"><span class="xref">CachedBatchTransformation&lt;TInput, TOutput, TCache&gt;</span></div>
      <div class="level7"><a class="xref" href="/api/etlbox.dataflow/cachedbatchtransformation-1">CachedBatchTransformation&lt;TInput&gt;</a></div>
      <div class="level7"><a class="xref" href="/api/etlbox.dataflow/cachedbatchtransformation-2">CachedBatchTransformation&lt;TInput, TOutput&gt;</a></div>
  </div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_CachedBatchTransformation_3_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class CachedBatchTransformation<TInput, TOutput, TCache> : BatchTransformation<TInput, TOutput>, IDataFlowTransformation<TInput, TOutput>, IDataFlowSource<TOutput>, IDataFlowSource, IDataFlowDestination<TInput>, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
...
{{< rawhtml >}}
  ...
  <h4 id="ETLBox_DataFlow_CachedBatchTransformation_3__ctor" data-uid="ETLBox.DataFlow.CachedBatchTransformation`3.#ctor">CachedBatchTransformation()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_CachedBatchTransformation_3__ctor_" data-uid="ETLBox.DataFlow.CachedBatchTransformation`3.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_CachedBatchTransformation_3__ctor_System_Int32_" data-uid="ETLBox.DataFlow.CachedBatchTransformation`3.#ctor(System.Int32)">CachedBatchTransformation(int)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_CachedBatchTransformation_3_BatchTransformationFunc_" data-uid="ETLBox.DataFlow.CachedBatchTransformation`3.BatchTransformationFunc*"></a>
  <h4 id="ETLBox_DataFlow_CachedBatchTransformation_3_BatchTransformationFunc" data-uid="ETLBox.DataFlow.CachedBatchTransformation`3.BatchTransformationFunc">BatchTransformationFunc</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_CachedBatchTransformation_3_CacheManager_" data-uid="ETLBox.DataFlow.CachedBatchTransformation`3.CacheManager*"></a>
  <h4 id="ETLBox_DataFlow_CachedBatchTransformation_3_CacheManager" data-uid="ETLBox.DataFlow.CachedBatchTransformation`3.CacheManager">CacheManager</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_CachedBatchTransformation_3_MaxCacheSize_" data-uid="ETLBox.DataFlow.CachedBatchTransformation`3.MaxCacheSize*"></a>
  <h4 id="ETLBox_DataFlow_CachedBatchTransformation_3_MaxCacheSize" data-uid="ETLBox.DataFlow.CachedBatchTransformation`3.MaxCacheSize">MaxCacheSize</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_CachedBatchTransformation_3_CheckParameter_" data-uid="ETLBox.DataFlow.CachedBatchTransformation`3.CheckParameter*"></a>
  <h4 id="ETLBox_DataFlow_CachedBatchTransformation_3_CheckParameter" data-uid="ETLBox.DataFlow.CachedBatchTransformation`3.CheckParameter">CheckParameter()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <div><a class="xref" href="/api/etlbox.dataflow/batchtransformation-2#ETLBox_DataFlow_BatchTransformation_2_CheckParameter">BatchTransformation&lt;TInput, TOutput&gt;.CheckParameter()</a></div>
  <a id="ETLBox_DataFlow_CachedBatchTransformation_3_InvokeBatchTransformationFunc_" data-uid="ETLBox.DataFlow.CachedBatchTransformation`3.InvokeBatchTransformationFunc*"></a>
  <h4 id="ETLBox_DataFlow_CachedBatchTransformation_3_InvokeBatchTransformationFunc__0___" data-uid="ETLBox.DataFlow.CachedBatchTransformation`3.InvokeBatchTransformationFunc(`0[])">InvokeBatchTransformationFunc(TInput[])</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="/api/etlbox.dataflow/batchtransformation-2#ETLBox_DataFlow_BatchTransformation_2_InvokeBatchTransformationFunc__0___">BatchTransformation&lt;TInput, TOutput&gt;.InvokeBatchTransformationFunc(TInput[])</a></div>
  <a id="ETLBox_DataFlow_CachedBatchTransformation_3_InvokeInitActionOnce_" data-uid="ETLBox.DataFlow.CachedBatchTransformation`3.InvokeInitActionOnce*"></a>
  <h4 id="ETLBox_DataFlow_CachedBatchTransformation_3_InvokeInitActionOnce" data-uid="ETLBox.DataFlow.CachedBatchTransformation`3.InvokeInitActionOnce">InvokeInitActionOnce()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="/api/etlbox.dataflow/batchtransformation-2#ETLBox_DataFlow_BatchTransformation_2_InvokeInitActionOnce">BatchTransformation&lt;TInput, TOutput&gt;.InvokeInitActionOnce()</a></div>
  <a id="ETLBox_DataFlow_CachedBatchTransformation_3_Reset_" data-uid="ETLBox.DataFlow.CachedBatchTransformation`3.Reset*"></a>
  <h4 id="ETLBox_DataFlow_CachedBatchTransformation_3_Reset" data-uid="ETLBox.DataFlow.CachedBatchTransformation`3.Reset">Reset()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="/api/etlbox.dataflow/batchtransformation-2#ETLBox_DataFlow_BatchTransformation_2_Reset">BatchTransformation&lt;TInput, TOutput&gt;.Reset()</a></div>
