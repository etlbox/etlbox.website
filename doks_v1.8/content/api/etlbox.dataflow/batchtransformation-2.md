...
description: "Details for Class BatchTransformation<TInput, TOutput> (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.BatchTransformation`2">
  <h1 id="ETLBox_DataFlow_BatchTransformation_2" data-uid="ETLBox.DataFlow.BatchTransformation`2" class="text-break">Class BatchTransformation&lt;TInput, TOutput&gt;</h1>
  <div class="markdown level0 summary"><p>A batch transformation will transform batches of data. The default batch size are 30000 rows.
...
memory to store a whole batch.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><span class="xref">BatchTransformation&lt;TInput, TOutput&gt;</span></div>
      <div class="level6"><a class="xref" href="/api/etlbox.dataflow/batchtransformation-1">BatchTransformation&lt;TInput&gt;</a></div>
      <div class="level6"><a class="xref" href="/api/etlbox.dataflow/blocktransformation-2">BlockTransformation&lt;TInput, TOutput&gt;</a></div>
      <div class="level6"><a class="xref" href="/api/etlbox.dataflow/cachedbatchtransformation-3">CachedBatchTransformation&lt;TInput, TOutput, TCache&gt;</a></div>
  </div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_BatchTransformation_2_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class BatchTransformation<TInput, TOutput> : DataFlowTransformation<TInput, TOutput>, IDataFlowTransformation<TInput, TOutput>, IDataFlowSource<TOutput>, IDataFlowSource, IDataFlowDestination<TInput>, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_BatchTransformation_2__ctor_" data-uid="ETLBox.DataFlow.BatchTransformation`2.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_BatchTransformation_2__ctor" data-uid="ETLBox.DataFlow.BatchTransformation`2.#ctor">BatchTransformation()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_BatchTransformation_2__ctor_" data-uid="ETLBox.DataFlow.BatchTransformation`2.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_BatchTransformation_2__ctor_System_Int32_" data-uid="ETLBox.DataFlow.BatchTransformation`2.#ctor(System.Int32)">BatchTransformation(int)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_BatchTransformation_2__ctor_" data-uid="ETLBox.DataFlow.BatchTransformation`2.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_BatchTransformation_2__ctor_System_Int32_System_Func__0____1____" data-uid="ETLBox.DataFlow.BatchTransformation`2.#ctor(System.Int32,System.Func{`0[],`1[]})">BatchTransformation(int, Func&lt;TInput[], TOutput[]&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-condensed">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><p>Sets the <a class="xref" href="/api/etlbox.dataflow/batchtransformation-2#ETLBox_DataFlow_BatchTransformation_2_BatchTransformationFunc">BatchTransformationFunc</a></p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <h4 id="ETLBox_DataFlow_BatchTransformation_2_WasInitActionInvoked" data-uid="ETLBox.DataFlow.BatchTransformation`2.WasInitActionInvoked">WasInitActionInvoked</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_BatchTransformation_2_BatchSize_" data-uid="ETLBox.DataFlow.BatchTransformation`2.BatchSize*"></a>
  <h4 id="ETLBox_DataFlow_BatchTransformation_2_BatchSize" data-uid="ETLBox.DataFlow.BatchTransformation`2.BatchSize">BatchSize</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_BatchTransformation_2_BatchTransformationFunc_" data-uid="ETLBox.DataFlow.BatchTransformation`2.BatchTransformationFunc*"></a>
  <h4 id="ETLBox_DataFlow_BatchTransformation_2_BatchTransformationFunc" data-uid="ETLBox.DataFlow.BatchTransformation`2.BatchTransformationFunc">BatchTransformationFunc</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_BatchTransformation_2_InitAction_" data-uid="ETLBox.DataFlow.BatchTransformation`2.InitAction*"></a>
  <h4 id="ETLBox_DataFlow_BatchTransformation_2_InitAction" data-uid="ETLBox.DataFlow.BatchTransformation`2.InitAction">InitAction</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_BatchTransformation_2_SourceBlock_" data-uid="ETLBox.DataFlow.BatchTransformation`2.SourceBlock*"></a>
  <h4 id="ETLBox_DataFlow_BatchTransformation_2_SourceBlock" data-uid="ETLBox.DataFlow.BatchTransformation`2.SourceBlock">SourceBlock</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_BatchTransformation_2_SuppressNullValueFilter_" data-uid="ETLBox.DataFlow.BatchTransformation`2.SuppressNullValueFilter*"></a>
  <h4 id="ETLBox_DataFlow_BatchTransformation_2_SuppressNullValueFilter" data-uid="ETLBox.DataFlow.BatchTransformation`2.SuppressNullValueFilter">SuppressNullValueFilter</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_BatchTransformation_2_TargetBlock_" data-uid="ETLBox.DataFlow.BatchTransformation`2.TargetBlock*"></a>
  <h4 id="ETLBox_DataFlow_BatchTransformation_2_TargetBlock" data-uid="ETLBox.DataFlow.BatchTransformation`2.TargetBlock">TargetBlock</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_BatchTransformation_2_CheckAndAdjustBatchSize_" data-uid="ETLBox.DataFlow.BatchTransformation`2.CheckAndAdjustBatchSize*"></a>
  <h4 id="ETLBox_DataFlow_BatchTransformation_2_CheckAndAdjustBatchSize" data-uid="ETLBox.DataFlow.BatchTransformation`2.CheckAndAdjustBatchSize">CheckAndAdjustBatchSize()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_BatchTransformation_2_CheckParameter_" data-uid="ETLBox.DataFlow.BatchTransformation`2.CheckParameter*"></a>
  <h4 id="ETLBox_DataFlow_BatchTransformation_2_CheckParameter" data-uid="ETLBox.DataFlow.BatchTransformation`2.CheckParameter">CheckParameter()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_BatchTransformation_2_CleanUpOnFaulted_" data-uid="ETLBox.DataFlow.BatchTransformation`2.CleanUpOnFaulted*"></a>
  <h4 id="ETLBox_DataFlow_BatchTransformation_2_CleanUpOnFaulted_System_Exception_" data-uid="ETLBox.DataFlow.BatchTransformation`2.CleanUpOnFaulted(System.Exception)">CleanUpOnFaulted(Exception)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_BatchTransformation_2_CleanUpOnSuccess_" data-uid="ETLBox.DataFlow.BatchTransformation`2.CleanUpOnSuccess*"></a>
  <h4 id="ETLBox_DataFlow_BatchTransformation_2_CleanUpOnSuccess" data-uid="ETLBox.DataFlow.BatchTransformation`2.CleanUpOnSuccess">CleanUpOnSuccess()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_BatchTransformation_2_InitComponent_" data-uid="ETLBox.DataFlow.BatchTransformation`2.InitComponent*"></a>
  <h4 id="ETLBox_DataFlow_BatchTransformation_2_InitComponent" data-uid="ETLBox.DataFlow.BatchTransformation`2.InitComponent">InitComponent()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_BatchTransformation_2_InvokeBatchTransformationFunc_" data-uid="ETLBox.DataFlow.BatchTransformation`2.InvokeBatchTransformationFunc*"></a>
  <h4 id="ETLBox_DataFlow_BatchTransformation_2_InvokeBatchTransformationFunc__0___" data-uid="ETLBox.DataFlow.BatchTransformation`2.InvokeBatchTransformationFunc(`0[])">InvokeBatchTransformationFunc(TInput[])</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_BatchTransformation_2_InvokeInitActionOnce_" data-uid="ETLBox.DataFlow.BatchTransformation`2.InvokeInitActionOnce*"></a>
  <h4 id="ETLBox_DataFlow_BatchTransformation_2_InvokeInitActionOnce" data-uid="ETLBox.DataFlow.BatchTransformation`2.InvokeInitActionOnce">InvokeInitActionOnce()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_BatchTransformation_2_Reset_" data-uid="ETLBox.DataFlow.BatchTransformation`2.Reset*"></a>
  <h4 id="ETLBox_DataFlow_BatchTransformation_2_Reset" data-uid="ETLBox.DataFlow.BatchTransformation`2.Reset">Reset()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
