...
{{< rawhtml >}}
  ...
  <h1 id="ETLBox_DataFlow_CustomBatchDestination" data-uid="ETLBox.DataFlow.CustomBatchDestination" class="text-break">Class CustomBatchDestination</h1>
...
which can be processed with the WriteBatchAction.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow/custombatchdestination-1">CustomBatchDestination</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
