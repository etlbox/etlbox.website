...
description: "Details for Class CachedBatchTransformation<TInput> (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.CachedBatchTransformation`1">
  <h1 id="ETLBox_DataFlow_CachedBatchTransformation_1" data-uid="ETLBox.DataFlow.CachedBatchTransformation`1" class="text-break">Class CachedBatchTransformation&lt;TInput&gt;</h1>
...
memory to store a whole batch.</p>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/cachedbatchtransformation-3#ETLBox_DataFlow_CachedBatchTransformation_3_BatchTransformationFunc">CachedBatchTransformation&lt;TInput, TInput, TInput&gt;.BatchTransformationFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/cachedbatchtransformation-3#ETLBox_DataFlow_CachedBatchTransformation_3_CacheManager">CachedBatchTransformation&lt;TInput, TInput, TInput&gt;.CacheManager</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/cachedbatchtransformation-3#ETLBox_DataFlow_CachedBatchTransformation_3_MaxCacheSize">CachedBatchTransformation&lt;TInput, TInput, TInput&gt;.MaxCacheSize</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/cachedbatchtransformation-3#ETLBox_DataFlow_CachedBatchTransformation_3_Reset">CachedBatchTransformation&lt;TInput, TInput, TInput&gt;.Reset()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/cachedbatchtransformation-3#ETLBox_DataFlow_CachedBatchTransformation_3_CheckParameter">CachedBatchTransformation&lt;TInput, TInput, TInput&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/cachedbatchtransformation-3#ETLBox_DataFlow_CachedBatchTransformation_3_InvokeInitActionOnce">CachedBatchTransformation&lt;TInput, TInput, TInput&gt;.InvokeInitActionOnce()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/cachedbatchtransformation-3#ETLBox_DataFlow_CachedBatchTransformation_3_InvokeBatchTransformationFunc__0___">CachedBatchTransformation&lt;TInput, TInput, TInput&gt;.InvokeBatchTransformationFunc(TInput[])</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_CachedBatchTransformation_1_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class CachedBatchTransformation<TInput> : CachedBatchTransformation<TInput, TInput, TInput>, IDataFlowTransformation<TInput, TInput>, IDataFlowSource<TInput>, IDataFlowSource, IDataFlowDestination<TInput>, IDataFlowDestination, IDataFlowComponent, ILoggableTask where TInput : class
```
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_CachedBatchTransformation_1__ctor_" data-uid="ETLBox.DataFlow.CachedBatchTransformation`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_CachedBatchTransformation_1__ctor" data-uid="ETLBox.DataFlow.CachedBatchTransformation`1.#ctor">CachedBatchTransformation()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_CachedBatchTransformation_1__ctor_" data-uid="ETLBox.DataFlow.CachedBatchTransformation`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_CachedBatchTransformation_1__ctor_System_Int32_" data-uid="ETLBox.DataFlow.CachedBatchTransformation`1.#ctor(System.Int32)">CachedBatchTransformation(int)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_CachedBatchTransformation_1__ctor_" data-uid="ETLBox.DataFlow.CachedBatchTransformation`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_CachedBatchTransformation_1__ctor_System_Int32_System_Func__0___ETLBox_DataFlow_CachedData__0___0____" data-uid="ETLBox.DataFlow.CachedBatchTransformation`1.#ctor(System.Int32,System.Func{`0[],ETLBox.DataFlow.CachedData{`0},`0[]})">CachedBatchTransformation(int, Func&lt;TInput[], CachedData&lt;TInput&gt;, TInput[]&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
```C#
    public CachedBatchTransformation(int batchSize, Func<TInput[], CachedData<TInput>, TInput[]> batchTransformationFunc)
```
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_CachedBatchTransformation_1_Reset_" data-uid="ETLBox.DataFlow.CachedBatchTransformation`1.Reset*"></a>
  <h4 id="ETLBox_DataFlow_CachedBatchTransformation_1_Reset" data-uid="ETLBox.DataFlow.CachedBatchTransformation`1.Reset">Reset()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <div><a class="xref" href="/api/etlbox.dataflow/cachedbatchtransformation-3#ETLBox_DataFlow_CachedBatchTransformation_3_Reset">CachedBatchTransformation&lt;TInput, TInput, TInput&gt;.Reset()</a></div>
