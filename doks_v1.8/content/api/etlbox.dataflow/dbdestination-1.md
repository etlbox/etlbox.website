...
```C#
    public class DbDestination<TInput> : DataFlowBatchDestination<TInput>, IDataFlowBatchDestination<TInput>, IDataFlowDestination<TInput>, IDataFlowBatchDestination, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_DbDestination_1_PrepareParameterForCheck_" data-uid="ETLBox.DataFlow.DbDestination`1.PrepareParameterForCheck*"></a>
  <h4 id="ETLBox_DataFlow_DbDestination_1_PrepareParameterForCheck" data-uid="ETLBox.DataFlow.DbDestination`1.PrepareParameterForCheck">PrepareParameterForCheck()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_DbDestination_1_Reset_" data-uid="ETLBox.DataFlow.DbDestination`1.Reset*"></a>
  <h4 id="ETLBox_DataFlow_DbDestination_1_Reset" data-uid="ETLBox.DataFlow.DbDestination`1.Reset">Reset()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
