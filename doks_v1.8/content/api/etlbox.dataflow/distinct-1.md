---
title: "Distinct<TInput>"
description: "Details for Class Distinct<TInput> (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
  ...
  <h1 id="ETLBox_DataFlow_Distinct_1" data-uid="ETLBox.DataFlow.Distinct`1" class="text-break">Class Distinct&lt;TInput&gt;</h1>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_Distinct_1_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class Distinct<TInput> : DataFlowTransformation<TInput, TInput>, IDataFlowTransformation<TInput, TInput>, IDataFlowSource<TInput>, IDataFlowSource, IDataFlowDestination<TInput>, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Distinct_1__ctor_" data-uid="ETLBox.DataFlow.Distinct`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_Distinct_1__ctor" data-uid="ETLBox.DataFlow.Distinct`1.#ctor">Distinct()</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Distinct_1_DuplicatesSourceBlock_" data-uid="ETLBox.DataFlow.Distinct`1.DuplicatesSourceBlock*"></a>
  <h4 id="ETLBox_DataFlow_Distinct_1_DuplicatesSourceBlock" data-uid="ETLBox.DataFlow.Distinct`1.DuplicatesSourceBlock">DuplicatesSourceBlock</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Distinct_1_SourceBlock_" data-uid="ETLBox.DataFlow.Distinct`1.SourceBlock*"></a>
  <h4 id="ETLBox_DataFlow_Distinct_1_SourceBlock" data-uid="ETLBox.DataFlow.Distinct`1.SourceBlock">SourceBlock</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Distinct_1_AddComplementVoidLinkToOtherTargets_" data-uid="ETLBox.DataFlow.Distinct`1.AddComplementVoidLinkToOtherTargets*"></a>
  <h4 id="ETLBox_DataFlow_Distinct_1_AddComplementVoidLinkToOtherTargets_System_Func_System_Type_ETLBox_IDataFlowDestination__System_Delegate_" data-uid="ETLBox.DataFlow.Distinct`1.AddComplementVoidLinkToOtherTargets(System.Func{System.Type,ETLBox.IDataFlowDestination},System.Delegate)">AddComplementVoidLinkToOtherTargets(Func&lt;Type, IDataFlowDestination&gt;, Delegate)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Distinct_1_CleanUpOnFaulted_" data-uid="ETLBox.DataFlow.Distinct`1.CleanUpOnFaulted*"></a>
  <h4 id="ETLBox_DataFlow_Distinct_1_CleanUpOnFaulted_System_Exception_" data-uid="ETLBox.DataFlow.Distinct`1.CleanUpOnFaulted(System.Exception)">CleanUpOnFaulted(Exception)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Distinct_1_CleanUpOnSuccess_" data-uid="ETLBox.DataFlow.Distinct`1.CleanUpOnSuccess*"></a>
  <h4 id="ETLBox_DataFlow_Distinct_1_CleanUpOnSuccess" data-uid="ETLBox.DataFlow.Distinct`1.CleanUpOnSuccess">CleanUpOnSuccess()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Distinct_1_InitComponent_" data-uid="ETLBox.DataFlow.Distinct`1.InitComponent*"></a>
  <h4 id="ETLBox_DataFlow_Distinct_1_InitComponent" data-uid="ETLBox.DataFlow.Distinct`1.InitComponent">InitComponent()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Distinct_1_PrepareParameterForCheck_" data-uid="ETLBox.DataFlow.Distinct`1.PrepareParameterForCheck*"></a>
  <h4 id="ETLBox_DataFlow_Distinct_1_PrepareParameterForCheck" data-uid="ETLBox.DataFlow.Distinct`1.PrepareParameterForCheck">PrepareParameterForCheck()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_Distinct_1_Reset_" data-uid="ETLBox.DataFlow.Distinct`1.Reset*"></a>
  <h4 id="ETLBox_DataFlow_Distinct_1_Reset" data-uid="ETLBox.DataFlow.Distinct`1.Reset">Reset()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
