...
{{< rawhtml >}}
  ...
  <h1 id="ETLBox_DataFlow_DbDestination" data-uid="ETLBox.DataFlow.DbDestination" class="text-break">Class DbDestination</h1>
...
Inserts are done in batches (using Bulk insert or an equivalent INSERT statement).</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow/dbdestination-1">DbDestination</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbdestination-1#ETLBox_DataFlow_DbDestination_1_Reset">DbDestination&lt;ExpandoObject&gt;.Reset()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbdestination-1#ETLBox_DataFlow_DbDestination_1_PrepareParameterForCheck">DbDestination&lt;ExpandoObject&gt;.PrepareParameterForCheck()</a>
    </div>
    <div>
