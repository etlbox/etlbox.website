...
description: "Details for Class RowDuplication (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
property if you want to duplicate only particular rows.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow/rowduplication-1">RowDuplication</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowduplication-1#ETLBox_DataFlow_RowDuplication_1_NumberOfDuplicates">RowDuplication&lt;ExpandoObject&gt;.NumberOfDuplicates</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowduplication-1#ETLBox_DataFlow_RowDuplication_1_CanDuplicate">RowDuplication&lt;ExpandoObject&gt;.CanDuplicate</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowduplication-1#ETLBox_DataFlow_RowDuplication_1_SourceBlock">RowDuplication&lt;ExpandoObject&gt;.SourceBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowduplication-1#ETLBox_DataFlow_RowDuplication_1_TargetBlock">RowDuplication&lt;ExpandoObject&gt;.TargetBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowduplication-1#ETLBox_DataFlow_RowDuplication_1_CheckParameter">RowDuplication&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowduplication-1#ETLBox_DataFlow_RowDuplication_1_InitComponent">RowDuplication&lt;ExpandoObject&gt;.InitComponent()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowduplication-1#ETLBox_DataFlow_RowDuplication_1_CleanUpOnSuccess">RowDuplication&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/rowduplication-1#ETLBox_DataFlow_RowDuplication_1_CleanUpOnFaulted_System_Exception_">RowDuplication&lt;ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_RowDuplication_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class RowDuplication : RowDuplication<ExpandoObject>, IDataFlowTransformation<ExpandoObject, ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowSource, IDataFlowDestination<ExpandoObject>, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
...
source.LinkTo(duplication).LinkTo(dest);</code></pre>
  ...
  <h4 id="ETLBox_DataFlow_RowDuplication__ctor" data-uid="ETLBox.DataFlow.RowDuplication.#ctor">RowDuplication()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_RowDuplication__ctor_" data-uid="ETLBox.DataFlow.RowDuplication.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_RowDuplication__ctor_System_Int32_" data-uid="ETLBox.DataFlow.RowDuplication.#ctor(System.Int32)">RowDuplication(int)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_RowDuplication__ctor_" data-uid="ETLBox.DataFlow.RowDuplication.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_RowDuplication__ctor_System_Predicate_System_Dynamic_ExpandoObject__" data-uid="ETLBox.DataFlow.RowDuplication.#ctor(System.Predicate{System.Dynamic.ExpandoObject})">RowDuplication(Predicate&lt;ExpandoObject&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_RowDuplication__ctor_" data-uid="ETLBox.DataFlow.RowDuplication.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_RowDuplication__ctor_System_Predicate_System_Dynamic_ExpandoObject__System_Int32_" data-uid="ETLBox.DataFlow.RowDuplication.#ctor(System.Predicate{System.Dynamic.ExpandoObject},System.Int32)">RowDuplication(Predicate&lt;ExpandoObject&gt;, int)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
