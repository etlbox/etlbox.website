---
title: "ConcurrentMemoryDestination<TInput>"
description: "Details for Class ConcurrentMemoryDestination<TInput> (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.ConcurrentMemoryDestination`1">
  <h1 id="ETLBox_DataFlow_ConcurrentMemoryDestination_1" data-uid="ETLBox.DataFlow.ConcurrentMemoryDestination`1" class="text-break">Class ConcurrentMemoryDestination&lt;TInput&gt;</h1>
...
the <a class="xref" href="/api/etlbox.dataflow/memorydestination">MemoryDestination</a> which uses a regular List&lt;T&gt;.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level4"><a class="xref" href="/api/etlbox.dataflow/memorydestination-1">MemoryDestination</a>&lt;TInput&gt;</div>
    <div class="level5"><span class="xref">ConcurrentMemoryDestination&lt;TInput&gt;</span></div>
      <div class="level6"><a class="xref" href="/api/etlbox.dataflow/concurrentmemorydestination">ConcurrentMemoryDestination</a></div>
  </div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/memorydestination-1#ETLBox_DataFlow_MemoryDestination_1_CheckParameter">MemoryDestination&lt;TInput&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/memorydestination-1#ETLBox_DataFlow_MemoryDestination_1_InitComponent">MemoryDestination&lt;TInput&gt;.InitComponent()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_ConcurrentMemoryDestination_1_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_ConcurrentMemoryDestination_1__ctor_" data-uid="ETLBox.DataFlow.ConcurrentMemoryDestination`1.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_ConcurrentMemoryDestination_1__ctor" data-uid="ETLBox.DataFlow.ConcurrentMemoryDestination`1.#ctor">ConcurrentMemoryDestination()</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_ConcurrentMemoryDestination_1_ClearDataOnStart_" data-uid="ETLBox.DataFlow.ConcurrentMemoryDestination`1.ClearDataOnStart*"></a>
  <h4 id="ETLBox_DataFlow_ConcurrentMemoryDestination_1_ClearDataOnStart" data-uid="ETLBox.DataFlow.ConcurrentMemoryDestination`1.ClearDataOnStart">ClearDataOnStart</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_ConcurrentMemoryDestination_1_Data_" data-uid="ETLBox.DataFlow.ConcurrentMemoryDestination`1.Data*"></a>
  <h4 id="ETLBox_DataFlow_ConcurrentMemoryDestination_1_Data" data-uid="ETLBox.DataFlow.ConcurrentMemoryDestination`1.Data">Data</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <h4 id="ETLBox_DataFlow_ConcurrentMemoryDestination_1_AddData__0_" data-uid="ETLBox.DataFlow.ConcurrentMemoryDestination`1.AddData(`0)">AddData(TInput)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_ConcurrentMemoryDestination_1_Reset_" data-uid="ETLBox.DataFlow.ConcurrentMemoryDestination`1.Reset*"></a>
  <h4 id="ETLBox_DataFlow_ConcurrentMemoryDestination_1_Reset" data-uid="ETLBox.DataFlow.ConcurrentMemoryDestination`1.Reset">Reset()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
