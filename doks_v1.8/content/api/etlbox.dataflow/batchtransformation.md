...
{{< rawhtml >}}
  ...
  <h1 id="ETLBox_DataFlow_BatchTransformation" data-uid="ETLBox.DataFlow.BatchTransformation" class="text-break">Class BatchTransformation</h1>
...
memory to store a whole batch.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level6"><a class="xref" href="/api/etlbox.dataflow/batchtransformation-1">BatchTransformation</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
...
```C#
    public class BatchTransformation : BatchTransformation<ExpandoObject>, IDataFlowTransformation<ExpandoObject, ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowSource, IDataFlowDestination<ExpandoObject>, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
