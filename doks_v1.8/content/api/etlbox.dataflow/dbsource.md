...
Multiple database are supported. Use the corresponding connection manager that fits to your database.</p>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbsource-1#ETLBox_DataFlow_DbSource_1_PrepareParameterForCheck">DbSource&lt;ExpandoObject&gt;.PrepareParameterForCheck()</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/dbsource-1#ETLBox_DataFlow_DbSource_1_InitCheckedParameter">DbSource&lt;ExpandoObject&gt;.InitCheckedParameter()</a>
    </div>
    <div>
