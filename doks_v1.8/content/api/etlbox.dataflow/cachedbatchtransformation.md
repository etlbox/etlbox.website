...
description: "Details for Class CachedBatchTransformation (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.CachedBatchTransformation">
  <h1 id="ETLBox_DataFlow_CachedBatchTransformation" data-uid="ETLBox.DataFlow.CachedBatchTransformation" class="text-break">Class CachedBatchTransformation</h1>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow/batchtransformation-2">BatchTransformation</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>, <a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
    <div class="level6"><a class="xref" href="/api/etlbox.dataflow/cachedbatchtransformation-3">CachedBatchTransformation</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>, <a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>, <a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
    <div class="level7"><a class="xref" href="/api/etlbox.dataflow/cachedbatchtransformation-1">CachedBatchTransformation</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/cachedbatchtransformation-3#ETLBox_DataFlow_CachedBatchTransformation_3_BatchTransformationFunc">CachedBatchTransformation&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.BatchTransformationFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/cachedbatchtransformation-3#ETLBox_DataFlow_CachedBatchTransformation_3_CacheManager">CachedBatchTransformation&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.CacheManager</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/cachedbatchtransformation-3#ETLBox_DataFlow_CachedBatchTransformation_3_CheckParameter">CachedBatchTransformation&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/cachedbatchtransformation-3#ETLBox_DataFlow_CachedBatchTransformation_3_InvokeInitActionOnce">CachedBatchTransformation&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.InvokeInitActionOnce()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/cachedbatchtransformation-3#ETLBox_DataFlow_CachedBatchTransformation_3_InvokeBatchTransformationFunc__0___">CachedBatchTransformation&lt;ExpandoObject, ExpandoObject, ExpandoObject&gt;.InvokeBatchTransformationFunc(ExpandoObject[])</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/batchtransformation-2#ETLBox_DataFlow_BatchTransformation_2_Reset">BatchTransformation&lt;ExpandoObject, ExpandoObject&gt;.Reset()</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/batchtransformation-2#ETLBox_DataFlow_BatchTransformation_2_InvokeBatchTransformationFunc__0___">BatchTransformation&lt;ExpandoObject, ExpandoObject&gt;.InvokeBatchTransformationFunc(ExpandoObject[])</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_CachedBatchTransformation_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <h4 id="ETLBox_DataFlow_CachedBatchTransformation__ctor" data-uid="ETLBox.DataFlow.CachedBatchTransformation.#ctor">CachedBatchTransformation()</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_CachedBatchTransformation_Reset_" data-uid="ETLBox.DataFlow.CachedBatchTransformation.Reset*"></a>
  <h4 id="ETLBox_DataFlow_CachedBatchTransformation_Reset" data-uid="ETLBox.DataFlow.CachedBatchTransformation.Reset">Reset()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <div><a class="xref" href="/api/etlbox.dataflow/cachedbatchtransformation-1#ETLBox_DataFlow_CachedBatchTransformation_1_Reset">CachedBatchTransformation&lt;ExpandoObject&gt;.Reset()</a></div>
