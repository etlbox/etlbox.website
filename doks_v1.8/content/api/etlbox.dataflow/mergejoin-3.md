...
```C#
    public class MergeJoin<TInput1, TInput2, TOutput> : DataFlowSource<TOutput>, IDataFlowSource<TOutput>, IDataFlowSource, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_DataFlow_MergeJoin_3_Reset_" data-uid="ETLBox.DataFlow.MergeJoin`3.Reset*"></a>
  <h4 id="ETLBox_DataFlow_MergeJoin_3_Reset" data-uid="ETLBox.DataFlow.MergeJoin`3.Reset">Reset()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
