...
{{< rawhtml >}}
  ...
  <h1 id="ETLBox_MongoDb_MongoDbSource" data-uid="ETLBox.MongoDb.MongoDbSource" class="text-break">Class MongoDbSource</h1>
...
```C#
    public class MongoDbSource : MongoDbSource<ExpandoObject>, IDataFlowExecutableSource<ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowExecutableSource, IDataFlowSource, IDataFlowComponent, ILoggableTask
```
