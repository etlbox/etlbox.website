...
description: "Details for Class XmlSchemaValidation (ETLBox.Xml)"
draft: false
images: []
menu:
  api:
...
Rows with a schema that is not valid are send to the error output..</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.xml/xmlschemavalidation-1">XmlSchemaValidation</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.xml/xmlschemavalidation-1#ETLBox_Xml_XmlSchemaValidation_1_TargetBlock">XmlSchemaValidation&lt;ExpandoObject&gt;.TargetBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.xml/xmlschemavalidation-1#ETLBox_Xml_XmlSchemaValidation_1_SourceBlock">XmlSchemaValidation&lt;ExpandoObject&gt;.SourceBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.xml/xmlschemavalidation-1#ETLBox_Xml_XmlSchemaValidation_1_XmlSchema">XmlSchemaValidation&lt;ExpandoObject&gt;.XmlSchema</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.xml/xmlschemavalidation-1#ETLBox_Xml_XmlSchemaValidation_1_XmlSelector">XmlSchemaValidation&lt;ExpandoObject&gt;.XmlSelector</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.xml/xmlschemavalidation-1#ETLBox_Xml_XmlSchemaValidation_1_Reset">XmlSchemaValidation&lt;ExpandoObject&gt;.Reset()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.xml/xmlschemavalidation-1#ETLBox_Xml_XmlSchemaValidation_1_CheckParameter">XmlSchemaValidation&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.xml/xmlschemavalidation-1#ETLBox_Xml_XmlSchemaValidation_1_InitComponent">XmlSchemaValidation&lt;ExpandoObject&gt;.InitComponent()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.xml/xmlschemavalidation-1#ETLBox_Xml_XmlSchemaValidation_1_CleanUpOnSuccess">XmlSchemaValidation&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.xml/xmlschemavalidation-1#ETLBox_Xml_XmlSchemaValidation_1_CleanUpOnFaulted_System_Exception_">XmlSchemaValidation&lt;ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.xml/xmlschemavalidation-1#ETLBox_Xml_XmlSchemaValidation_1_LinkErrorTo_ETLBox_IDataFlowDestination_ETLBox_ETLBoxError__">XmlSchemaValidation&lt;ExpandoObject&gt;.LinkErrorTo(IDataFlowDestination&lt;ETLBoxError&gt;)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.Xml</h6>
  ...
  <h5 id="ETLBox_Xml_XmlSchemaValidation_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class XmlSchemaValidation : XmlSchemaValidation<ExpandoObject>, IDataFlowTransformation<ExpandoObject, ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowSource, IDataFlowDestination<ExpandoObject>, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
...
schemaValidation.LinkErrorTo(error);</code></pre>
  ...
  <h4 id="ETLBox_Xml_XmlSchemaValidation__ctor" data-uid="ETLBox.Xml.XmlSchemaValidation.#ctor">XmlSchemaValidation()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_Xml_XmlSchemaValidation__ctor_" data-uid="ETLBox.Xml.XmlSchemaValidation.#ctor*"></a>
  <h4 id="ETLBox_Xml_XmlSchemaValidation__ctor_System_String_System_Func_System_Dynamic_ExpandoObject_System_String__" data-uid="ETLBox.Xml.XmlSchemaValidation.#ctor(System.String,System.Func{System.Dynamic.ExpandoObject,System.String})">XmlSchemaValidation(string, Func&lt;ExpandoObject, string&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-condensed">
    ...
    <tbody>
      ...
      <tr>
        <td><a class="xref" href="https://learn.microsoft.com/dotnet/api/system.func-2">Func</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>, <a class="xref" href="https://learn.microsoft.com/dotnet/api/system.string">string</a>&gt;</td>
