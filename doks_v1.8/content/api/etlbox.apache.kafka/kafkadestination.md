---
title: "KafkaDestination"
description: "Details for Class KafkaDestination (ETLBox.Apache.Kafka)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.apache.kafka/kafkadestination-1">KafkaDestination</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
    <div class="level6"><span class="xref">KafkaDestination</span></div>
  </div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.apache.kafka/kafkadestination-1#ETLBox_Apache_Kafka_KafkaDestination_1_ProducerConfig">KafkaDestination&lt;ExpandoObject&gt;.ProducerConfig</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.apache.kafka/kafkadestination-1#ETLBox_Apache_Kafka_KafkaDestination_1_TopicName">KafkaDestination&lt;ExpandoObject&gt;.TopicName</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.apache.kafka/kafkadestination-1#ETLBox_Apache_Kafka_KafkaDestination_1_DeliveryHandler">KafkaDestination&lt;ExpandoObject&gt;.DeliveryHandler</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.apache.kafka/kafkadestination-1#ETLBox_Apache_Kafka_KafkaDestination_1_BuilderContext">KafkaDestination&lt;ExpandoObject&gt;.BuilderContext</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.apache.kafka/kafkadestination-1#ETLBox_Apache_Kafka_KafkaDestination_1_ProducerContext">KafkaDestination&lt;ExpandoObject&gt;.ProducerContext</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.apache.kafka/kafkadestination-1#ETLBox_Apache_Kafka_KafkaDestination_1_UseTransaction">KafkaDestination&lt;ExpandoObject&gt;.UseTransaction</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.apache.kafka/kafkadestination-1#ETLBox_Apache_Kafka_KafkaDestination_1_InitTransactionTimeout">KafkaDestination&lt;ExpandoObject&gt;.InitTransactionTimeout</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.apache.kafka/kafkadestination-1#ETLBox_Apache_Kafka_KafkaDestination_1_CheckParameter">KafkaDestination&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.apache.kafka/kafkadestination-1#ETLBox_Apache_Kafka_KafkaDestination_1_PrepareWrite">KafkaDestination&lt;ExpandoObject&gt;.PrepareWrite()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.apache.kafka/kafkadestination-1#ETLBox_Apache_Kafka_KafkaDestination_1_BulkInsertData__0___">KafkaDestination&lt;ExpandoObject&gt;.BulkInsertData(ExpandoObject[])</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.apache.kafka/kafkadestination-1#ETLBox_Apache_Kafka_KafkaDestination_1_CleanUpOnSuccess">KafkaDestination&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.apache.kafka/kafkadestination-1#ETLBox_Apache_Kafka_KafkaDestination_1_CleanUpOnFaulted_System_Exception_">KafkaDestination&lt;ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.apache.kafka/kafkadestination-1#ETLBox_Apache_Kafka_KafkaDestination_1_FinishWrite">KafkaDestination&lt;ExpandoObject&gt;.FinishWrite()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.Apache.Kafka</h6>
  ...
  <h5 id="ETLBox_Apache_Kafka_KafkaDestination_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class KafkaDestination : KafkaDestination<ExpandoObject>, IDataFlowBatchDestination<ExpandoObject>, IDataFlowDestination<ExpandoObject>, IDataFlowBatchDestination, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```

{{< rawhtml >}}
  <h3 id="constructors">Constructors
</h3>
  <a id="ETLBox_Apache_Kafka_KafkaDestination__ctor_" data-uid="ETLBox.Apache.Kafka.KafkaDestination.#ctor*"></a>
  <h4 id="ETLBox_Apache_Kafka_KafkaDestination__ctor" data-uid="ETLBox.Apache.Kafka.KafkaDestination.#ctor">KafkaDestination()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_Apache_Kafka_KafkaDestination__ctor_" data-uid="ETLBox.Apache.Kafka.KafkaDestination.#ctor*"></a>
  <h4 id="ETLBox_Apache_Kafka_KafkaDestination__ctor_System_Int32_" data-uid="ETLBox.Apache.Kafka.KafkaDestination.#ctor(System.Int32)">KafkaDestination(int)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
