---
title: "TableSource"
description: "Details for Class TableSource (ETLBox.Azure.Tables)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.Azure.Tables.TableSource">
  <h1 id="ETLBox_Azure_Tables_TableSource" data-uid="ETLBox.Azure.Tables.TableSource" class="text-break">Class TableSource</h1>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.azure.tables/tablesource-1">TableSource</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.azure.tables/tablesource-1#ETLBox_Azure_Tables_TableSource_1_PrepareParameterForCheck">TableSource&lt;ExpandoObject&gt;.PrepareParameterForCheck()</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.azure.tables/tablesource-1#ETLBox_Azure_Tables_TableSource_1_InitCheckedParameter">TableSource&lt;ExpandoObject&gt;.InitCheckedParameter()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.Azure.Tables</h6>
  ...
  <h5 id="ETLBox_Azure_Tables_TableSource_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class TableSource : TableSource<ExpandoObject>, IDataFlowExecutableSource<ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowExecutableSource, IDataFlowSource, IDataFlowComponent, ILoggableTask
```

{{< rawhtml >}}
  <h3 id="constructors">Constructors
</h3>
  <a id="ETLBox_Azure_Tables_TableSource__ctor_" data-uid="ETLBox.Azure.Tables.TableSource.#ctor*"></a>
  <h4 id="ETLBox_Azure_Tables_TableSource__ctor" data-uid="ETLBox.Azure.Tables.TableSource.#ctor">TableSource()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_Azure_Tables_TableSource__ctor_" data-uid="ETLBox.Azure.Tables.TableSource.#ctor*"></a>
  <h4 id="ETLBox_Azure_Tables_TableSource__ctor_System_String_System_String_" data-uid="ETLBox.Azure.Tables.TableSource.#ctor(System.String,System.String)">TableSource(string, string)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
