...
{{< rawhtml >}}
  ...
  <h1 id="ETLBox_Azure_Tables_TableDestination" data-uid="ETLBox.Azure.Tables.TableDestination" class="text-break">Class TableDestination</h1>
...
```C#
    public class TableDestination : TableDestination<ExpandoObject>, IDataFlowBatchDestination<ExpandoObject>, IDataFlowDestination<ExpandoObject>, IDataFlowBatchDestination, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
