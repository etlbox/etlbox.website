---
title: "InsertColumn"
description: "Details for Class InsertColumn (ETLBox)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.InsertColumn">
  <h1 id="ETLBox_InsertColumn" data-uid="ETLBox.InsertColumn" class="text-break">Class InsertColumn</h1>
  <div class="markdown level0 summary"><p>This attribute defines if a column in the destination is inserted.</p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level2"><span class="xref">InsertColumn</span></div>
  </div>
...
<h6><strong>Namespace</strong>: ETLBox</h6>
  ...
  <h5 id="ETLBox_InsertColumn_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  <h5 id="ETLBox_InsertColumn_examples"><strong>Examples</strong></h5>
...
public string IgnoredValue { get;set; }
  ...
  <a id="ETLBox_InsertColumn__ctor_" data-uid="ETLBox.InsertColumn.#ctor*"></a>
  <h4 id="ETLBox_InsertColumn__ctor" data-uid="ETLBox.InsertColumn.#ctor">InsertColumn()</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_InsertColumn_InsertPropertyName_" data-uid="ETLBox.InsertColumn.InsertPropertyName*"></a>
  <h4 id="ETLBox_InsertColumn_InsertPropertyName" data-uid="ETLBox.InsertColumn.InsertPropertyName">InsertPropertyName</h4>
