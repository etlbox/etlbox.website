---
title: "RemoveColumn"
description: "Details for Class RemoveColumn (ETLBox)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
  ...
  <h1 id="ETLBox_RemoveColumn" data-uid="ETLBox.RemoveColumn" class="text-break">Class RemoveColumn</h1>
...
You can remove a property in either your strong typed or dynamic object.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level2"><span class="xref">RemoveColumn</span></div>
  </div>
...
<h6><strong>Namespace</strong>: ETLBox</h6>
  ...
  <h5 id="ETLBox_RemoveColumn_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_RemoveColumn__ctor_" data-uid="ETLBox.RemoveColumn.#ctor*"></a>
  <h4 id="ETLBox_RemoveColumn__ctor" data-uid="ETLBox.RemoveColumn.#ctor">RemoveColumn()</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_RemoveColumn_PropertyName_" data-uid="ETLBox.RemoveColumn.PropertyName*"></a>
  <h4 id="ETLBox_RemoveColumn_PropertyName" data-uid="ETLBox.RemoveColumn.PropertyName">PropertyName</h4>
  <div class="markdown level1 summary"><p>Name of the property that should be removed (not needed if you use this class as an attribute)</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
