---
title: "IdColumn"
description: "Details for Class IdColumn (ETLBox)"
draft: false
images: []
menu:
  api:
...
<h6><strong>Namespace</strong>: ETLBox</h6>
  ...
  <h5 id="ETLBox_IdColumn_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  <h5 id="ETLBox_IdColumn_examples"><strong>Examples</strong></h5>
  <pre><code class="lang-csharp">public class MyPoco : MergeableRow
{
  ...
  <a id="ETLBox_IdColumn__ctor_" data-uid="ETLBox.IdColumn.#ctor*"></a>
  <h4 id="ETLBox_IdColumn__ctor" data-uid="ETLBox.IdColumn.#ctor">IdColumn()</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_IdColumn_IdPropertyName_" data-uid="ETLBox.IdColumn.IdPropertyName*"></a>
  <h4 id="ETLBox_IdColumn_IdPropertyName" data-uid="ETLBox.IdColumn.IdPropertyName">IdPropertyName</h4>
