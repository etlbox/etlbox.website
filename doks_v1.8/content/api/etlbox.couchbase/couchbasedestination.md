...
{{< rawhtml >}}
  ...
  <h1 id="ETLBox_Couchbase_CouchbaseDestination" data-uid="ETLBox.Couchbase.CouchbaseDestination" class="text-break">Class CouchbaseDestination</h1>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.couchbase/couchbasedestination-1">CouchbaseDestination</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.couchbase/couchbasedestination-1#ETLBox_Couchbase_CouchbaseDestination_1_Reset">CouchbaseDestination&lt;ExpandoObject&gt;.Reset()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.couchbase/couchbasedestination-1#ETLBox_Couchbase_CouchbaseDestination_1_PrepareParameterForCheck">CouchbaseDestination&lt;ExpandoObject&gt;.PrepareParameterForCheck()</a>
    </div>
    <div>
...
```C#
    public class CouchbaseDestination : CouchbaseDestination<ExpandoObject>, IDataFlowBatchDestination<ExpandoObject>, IDataFlowDestination<ExpandoObject>, IDataFlowBatchDestination, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
