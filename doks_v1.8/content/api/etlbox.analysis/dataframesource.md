---
title: "DataFrameSource"
description: "Details for Class DataFrameSource (ETLBox.Analysis)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.Analysis.DataFrameSource">
  <h1 id="ETLBox_Analysis_DataFrameSource" data-uid="ETLBox.Analysis.DataFrameSource" class="text-break">Class DataFrameSource</h1>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.analysis/dataframesource-1">DataFrameSource</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
    <div class="level6"><span class="xref">DataFrameSource</span></div>
  </div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.analysis/dataframesource-1#ETLBox_Analysis_DataFrameSource_1_DataFrame">DataFrameSource&lt;ExpandoObject&gt;.DataFrame</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.analysis/dataframesource-1#ETLBox_Analysis_DataFrameSource_1_DataFrameColumnMapping">DataFrameSource&lt;ExpandoObject&gt;.DataFrameColumnMapping</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.analysis/dataframesource-1#ETLBox_Analysis_DataFrameSource_1_Reset">DataFrameSource&lt;ExpandoObject&gt;.Reset()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.analysis/dataframesource-1#ETLBox_Analysis_DataFrameSource_1_PrepareParameterForCheck">DataFrameSource&lt;ExpandoObject&gt;.PrepareParameterForCheck()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.analysis/dataframesource-1#ETLBox_Analysis_DataFrameSource_1_CheckParameter">DataFrameSource&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.analysis/dataframesource-1#ETLBox_Analysis_DataFrameSource_1_OnExecutionDoAsyncWork">DataFrameSource&lt;ExpandoObject&gt;.OnExecutionDoAsyncWork()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.analysis/dataframesource-1#ETLBox_Analysis_DataFrameSource_1_CleanUpOnSuccess">DataFrameSource&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.analysis/dataframesource-1#ETLBox_Analysis_DataFrameSource_1_CleanUpOnFaulted_System_Exception_">DataFrameSource&lt;ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.Analysis</h6>
  ...
  <h5 id="ETLBox_Analysis_DataFrameSource_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class DataFrameSource : DataFrameSource<ExpandoObject>, IDataFlowExecutableSource<ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowExecutableSource, IDataFlowSource, IDataFlowComponent, ILoggableTask
```

{{< rawhtml >}}
  <h3 id="constructors">Constructors
</h3>
  <a id="ETLBox_Analysis_DataFrameSource__ctor_" data-uid="ETLBox.Analysis.DataFrameSource.#ctor*"></a>
  <h4 id="ETLBox_Analysis_DataFrameSource__ctor" data-uid="ETLBox.Analysis.DataFrameSource.#ctor">DataFrameSource()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_Analysis_DataFrameSource__ctor_" data-uid="ETLBox.Analysis.DataFrameSource.#ctor*"></a>
  <h4 id="ETLBox_Analysis_DataFrameSource__ctor_Microsoft_Data_Analysis_DataFrame_" data-uid="ETLBox.Analysis.DataFrameSource.#ctor(Microsoft.Data.Analysis.DataFrame)">DataFrameSource(DataFrame)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
