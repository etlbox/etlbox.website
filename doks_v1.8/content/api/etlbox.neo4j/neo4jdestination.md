...
{{< rawhtml >}}
  ...
  <h1 id="ETLBox_Neo4j_Neo4jDestination" data-uid="ETLBox.Neo4j.Neo4jDestination" class="text-break">Class Neo4jDestination</h1>
...
```C#
    public class Neo4jDestination : Neo4jDestination<ExpandoObject>, IDataFlowBatchDestination<ExpandoObject>, IDataFlowDestination<ExpandoObject>, IDataFlowBatchDestination, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
