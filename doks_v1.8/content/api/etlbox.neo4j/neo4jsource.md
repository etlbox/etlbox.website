...
{{< rawhtml >}}
  ...
  <h1 id="ETLBox_Neo4j_Neo4jSource" data-uid="ETLBox.Neo4j.Neo4jSource" class="text-break">Class Neo4jSource</h1>
...
```C#
    public class Neo4jSource : Neo4jSource<ExpandoObject>, IDataFlowExecutableSource<ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowExecutableSource, IDataFlowSource, IDataFlowComponent, ILoggableTask
```
