...
description: "Details for Class IfIndexExistsTask (ETLBox.ControlFlow)"
draft: false
images: []
menu:
  api:
...
<h6><strong>Namespace</strong>: ETLBox.ControlFlow</h6>
  ...
  <h5 id="ETLBox_ControlFlow_IfIndexExistsTask_syntax">Syntax</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_ControlFlow_IfIndexExistsTask__ctor_" data-uid="ETLBox.ControlFlow.IfIndexExistsTask.#ctor*"></a>
  <h4 id="ETLBox_ControlFlow_IfIndexExistsTask__ctor" data-uid="ETLBox.ControlFlow.IfIndexExistsTask.#ctor">IfIndexExistsTask()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_ControlFlow_IfIndexExistsTask__ctor_" data-uid="ETLBox.ControlFlow.IfIndexExistsTask.#ctor*"></a>
  <h4 id="ETLBox_ControlFlow_IfIndexExistsTask__ctor_System_String_System_String_" data-uid="ETLBox.ControlFlow.IfIndexExistsTask.#ctor(System.String,System.String)">IfIndexExistsTask(string, string)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_ControlFlow_IfIndexExistsTask_IsExisting_" data-uid="ETLBox.ControlFlow.IfIndexExistsTask.IsExisting*"></a>
  <h4 id="ETLBox_ControlFlow_IfIndexExistsTask_IsExisting_ETLBox_IConnectionManager_System_String_System_String_" data-uid="ETLBox.ControlFlow.IfIndexExistsTask.IsExisting(ETLBox.IConnectionManager,System.String,System.String)">IsExisting(IConnectionManager, string, string)</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_ControlFlow_IfIndexExistsTask_IsExisting_" data-uid="ETLBox.ControlFlow.IfIndexExistsTask.IsExisting*"></a>
  <h4 id="ETLBox_ControlFlow_IfIndexExistsTask_IsExisting_System_String_System_String_" data-uid="ETLBox.ControlFlow.IfIndexExistsTask.IsExisting(System.String,System.String)">IsExisting(string, string)</h4>
  <div class="markdown level1 summary"><p>Ćhecks if the index exists</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
