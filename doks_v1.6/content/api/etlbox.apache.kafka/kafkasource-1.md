---
title: "KafkaSource<TOutput>"
description: "Details for Class KafkaSource<TOutput> (ETLBox.Apache.Kafka)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
  ...
  <div class="inheritance">
    ...
    <div class="level5"><span class="xref">KafkaSource&lt;TOutput&gt;</span></div>
      <div class="level6"><a class="xref" href="/api/etlbox.apache.kafka/kafkasource">KafkaSource</a></div>
  </div>
...
<h6><strong>Namespace</strong>: ETLBox.Apache.Kafka</h6>
  ...
  <h5 id="ETLBox_Apache_Kafka_KafkaSource_1_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class KafkaSource<TOutput> : DataFlowExecutableSource<TOutput>, IDataFlowExecutableSource<TOutput>, IDataFlowSource<TOutput>, IDataFlowExecutableSource, IDataFlowSource, IDataFlowComponent, ILoggableTask
```
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Apache_Kafka_KafkaSource_1__ctor_" data-uid="ETLBox.Apache.Kafka.KafkaSource`1.#ctor*"></a>
  <h4 id="ETLBox_Apache_Kafka_KafkaSource_1__ctor" data-uid="ETLBox.Apache.Kafka.KafkaSource`1.#ctor">KafkaSource()</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Apache_Kafka_KafkaSource_1_BuilderContext_" data-uid="ETLBox.Apache.Kafka.KafkaSource`1.BuilderContext*"></a>
  <h4 id="ETLBox_Apache_Kafka_KafkaSource_1_BuilderContext" data-uid="ETLBox.Apache.Kafka.KafkaSource`1.BuilderContext">BuilderContext</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="https://learn.microsoft.com/dotnet/api/system.action-1">Action</a>&lt;<span class="xref">ConsumerBuilder</span>&lt;<span class="xref">Ignore</span>, TOutput&gt;&gt;</td>
        <td></td>
      </tr>
    </tbody>
  </table>
  <a id="ETLBox_Apache_Kafka_KafkaSource_1_ConsumerConfig_" data-uid="ETLBox.Apache.Kafka.KafkaSource`1.ConsumerConfig*"></a>
  <h4 id="ETLBox_Apache_Kafka_KafkaSource_1_ConsumerConfig" data-uid="ETLBox.Apache.Kafka.KafkaSource`1.ConsumerConfig">ConsumerConfig</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">ConsumerConfig</span></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  <a id="ETLBox_Apache_Kafka_KafkaSource_1_ConsumerContext_" data-uid="ETLBox.Apache.Kafka.KafkaSource`1.ConsumerContext*"></a>
  <h4 id="ETLBox_Apache_Kafka_KafkaSource_1_ConsumerContext" data-uid="ETLBox.Apache.Kafka.KafkaSource`1.ConsumerContext">ConsumerContext</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="https://learn.microsoft.com/dotnet/api/system.action-1">Action</a>&lt;<span class="xref">IConsumer</span>&lt;<span class="xref">Ignore</span>, TOutput&gt;&gt;</td>
        <td></td>
      </tr>
    </tbody>
  </table>
  <a id="ETLBox_Apache_Kafka_KafkaSource_1_TimeOut_" data-uid="ETLBox.Apache.Kafka.KafkaSource`1.TimeOut*"></a>
  <h4 id="ETLBox_Apache_Kafka_KafkaSource_1_TimeOut" data-uid="ETLBox.Apache.Kafka.KafkaSource`1.TimeOut">TimeOut</h4>
  <div class="markdown level1 summary"><p>If no records can be consumed within this time span, the source will
stop reading and send the completed signal to subsequent components.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Apache_Kafka_KafkaSource_1_TopicName_" data-uid="ETLBox.Apache.Kafka.KafkaSource`1.TopicName*"></a>
  <h4 id="ETLBox_Apache_Kafka_KafkaSource_1_TopicName" data-uid="ETLBox.Apache.Kafka.KafkaSource`1.TopicName">TopicName</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Apache_Kafka_KafkaSource_1_CheckParameter_" data-uid="ETLBox.Apache.Kafka.KafkaSource`1.CheckParameter*"></a>
  <h4 id="ETLBox_Apache_Kafka_KafkaSource_1_CheckParameter" data-uid="ETLBox.Apache.Kafka.KafkaSource`1.CheckParameter">CheckParameter()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Apache_Kafka_KafkaSource_1_CleanUpOnFaulted_" data-uid="ETLBox.Apache.Kafka.KafkaSource`1.CleanUpOnFaulted*"></a>
  <h4 id="ETLBox_Apache_Kafka_KafkaSource_1_CleanUpOnFaulted_System_Exception_" data-uid="ETLBox.Apache.Kafka.KafkaSource`1.CleanUpOnFaulted(System.Exception)">CleanUpOnFaulted(Exception)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Apache_Kafka_KafkaSource_1_CleanUpOnSuccess_" data-uid="ETLBox.Apache.Kafka.KafkaSource`1.CleanUpOnSuccess*"></a>
  <h4 id="ETLBox_Apache_Kafka_KafkaSource_1_CleanUpOnSuccess" data-uid="ETLBox.Apache.Kafka.KafkaSource`1.CleanUpOnSuccess">CleanUpOnSuccess()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Apache_Kafka_KafkaSource_1_OnExecutionDoAsyncWork_" data-uid="ETLBox.Apache.Kafka.KafkaSource`1.OnExecutionDoAsyncWork*"></a>
  <h4 id="ETLBox_Apache_Kafka_KafkaSource_1_OnExecutionDoAsyncWork" data-uid="ETLBox.Apache.Kafka.KafkaSource`1.OnExecutionDoAsyncWork">OnExecutionDoAsyncWork()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
