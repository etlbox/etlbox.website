...
{{< rawhtml >}}
  ...
  <h1 id="ETLBox_Apache_Kafka_KafkaSource" data-uid="ETLBox.Apache.Kafka.KafkaSource" class="text-break">Class KafkaSource
</h1>
...
```C#
    public class KafkaSource : KafkaSource<ExpandoObject>, IDataFlowLogging, IDataFlowExecutableSource<ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowExecutableSource, IDataFlowSource, IDataFlowComponent, ILoggableTask
```
