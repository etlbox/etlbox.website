---
title: "Neo4jSource"
description: "Details for Class Neo4jSource (ETLBox.Neo4j)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.Neo4j.Neo4jSource">
  <h1 id="ETLBox_Neo4j_Neo4jSource" data-uid="ETLBox.Neo4j.Neo4jSource" class="text-break">Class Neo4jSource
</h1>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.neo4j/neo4jsource-1">Neo4jSource</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
    <div class="level6"><span class="xref">Neo4jSource</span></div>
  </div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.neo4j/neo4jsource-1#ETLBox_Neo4j_Neo4jSource_1_ConnectionString">Neo4jSource&lt;ExpandoObject&gt;.ConnectionString</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.neo4j/neo4jsource-1#ETLBox_Neo4j_Neo4jSource_1_AuthToken">Neo4jSource&lt;ExpandoObject&gt;.AuthToken</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.neo4j/neo4jsource-1#ETLBox_Neo4j_Neo4jSource_1_ConfigBuilder">Neo4jSource&lt;ExpandoObject&gt;.ConfigBuilder</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.neo4j/neo4jsource-1#ETLBox_Neo4j_Neo4jSource_1_Cypher">Neo4jSource&lt;ExpandoObject&gt;.Cypher</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.neo4j/neo4jsource-1#ETLBox_Neo4j_Neo4jSource_1_Driver">Neo4jSource&lt;ExpandoObject&gt;.Driver</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.neo4j/neo4jsource-1#ETLBox_Neo4j_Neo4jSource_1_Reset">Neo4jSource&lt;ExpandoObject&gt;.Reset()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.neo4j/neo4jsource-1#ETLBox_Neo4j_Neo4jSource_1_CheckParameter">Neo4jSource&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.neo4j/neo4jsource-1#ETLBox_Neo4j_Neo4jSource_1_InitCheckedParameter">Neo4jSource&lt;ExpandoObject&gt;.InitCheckedParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.neo4j/neo4jsource-1#ETLBox_Neo4j_Neo4jSource_1_OnExecutionDoAsyncWork">Neo4jSource&lt;ExpandoObject&gt;.OnExecutionDoAsyncWork()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.neo4j/neo4jsource-1#ETLBox_Neo4j_Neo4jSource_1_CleanUpOnSuccess">Neo4jSource&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.neo4j/neo4jsource-1#ETLBox_Neo4j_Neo4jSource_1_CleanUpOnFaulted_System_Exception_">Neo4jSource&lt;ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.Neo4j</h6>
  ...
  <h5 id="ETLBox_Neo4j_Neo4jSource_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class Neo4jSource : Neo4jSource<ExpandoObject>, IDataFlowLogging, IDataFlowExecutableSource<ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowExecutableSource, IDataFlowSource, IDataFlowComponent, ILoggableTask
```

{{< rawhtml >}}
  <h3 id="constructors">Constructors
</h3>
  <a id="ETLBox_Neo4j_Neo4jSource__ctor_" data-uid="ETLBox.Neo4j.Neo4jSource.#ctor*"></a>
  <h4 id="ETLBox_Neo4j_Neo4jSource__ctor" data-uid="ETLBox.Neo4j.Neo4jSource.#ctor">Neo4jSource()</h4>
