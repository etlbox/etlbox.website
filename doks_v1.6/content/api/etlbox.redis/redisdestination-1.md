...
description: "Details for Class RedisDestination<TInput> (ETLBox.Redis)"
draft: false
images: []
menu:
  api:
...
The stored value will contain your serialized object using Newtonsoft.Json and JsonConvert.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><span class="xref">RedisDestination&lt;TInput&gt;</span></div>
      <div class="level6"><a class="xref" href="/api/etlbox.redis/redisdestination">RedisDestination</a></div>
  </div>
...
<h6><strong>Namespace</strong>: ETLBox.Redis</h6>
  ...
  <h5 id="ETLBox_Redis_RedisDestination_1_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class RedisDestination<TInput> : DataFlowBatchDestination<TInput>, IDataFlowBatchDestination<TInput>, IDataFlowDestination<TInput>, IDataFlowBatchDestination, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Redis_RedisDestination_1__ctor_" data-uid="ETLBox.Redis.RedisDestination`1.#ctor*"></a>
  <h4 id="ETLBox_Redis_RedisDestination_1__ctor" data-uid="ETLBox.Redis.RedisDestination`1.#ctor">RedisDestination()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_Redis_RedisDestination_1__ctor_" data-uid="ETLBox.Redis.RedisDestination`1.#ctor*"></a>
  <h4 id="ETLBox_Redis_RedisDestination_1__ctor_System_Int32_" data-uid="ETLBox.Redis.RedisDestination`1.#ctor(System.Int32)">RedisDestination(int)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Redis_RedisDestination_1_ConnectionString_" data-uid="ETLBox.Redis.RedisDestination`1.ConnectionString*"></a>
  <h4 id="ETLBox_Redis_RedisDestination_1_ConnectionString" data-uid="ETLBox.Redis.RedisDestination`1.ConnectionString">ConnectionString</h4>
...
use <a class="xref" href="/api/etlbox.redis/redisdestination-1#ETLBox_Redis_RedisDestination_1_RedisConnection">RedisConnection</a> instead to pass it to the component.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Redis_RedisDestination_1_DatabaseNumber_" data-uid="ETLBox.Redis.RedisDestination`1.DatabaseNumber*"></a>
  <h4 id="ETLBox_Redis_RedisDestination_1_DatabaseNumber" data-uid="ETLBox.Redis.RedisDestination`1.DatabaseNumber">DatabaseNumber</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Redis_RedisDestination_1_KeyColumn_" data-uid="ETLBox.Redis.RedisDestination`1.KeyColumn*"></a>
  <h4 id="ETLBox_Redis_RedisDestination_1_KeyColumn" data-uid="ETLBox.Redis.RedisDestination`1.KeyColumn">KeyColumn</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Redis_RedisDestination_1_RedisConnection_" data-uid="ETLBox.Redis.RedisDestination`1.RedisConnection*"></a>
  <h4 id="ETLBox_Redis_RedisDestination_1_RedisConnection" data-uid="ETLBox.Redis.RedisDestination`1.RedisConnection">RedisConnection</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Redis_RedisDestination_1_SerializationFunc_" data-uid="ETLBox.Redis.RedisDestination`1.SerializationFunc*"></a>
  <h4 id="ETLBox_Redis_RedisDestination_1_SerializationFunc" data-uid="ETLBox.Redis.RedisDestination`1.SerializationFunc">SerializationFunc</h4>
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Redis_RedisDestination_1_SerializerSettings_" data-uid="ETLBox.Redis.RedisDestination`1.SerializerSettings*"></a>
  <h4 id="ETLBox_Redis_RedisDestination_1_SerializerSettings" data-uid="ETLBox.Redis.RedisDestination`1.SerializerSettings">SerializerSettings</h4>
  <div class="markdown level1 summary"><p>The JsonSerializerSettings used to serialize or deserialize your object into json.
By default, your object is serialized into json. Use <a class="xref" href="/api/etlbox.redis/redisdestination-1#ETLBox_Redis_RedisDestination_1_SerializationFunc">SerializationFunc</a> if you want
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Redis_RedisDestination_1_SetParameter_" data-uid="ETLBox.Redis.RedisDestination`1.SetParameter*"></a>
  <h4 id="ETLBox_Redis_RedisDestination_1_SetParameter" data-uid="ETLBox.Redis.RedisDestination`1.SetParameter">SetParameter</h4>
...
{{< rawhtml >}}
  ...
  <table class="table table-bordered table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="/api/etlbox.redis/redisdestination-1">RedisDestination</a>&lt;TInput&gt;.<a class="xref" href="/api/etlbox.redis.redisdestination-1/redissetparameter">RedisSetParameter</a></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="ETLBox_Redis_RedisDestination_1_BulkInsertData_" data-uid="ETLBox.Redis.RedisDestination`1.BulkInsertData*"></a>
  <h4 id="ETLBox_Redis_RedisDestination_1_BulkInsertData__0___" data-uid="ETLBox.Redis.RedisDestination`1.BulkInsertData(`0[])">BulkInsertData(TInput[])</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Redis_RedisDestination_1_CheckParameter_" data-uid="ETLBox.Redis.RedisDestination`1.CheckParameter*"></a>
  <h4 id="ETLBox_Redis_RedisDestination_1_CheckParameter" data-uid="ETLBox.Redis.RedisDestination`1.CheckParameter">CheckParameter()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Redis_RedisDestination_1_FinishWrite_" data-uid="ETLBox.Redis.RedisDestination`1.FinishWrite*"></a>
  <h4 id="ETLBox_Redis_RedisDestination_1_FinishWrite" data-uid="ETLBox.Redis.RedisDestination`1.FinishWrite">FinishWrite()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Redis_RedisDestination_1_InitCheckedParameter_" data-uid="ETLBox.Redis.RedisDestination`1.InitCheckedParameter*"></a>
  <h4 id="ETLBox_Redis_RedisDestination_1_InitCheckedParameter" data-uid="ETLBox.Redis.RedisDestination`1.InitCheckedParameter">InitCheckedParameter()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Redis_RedisDestination_1_PrepareParameterForCheck_" data-uid="ETLBox.Redis.RedisDestination`1.PrepareParameterForCheck*"></a>
  <h4 id="ETLBox_Redis_RedisDestination_1_PrepareParameterForCheck" data-uid="ETLBox.Redis.RedisDestination`1.PrepareParameterForCheck">PrepareParameterForCheck()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
...
{{< rawhtml >}}
  ...
  <a id="ETLBox_Redis_RedisDestination_1_PrepareWrite_" data-uid="ETLBox.Redis.RedisDestination`1.PrepareWrite*"></a>
  <h4 id="ETLBox_Redis_RedisDestination_1_PrepareWrite" data-uid="ETLBox.Redis.RedisDestination`1.PrepareWrite">PrepareWrite()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
