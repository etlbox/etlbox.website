---
title: "CosmosSource"
description: "Details for Class CosmosSource (ETLBox.Azure.CosmosDb)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.azure.cosmosdb/cosmossource-1">CosmosSource</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.azure.cosmosdb/cosmossource-1#ETLBox_Azure_CosmosDb_CosmosSource_1_PrepareParameterForCheck">CosmosSource&lt;ExpandoObject&gt;.PrepareParameterForCheck()</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.azure.cosmosdb/cosmossource-1#ETLBox_Azure_CosmosDb_CosmosSource_1_InitCheckedParameter">CosmosSource&lt;ExpandoObject&gt;.InitCheckedParameter()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.Azure.CosmosDb</h6>
  ...
  <h5 id="ETLBox_Azure_CosmosDb_CosmosSource_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class CosmosSource : CosmosSource<ExpandoObject>, IDataFlowExecutableSource<ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowExecutableSource, IDataFlowSource, IDataFlowComponent, ILoggableTask
```

{{< rawhtml >}}
  <h3 id="constructors">Constructors
</h3>
  <a id="ETLBox_Azure_CosmosDb_CosmosSource__ctor_" data-uid="ETLBox.Azure.CosmosDb.CosmosSource.#ctor*"></a>
  <h4 id="ETLBox_Azure_CosmosDb_CosmosSource__ctor" data-uid="ETLBox.Azure.CosmosDb.CosmosSource.#ctor">CosmosSource()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_Azure_CosmosDb_CosmosSource__ctor_" data-uid="ETLBox.Azure.CosmosDb.CosmosSource.#ctor*"></a>
  <h4 id="ETLBox_Azure_CosmosDb_CosmosSource__ctor_System_String_System_String_System_String_System_String_" data-uid="ETLBox.Azure.CosmosDb.CosmosSource.#ctor(System.String,System.String,System.String,System.String)">CosmosSource(string, string, string, string)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
