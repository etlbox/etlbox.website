---
title: "ColumnRename"
description: "Details for Class ColumnRename (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
            ...
            <article class="content wrap" id="_content" data-uid="ETLBox.DataFlow.ColumnRename">
  <h1 id="ETLBox_DataFlow_ColumnRename" data-uid="ETLBox.DataFlow.ColumnRename" class="text-break">Class ColumnRename
</h1>
...
existing ColumnMap attributes. For arrays provide the array index and the new name.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow/columnrename-1">ColumnRename</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/columnrename-1#ETLBox_DataFlow_ColumnRename_1_SourceBlock">ColumnRename&lt;ExpandoObject&gt;.SourceBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/columnrename-1#ETLBox_DataFlow_ColumnRename_1_TargetBlock">ColumnRename&lt;ExpandoObject&gt;.TargetBlock</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/columnrename-1#ETLBox_DataFlow_ColumnRename_1_RenameColumns">ColumnRename&lt;ExpandoObject&gt;.RenameColumns</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/columnrename-1#ETLBox_DataFlow_ColumnRename_1_RenameFunc">ColumnRename&lt;ExpandoObject&gt;.RenameFunc</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/columnrename-1#ETLBox_DataFlow_ColumnRename_1_ProgressCount">ColumnRename&lt;ExpandoObject&gt;.ProgressCount</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/columnrename-1#ETLBox_DataFlow_ColumnRename_1_Reset">ColumnRename&lt;ExpandoObject&gt;.Reset()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/columnrename-1#ETLBox_DataFlow_ColumnRename_1_PrepareParameterForCheck">ColumnRename&lt;ExpandoObject&gt;.PrepareParameterForCheck()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/columnrename-1#ETLBox_DataFlow_ColumnRename_1_CheckParameter">ColumnRename&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/columnrename-1#ETLBox_DataFlow_ColumnRename_1_InitComponent">ColumnRename&lt;ExpandoObject&gt;.InitComponent()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/columnrename-1#ETLBox_DataFlow_ColumnRename_1_CleanUpOnSuccess">ColumnRename&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/columnrename-1#ETLBox_DataFlow_ColumnRename_1_CleanUpOnFaulted_System_Exception_">ColumnRename&lt;ExpandoObject&gt;.CleanUpOnFaulted(Exception)</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/columnrename-1#ETLBox_DataFlow_ColumnRename_1_LinkErrorTo_ETLBox_IDataFlowDestination_ETLBox_ETLBoxError__">ColumnRename&lt;ExpandoObject&gt;.LinkErrorTo(IDataFlowDestination&lt;ETLBoxError&gt;)</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_ColumnRename_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class ColumnRename : ColumnRename<ExpandoObject>, IDataFlowTransformation<ExpandoObject, ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowSource, IDataFlowDestination<ExpandoObject>, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```

{{< rawhtml >}}
  <h3 id="constructors">Constructors
</h3>
  <a id="ETLBox_DataFlow_ColumnRename__ctor_" data-uid="ETLBox.DataFlow.ColumnRename.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_ColumnRename__ctor" data-uid="ETLBox.DataFlow.ColumnRename.#ctor">ColumnRename()</h4>
...
{{< rawhtml >}}
  <a id="ETLBox_DataFlow_ColumnRename__ctor_" data-uid="ETLBox.DataFlow.ColumnRename.#ctor*"></a>
  <h4 id="ETLBox_DataFlow_ColumnRename__ctor_System_Collections_Generic_ICollection_ETLBox_RenameColumn__" data-uid="ETLBox.DataFlow.ColumnRename.#ctor(System.Collections.Generic.ICollection{ETLBox.RenameColumn})">ColumnRename(ICollection&lt;RenameColumn&gt;)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
{{< /rawhtml >}}
