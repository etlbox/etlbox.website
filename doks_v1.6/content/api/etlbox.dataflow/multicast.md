---
title: "Multicast"
description: "Details for Class Multicast (ETLBox.DataFlow)"
draft: false
images: []
menu:
  api:
...
There is no limit how many target the Multicast can be linked to.</p>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><a class="xref" href="/api/etlbox.dataflow/multicast-1">Multicast</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/multicast-1#ETLBox_DataFlow_Multicast_1_SourceBlock">Multicast&lt;ExpandoObject&gt;.SourceBlock</a>
    </div>
    <div>
    ...
    <div>
      <a class="xref" href="/api/etlbox.dataflow/multicast-1#ETLBox_DataFlow_Multicast_1_CheckParameter">Multicast&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/multicast-1#ETLBox_DataFlow_Multicast_1_InitComponent">Multicast&lt;ExpandoObject&gt;.InitComponent()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.dataflow/multicast-1#ETLBox_DataFlow_Multicast_1_CleanUpOnSuccess">Multicast&lt;ExpandoObject&gt;.CleanUpOnSuccess()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.DataFlow</h6>
  ...
  <h5 id="ETLBox_DataFlow_Multicast_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class Multicast : Multicast<ExpandoObject>, IDataFlowTransformation<ExpandoObject, ExpandoObject>, IDataFlowSource<ExpandoObject>, IDataFlowSource, IDataFlowDestination<ExpandoObject>, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```
...
{{< rawhtml >}}
  ...
  <h4 id="ETLBox_DataFlow_Multicast__ctor" data-uid="ETLBox.DataFlow.Multicast.#ctor">Multicast()</h4>
