---
title: "DataFrameDestination"
description: "Details for Class DataFrameDestination (ETLBox.Analysis)"
draft: false
images: []
menu:
  api:
...
{{< rawhtml >}}
  ...
  <div class="inheritance">
    ...
    <div class="level4"><a class="xref" href="/api/etlbox.analysis/dataframedestination-1">DataFrameDestination</a>&lt;<a class="xref" href="https://learn.microsoft.com/dotnet/api/system.dynamic.expandoobject">ExpandoObject</a>&gt;</div>
    <div class="level5"><span class="xref">DataFrameDestination</span></div>
  </div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="/api/etlbox.analysis/dataframedestination-1#ETLBox_Analysis_DataFrameDestination_1_DataFrame">DataFrameDestination&lt;ExpandoObject&gt;.DataFrame</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.analysis/dataframedestination-1#ETLBox_Analysis_DataFrameDestination_1_Culture">DataFrameDestination&lt;ExpandoObject&gt;.Culture</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.analysis/dataframedestination-1#ETLBox_Analysis_DataFrameDestination_1_IgnoreUnsupportedTypes">DataFrameDestination&lt;ExpandoObject&gt;.IgnoreUnsupportedTypes</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.analysis/dataframedestination-1#ETLBox_Analysis_DataFrameDestination_1_DataFrameColumnMapping">DataFrameDestination&lt;ExpandoObject&gt;.DataFrameColumnMapping</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.analysis/dataframedestination-1#ETLBox_Analysis_DataFrameDestination_1_Reset">DataFrameDestination&lt;ExpandoObject&gt;.Reset()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.analysis/dataframedestination-1#ETLBox_Analysis_DataFrameDestination_1_PrepareParameterForCheck">DataFrameDestination&lt;ExpandoObject&gt;.PrepareParameterForCheck()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.analysis/dataframedestination-1#ETLBox_Analysis_DataFrameDestination_1_CheckParameter">DataFrameDestination&lt;ExpandoObject&gt;.CheckParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.analysis/dataframedestination-1#ETLBox_Analysis_DataFrameDestination_1_InitCheckedParameter">DataFrameDestination&lt;ExpandoObject&gt;.InitCheckedParameter()</a>
    </div>
    <div>
      <a class="xref" href="/api/etlbox.analysis/dataframedestination-1#ETLBox_Analysis_DataFrameDestination_1_InitComponent">DataFrameDestination&lt;ExpandoObject&gt;.InitComponent()</a>
    </div>
    <div>
...
<h6><strong>Namespace</strong>: ETLBox.Analysis</h6>
  ...
  <h5 id="ETLBox_Analysis_DataFrameDestination_syntax">Syntax</h5>
{{< /rawhtml >}}

```C#
    public class DataFrameDestination : DataFrameDestination<ExpandoObject>, IDataFlowDestination<ExpandoObject>, IDataFlowDestination, IDataFlowComponent, ILoggableTask
```

{{< rawhtml >}}
  <h3 id="constructors">Constructors
</h3>
  <a id="ETLBox_Analysis_DataFrameDestination__ctor_" data-uid="ETLBox.Analysis.DataFrameDestination.#ctor*"></a>
  <h4 id="ETLBox_Analysis_DataFrameDestination__ctor" data-uid="ETLBox.Analysis.DataFrameDestination.#ctor">DataFrameDestination()</h4>
